...
function GetDistrictList(phaseVal,data){
	...
	jQuery.ajax({
	    ...
	    success: function(result){
	    	...
	    	getDgFundAllcationHdDt(data);
		    
	    }
		
	   //setTimeout( function() { getDgFundAllcationHdDt(data); }, 4000);
	});
}
...
function submitDialouge()
{
	...
	$('#msgForSaved').hide();
	$('.modal-backdrop').hide();
	window.location = 'approvalFundAllocationList';
						...
						<div class="card">
							...
							<div class="row"> 
                               <div class="col-md-12 text-right">														 
                                    ...
                                    <button type="button" id="submitBtn" value="A" onclick="saveSubmitFundAllocationFunction(this.value)" class="btn btn-primary">Submit</button>
