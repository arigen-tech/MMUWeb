...
function addHeadAmountRow() {
		...
		countRecall++;
		 var $tableBody = $('#tbl').find("tbody"),
		  ...
		  $trNew.find("td:eq(0)").find(":input").val("");
            ...
            if (msg.status == 1)
            {
              ...
              //  localStorage.typeOfVal='fundApproval';
               ...
               // window.location.href ="fundBillSubmit?fundAllocationHdId="+Id+"";
                window.location.href ="captureSubmitInterest?captureInterestHdId="+Id+"&pageFlag=approvalCaptureInterestList";
            } 
...
function getDgFundAllcationHdDt(data) {
					...
					if (data != null && data.length > 0) {
						...
						//	var letterNo=data[i].letterNo;
							...
							allocationGridValue += '<td ><select name="headType" class="form-control" readonly onchange="checkDuplicateRecord(this);" id="headType'+ count + '" ';
							allocationGridValue += 'class="medium">';
							var dispStock = data[i].dispUnitId;
							//allocationGridValue += '<option value=""><strong>Select</strong></option>';
...
function submitDialouge()
{
	...
	$('#msgForSaved').hide();
	$('.modal-backdrop').hide();
	window.location = 'approvalCaptureInterestList';
	
}
function backListReport() {
	 window.location.href ="approvalCaptureInterestList";
	...
	<div id="wrapper">
		<div class="content-page">
			...
			<div class="container-fluid">
				...
				<div class="internal_Htext">Approval list of Bank  Interest</div>
                                ...
                                <div class="row">
									...
									<div class="col-md-4">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<select class="form-control" id="financialYearVal">
													<option value="">Select</option>
												</select>
											</div>
										</div>
