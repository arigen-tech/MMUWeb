...
<html>
<head>
<title>Pending List for Complete Registration</title>
...
<script type="text/javascript" language="javascript">
	...
	function getPreConsultationWaitingListOnline(MODE) {
		...
		if (MODE == 'ALL') {
			var data = {"patientName" :"","mobileNo":"", "pageNo" : nPageNo}

		} else {
			var data = {"patientName" :patientName,"mobileNo":mobileNo, "pageNo" : nPageNo}

		};

		var bClickable = true;
		var url = "partialRegisteredPatientList";
	...
	function executeClickEvent(Id) {	
		...
		window.location="completePatientRegistration?id="+Id+"";		
	...
	<div class="content-page">
		...
		<div class="">
			<div class="container-fluid">
				<div class="internal_Htext">Pending List for Complete Registration</div>
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group row">
												...
												<div class="col-sm-7">
													<input class="form-control  form-control-sm" maxlength="10" onkeypress="if(isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"
														id="mobileNo"> </input>
												</div>
											</div>
										</div>
