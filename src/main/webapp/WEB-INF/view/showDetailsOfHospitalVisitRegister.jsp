							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group row">
										...
										<div class="col-md-6">
											<input type="text" class="form-control" id="serviceNo" name="serviceNo" readonly onblur="getEmpDetails()"/>
								...
								<div class="col-md-4" id="dobDiv" style="display:none">
									<div class="form-group row">
										...
										<div class="col-md-6">
											<div class="dateHolder">
											<input type="text" class="form-control calDate noFuture_date2" id="birthDatecal"  onchange="calculateAge()" placeholder="DD/MM/YYYY"  />
											</div>
										</div>
									</div>															
								</div>
								...
								<div class="col-md-4" id="genderNameDiv">
								 ...
								 <div  class="col-md-4" id="genderDiv" style="display:none" >
                                                                    <div class="form-group row">
                                                                        <label for="service" class="col-md-6 col-form-label">Gender</label>
                                                                        <div class="col-md-6">
								...
								<div class="col-md-4">
									<div class="form-group row">
										...
										<div class="col-md-6">
											<input type="text" name="hospitalName" id="hospitalName" class="form-control" maxlength="200" readonly/>
										</div>
									</div>															
								</div>
								<div class="col-md-4">
									<div class="form-group row">
										...
										<div class="col-md-6">
											<input type="text" name="wardName" id="wardName" class="form-control" maxlength="200" readonly/>
										</div>
									</div>															
								</div>
								<div class="w-100"></div>
								<div class="col-md-8">
									<div class="form-group row">
										<div class="col-md-3">
											<label class="col-form-label">ICD Diagnosis <span class="mandate"><sup>&#9733;</sup></span></label>
										</div>
										<div class="col-md-9" style="margin-bottom:6px;">
										<textarea class="form-control" id="diagnosisId" name="diagnosisId"  rows="3" readonly></textarea>
												</div>
									</div>															
								</div>
									<!-- <div class="col-md-4">
								...
								<div class="col-12 m-t-10">
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody id="visitorGrid">
											<tr>
												<td>
												<input type="text" id="visitor1" name="visitor" class="form-control"  readonly />
												</td>
													    <!--  <div class="form-group ">							                                
							                                    <select class="form-control" id="visitor1" name="visitor" readonly>
							                                    <option value="0">Select</option>
												...
												<td>
													<textarea class="form-control" id="visitorName1" name="visitorName"  rows="2" readonly></textarea>
												</td>
												<td>
													<textarea class="form-control" id="remark1" name="remark" rows="2" readonly></textarea>
												</td>
												<!-- <td>
...
$j(document).ready(function()
  {
         var dataList = ${data};
          ...
          var visitorList= dataList.visitorData;
          ...
          var count=dataList.count;
           var j=0;
    		 ...
    		 if(item==1){
    			   $j('#serviceNo').val(resultList[item].serviceNo);
    		  	   $j('#visitDate').val(resultList[item].date);
    		  	   $j('#rank').val(resultList[item].rank);
    		  	   $j('#empName').val(resultList[item].empName);
    		  	   $j('#birthDate').val(resultList[item].dob);
    		  	   $j('#age').val(resultList[item].age);
    		  	   $j('#gender').val(resultList[item].gender);
    		  	   $j('#hospitalName').val(resultList[item].hospitalName);
    		  	   $j('#wardName').val(resultList[item].wardName);
    		  	   $j('#diagnosisId').val(resultList[item].diagnosis);
    		  	   
    		 }
        	}
        	for(item in visitorList){
        		 j++;
        	 $('#visitor'+j).val(visitorList[item].visitorType);
    		 $('#visitorName'+j).val(visitorList[item].visitorName);
    		 $('#remark'+j).val(visitorList[item].remark);
    ...
    var digaoReferal='';   
         ...
         function addNomenclatureRow1() {
        	  i++;
        	 	...
        	 	aClone.find("td:eq(0)").find(':input').prop('id', 'visitor'+i+'');
