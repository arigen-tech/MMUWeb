		...
		<div class="content-page">
			...
			<div class="">
				<div class="container-fluid">
					<div class="internal_Htext">AFMSF - 18</div>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<form:form name="submitMedicalExamByMAForm18"
									id="submitMedicalExamByMAForm18" method="post"
									enctype='multipart/form-data'
									action="${pageContext.request.contextPath}/medicalexam/submitMedicalExamByMAForm18"
									autocomplete="on">
									<div class="card-body">
										<input type="hidden" name="hospitalId" id="hospitalId"
											value="<%=hospitalId%>" /> <input type="hidden" name="userId"
											id="userId" value="<%=userId%>" /> <input type="hidden"
											name="visitId" id="visitId" value="${visitId}" /> <input
											type="hidden" name="patientId" id="patientId" value="" /> <input
											type="hidden" name="disabilityBeforeJoiningIdValue"
											id="disabilityBeforeJoiningIdValue" value="" /> <input
											type="hidden" name="witnessOfEmployee" id="witnessOfEmployee"
											value="" /> <input type="hidden"
											name="signatureOfIndividualId" id="signatureOfIndividualId"
											value="" /> <input type="hidden" name="ageForPatient"
											id="ageForPatient" value="${age}" /> <input type="hidden"
											name="age" id="age" value="" /> 
											<input type="hidden" name="meAgeForOn" id="meAgeForOn"  value=""/>
											<input type="hidden"
											name="saveInDraft" id="saveInDraft" value="draftMa18" /> <input
											type="hidden" name="genderId" id="genderId" value="" /> <input
											type="hidden" name="rankId" value="" id="rankId" /> <input
											type="hidden" name="radioInvAndImaValue"
											id="radioInvAndImaValue" value="Lab" /> <input type="hidden"
											name="totalLengthDigiFile" id="totalLengthDigiFile" value="0" />
										<input type="hidden" name="totalLengthDigiFileRefer"
											id="totalLengthDigiFileRefer" value="0" /> <input
											name="obsistyMark" id="obsistyMark" type="hidden" value="" />
										<input name="labImaginId" id="labImaginId" type="hidden"
											value="" /> <input type="hidden" name="fitFlagCheckValue"
											id="fitFlagCheckValue" />
									...
									<br/>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label for="service" class="col-form-label">Authority
															for Board</label>
													</div>
													<div class="col-md-6">
														<input type="text" name="authorityForBoard"
															id="authorityForBoard" class="form-control" readonly />
													</div>
												</div>
											</div>
											<div class="col-md-4">
												...
												<div class="form-group row">
													...
													<div class="col-md-6">
														<div class="dateHolder">
															<input type="text" name="dateOfReport" id="dateOfReport"
													...
													<div class="col-md-6">
														<div class="dateHolder">
															<input type="text" name="dateOfRelease"
																id="dateOfRelease" class="calDate form-control" placeholder="DD/MM/YYYY" >
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<input type="text" name="armCorpsBranchTrade"
															id="armCorpsBranchTrade" class="form-control" readonly />
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<input type="text" class="form-control"
															name="totalService" id="totalService" readonly />
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label for="service" class="col-form-label">Marital
															Status</label>
													</div>
													<div class="col-md-6">
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label for="service" class="col-form-label">Permanent
															Address</label>
													</div>
													<div class="col-md-6">
														<textarea class="form-control" name="permanentAddress"
															id="permanentAddress" rows="2" readonly></textarea>
													</div>
												</div>
											</div>
											<!-- <div class="col-md-4">
											...
											<div class="col-md-8">
												<div class="form-group row">
													<div class="col-md-3">
														<label for="service" class="col-form-label">Identification
															Marks </label> <span class="pull-right m-t-8">1.</span>
													</div>
													<div class="col-md-9">
														<textarea class="form-control" name="identificationMarks1"
															id="identificationMarks1" maxlength="200"></textarea>
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-md-9">
														<textarea class="form-control" name="identificationMarks2"
															id="identificationMarks2" maxlength="200"></textarea>
													</div>
												</div>
											</div>
										</div>
										...
										<div  style="display:none;">
										 <div class="adviceDivMain" id="button17"
											onclick="showhide(this.id)"  >
											<div class="titleBg" style="width: 520px; float: left;">
												<span>Present Medical Category (Composite) (Enter if LMC)</span>
											</div>
											<input class="buttonPlusMinus" tabindex="5" name=""
												id="relatedbutton17" value="-" onclick="showhide(this.id)"
												type="button">
										</div>
														...
														<td>
															<div class="autocomplete forTableResp">
																<input type="text" autocomplete="off"
																	name="medicalCompositeName" id="medicalCompositeName"
																	onKeyUp="getNomenClatureList(this,'fillMedicalCategoryData','medicalBoard','getMedicalBoardAutocomplete','compositeCategoryForDetail');"
																	class="form-control"> <input type="hidden"
																	id="medicalCompositeNameValue"
																	name="medicalCompositeNameValue" value="" />
																<div id="compositeCategoryDiv"
										...
										<div  style="display:none;">
										 <div class="adviceDivMain" id="button18"
											onclick="showhide(this.id)" >
											<div class="titleBg" style="width: 520px; float: left;">
												<span>List of Medical Category (Enter if LMC)</span>
											</div>
											<input class="buttonPlusMinus" tabindex="5" name=""
												id="relatedbutton18" value="-" onclick="showhide(this.id)"
												type="button">
										</div>

										<div class="hisDivHide p-10 m-t-10" id="newpost18" style="display:none;">
												...
												<tbody id="medicalCategory">
													<tr>
														<td>
															<div class="autocomplete forTableResp">
																<input type="text" autocomplete="off"
																	class="form-control" name="diagnosisId"
																	id="diagnosisId"
																	onKeyUp="getNomenClatureList(this,'fillDiagnosisComboMedCatMe','opd','getIcdListByName','diagnosisMe');"
														...
														<td>
															<div class="autocomplete forTableResp">
																<input type="text" autocomplete="off"
																	...
																	onKeyUp="getNomenClatureList(this,'fillMedicalCategoryDataMe','medicalBoard','getMedicalBoardAutocomplete','compositeCategory');"
																	class="form-control"> <input type="hidden"
																	id="diagnosisiIdMC" name="diagnosisiIdMC" value="" /> <input
																	type="hidden" id="medicalCategoryValueId"
																	name="medicalCategoryValueId" value="" /> <input
																	type="hidden" id="patientMedicalCatId"
																	name="patientMedicalCatId" value="" />
															...
															<input type="hidden" name="placeOfOrigin" id="placeOfOrigin" class="form-control" value=""/>
																...
																<div id="compositeCategoryForDetailDiv"
																	class="autocomplete-itemsNew"></div>
															</div>
														</td>
														<td>
														...
														<td><select class="form-control width120"
															name=typeOfCategory id="typeOfCategory"
															onChange="getdurationByType(this);generateNextDate(this);">
																<option value="0">Select</option>
																<option value="T">Temporary(Week)</option>
																<option value="P">Permanent(Month)</option>
														</select></td>
														<td><input type="text" name="duration" id="duration"
															onblur="return generateNextDate(this);"
															onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"
															class="form-control"></td>

														<td>
															<div class="dateHolder">
																<input type="text" id="categoryDate" name="categoryDate"
																	class="noFuture_date5 form-control"
																	placeholder="DD/MM/YYYY" value="" maxlength="10" />
															</div>
														</td>
														<td>
															<div class="dateHolder">
																<input type="text" id="nextcategoryDate"
																	name="nextcategoryDate" class="noFuture_date10 form-control"
																	placeholder="DD/MM/YYYY" value="" maxlength="10" />
															</div>
														</td>
														<td>
										...
										<div class="hisDivHide p-10 m-t-10" id="newpost12">
													...
													<table
														...
														<tbody id="serviceDetailsIdGrid">
															<tr>
																...
																<td>
																	<div class="dateHolder">
																		<input type="text" name="serviceDetailFrom"
																			id="serviceDetailFrom"
																			class="input_date  form-control" placeholder="DD/MM/YYYY"  maxlength="10" > <input
																			type="hidden" name="serviceDetailId"
																			id="serviceDetailId" value=""  />
																	</div>
																</td>
																<td>
																	<div class="dateHolder">
																		<input type="text" name="serviceDetailTo"
																			id="serviceDetailTo" class="input_date  form-control" placeholder="DD/MM/YYYY" maxlength="10" >
																	</div>
																</td>
																<td><input type="text" name="serviceDetailPlace"
																	id="serviceDetailPlace" class="form-control" maxlength="100"></td>
																<td><select class="form-control"
																	name="serviceDetailPf" id="serviceDetailPf">
																		<option value="0">Select</option>
																...
																<td>
																	<button name="Button" type="button"
																		...
																		button-type="add" onclick="addRowForServiceDetails();"></button>
																</td>
																<td>

																	<button class="btn btn-danger noMinWidth" name="delete"
																		value="" id="deleteServiceDetail" button-type="delete"
											...
											<div class="row">
												<div class="col-12 m-t-10">
													<h6 class="font-weight-bold">Any Previous Service in
														Army / Navy / Air Force</h6>
												</div>
											</div>
											<div class="row m-t-10">
												<div class="col-md-8">
													<div class="form-group row">
														<div class="col-md-3">
															<label for="service" class="col-form-label">Particulars
																of Previous Service</label>
														</div>
														<div class="col-md-9">
															<textarea class="form-control" rows="2"
																name="particularsOfPreviousService"
																id="particularsOfPreviousService"  maxlength="200" ></textarea>
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Disability
																Pension Recieved</label>
														</div>
														<div class="col-md-7">
															<select class="form-control"
																id="disabilityPensionRecieved"
																name="disabilityPensionRecieved">
																<option value="0">Select</option>
										...
										<div class="hisDivHide p-10 m-t-10" id="newpost13">
											...
											<table class="table table-hover table-striped table-bordered">
												<thead class="bg-primary">
													<tr>
														...
														<th class="text-center" colspan="2">Approximate Dates
															&amp; Periods Treated</th>
														...
														<td>
															...
															<div class="autocomplete forTableResp">
																...
																<input autocomplete="off" type="text"
																	class="form-control" name="IllnessWoundInjury"
																	id="IllnessWoundInjury"
																	onKeyUp="getNomenClatureList(this,'fillDiagnosisComboF18','opd','getIcdListByName','diagnosisMe18');"
																	placeholder="Diagnosis" value="" /> <input
																	type="hidden" id="icdDiagnaosis" name="icdDiagnaosis"
																	value="" /> <input type="hidden"
																	id="patientDiagnosisId" name="patientDiagnosisId"
																	value="" />
																<div id="diseaseWoundInjuryDetailsGridDiv"
																	class="autocomplete-itemsNew"></div>
															</div>
														</td>
														<td>
															<div class="dateHolder">
																<input type="text" name="firstStartedDate"
																	id="firstStartedDate" class="input_date  form-control" placeholder="DD/MM/YYYY" maxlength="10">
															</div>
														</td>
														<td><input type="text" name="firstStartedPlace"
															id="firstStartedPlace" class="form-control"></td>
														<td><input type="text" name="whereTreated"
															id="whereTreated" class="form-control" maxlength="100"></td>

														<td>
															<div class="dateHolder">
																<input type="text" name="approximatePeriodsTreatedFrom"
																	id="approximatePeriodsTreatedFrom"
																	class="input_date  form-control" placeholder="DD/MM/YYYY" maxlength="10">
															</div>
														</td>
														<td>
															<div class="dateHolder">
																<input type="text" name="approximatePeriodsTreatedTo"
																	id="approximatePeriodsTreatedTo"
																	class="input_date  form-control" placeholder="DD/MM/YYYY" maxlength="10">
															</div>
														</td>
														<td>
															<button name="Button" type="button"
																class="btn btn-primary noMinWidth" button-type="add"
																onclick="addRowForDiseaseWoundInjury();"></button>

														</td>
														<td>
															<button class="btn btn-danger noMinWidth" name="delete"
																value="" id="deleteDiseaseWoundInjury"
																button-type="delete"
																onclick="removeRowInvestigation(this);"></button>
											...
											<div class="row m-t-10">
												<div class="col-md-12">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label"> Did
																you suffer from any disability before joining the Armed
																Forces </label>
														</div>
														<div class="col-md-2">
															<select class="form-control"
																name="disabilityBeforeJoining"
																id="disabilityBeforeJoining"
																onChange="return getDisabilityBeforeJoining(this);">
																<option value="0">Select</option>
																<option value="Yes">Yes</option>
																<option value="No">No</option>
															</select>
													...
													<div id="diseaseWoundInjuryArmedForcesTable"
														style="display: none">
														<table
															class="table table-hover table-striped table-bordered">
															<thead class="bg-primary">
															...
															<tbody id="diseaseWoundInjuryArmedForces">
																...
																<tr>
																	<td class="width150">
																		<div class="dateHolder">
																			<input type="text" name="armedForcesFrom"
																				id="armedForcesFrom" class="input_date form-control" placeholder="DD/MM/YYYY" maxlength="10">
																			<input type="hidden"
																				id="armedForcesPatientDiagnosisId"
																				name="armedForcesPatientDiagnosisId" value="" />
																		</div>
																	</td>

																	<td class="width150">
																		<div class="dateHolder">
																			<input type="text" name="armedForcesTo"
																				id="armedForcesTo" class="input_date form-control" placeholder="DD/MM/YYYY" maxlength="10">
																		</div>
																	</td>
																	<td><textarea name="armedForcesDetails"
																			id="armedForcesDetails" class="form-control" maxlength="200"></textarea>
																	</td>

																	<td class="width60">
																		<button name="Button" type="button"
																			class="btn btn-primary noMinWidth" button-type="add"
																			onclick="addRowForDiseaseWoundInjuryArmedForces();"></button>

																	</td>
																	<td class="width60">
																		<button class="btn btn-danger noMinWidth"
																			name="delete" value="" id="deleteArmedForces"
																			button-type="delete"
																			onclick="removeRowInvestigation(this);"></button>
												...
												<div class="col-md-12">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label"> Do
																you claim any disability due to service </label>
														</div>
														<div class="col-md-2">
															<select class="form-control" name="claimAnyDisability"
																id="claimAnyDisability">
												...
												<div class="col-md-12">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label"> Any
																other information you wish to give about your health </label>
														</div>
														<div class="col-md-3">
															<textarea class="form-control" name="anyOtherInformation"
																id="anyOtherInformation" rows="3" maxlength="200"></textarea>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="hisDivHide p-10 m-t-10" id="newpost14">
											...
											<div class="row m-b-10">
												<div class="col-md-12">
													<label for="service" class="col-form-label">I
														certify that I have answered as fully as possible all the
														questions about my service and personal history and that
														the information given is to the best of my knowledge.</label>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<input type="text" name="serviceNoForEmployee"
																id="serviceNoForEmployee" class="form-control" readonly />
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<input type="text" name="rankForEmployee"
																id="rankForEmployee" class="form-control" readonly />
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<div class="dateHolder">
																<input type="text" name="dateOfWitness"
																	id="dateOfWitness" class="calDate form-control"
																	value="" placeholder="DD/MM/YYYY"  maxlength="10"/>
															</div>
												...
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Signature
																of Witness</label>
														</div>
														<div class="col-md-7">
															<input type="text" name="signatureOfWitness"
																id="signatureOfWitness" class="form-control" readonly />
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<input type="text" name="signatureOfIndividual"
																id="signatureOfIndividual" class="form-control" readonly />
														</div>
													</div>
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Total
																No. of Defective Teeth <span class="mandate"><sup></sup></span>
															</label>
														</div>
														<div class="col-md-7">
												...
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Total
																No. of Dental Points <span class="mandate"><sup></sup></span>
															</label>
														</div>
														<div class="col-md-7">
															...
															<tr id="urRow">
																...
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="8"
																			name="urInput8" id="urInput8" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		<input class="form-check-input" type="checkbox"
																			...
																			onClick="return countMissingAndUnsavableValue(this);" />
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="7"
																			name="urInput7" id="urInput7" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		<input class="form-check-input" type="checkbox"
																			...
																			onClick="return countMissingAndUnsavableValue(this);" />
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="6"
																			name="urInput6" id="urInput6" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		<input class="form-check-input" type="checkbox"
																			...
																			onClick="return countMissingAndUnsavableValue(this);" />
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="5"
																			name="urInput5" id="urInput5" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		<input class="form-check-input" type="checkbox"
																			...
																			onClick="return countMissingAndUnsavableValue(this);" />
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="4"
																			name="urInput4" id="urInput4" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		<input class="form-check-input" type="checkbox"
																			...
																			onClick="return countMissingAndUnsavableValue(this);">
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="3"
																			name="urInput3" id="urInput3" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		<input class="form-check-input" type="checkbox"
																			...
																			onClick="return countMissingAndUnsavableValue(this);">
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="2"
																			name="urInput2" id="urInput2" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		<input class="form-check-input" type="checkbox"
																			...
																			onClick="return countMissingAndUnsavableValue(this);">
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="1"
																			name="urInput1" id="urInput1" readonly>
																	</div>
																</td>
															</tr>
															<tr id="ulRow">
																...
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="8"
																			name="ulInput8" id="ulInput8" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="7"
																			name="ulInput7" id="ulInput7" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="6"
																			name="ulInput6" id="ulInput6" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="5"
																			name="ulInput5" id="ulInput5" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="4"
																			name="ulInput4" id="ulInput4" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="3"
																			name="ulInput3" id="ulInput3" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="2"
																			name="ulInput2" id="ulInput2" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="1"
																			name="ulInput1" id="ulInput1" readonly>
																	</div>
																</td>
															</tr>
															<tr>
																...
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="8"
																			name="llInput8" id="llInput8" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="7"
																			name="llInput7" id="llInput7" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="6"
																			name="llInput6" id="llInput6" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="5"
																			name="llInput5" id="llInput5" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="4"
																			name="llInput4" id="llInput4" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="3"
																			name="llInput3" id="llInput3" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="2"
																			name="llInput2" id="llInput2" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="1"
																			name="llInput1" id="llInput1" readonly>
																	</div>
																</td>
															</tr>
															<tr>
																...
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="8"
																			name="lrInput8" id="lrInput8" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="7"
																			name="lrInput7" id="lrInput7" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="6"
																			name="lrInput6" id="lrInput6" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="5"
																			name="lrInput5" id="lrInput5" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="4"
																			name="lrInput4" id="lrInput4" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="3"
																			name="lrInput3" id="lrInput3" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="2"
																			name="lrInput2" id="lrInput2" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="1"
																			name="lrInput1" id="lrInput1" readonly>
																	</div>
																</td>
															</tr>
														</tbody>
															...
															<tr>
																...
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="8"
																			name="unurInput8" id="unurInput8" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="7"
																			name="unurInput7" id="unurInput7" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="6"
																			name="unurInput6" id="unurInput6" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="5"
																			name="unurInput5" id="unurInput5" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="4"
																			name="unurInput4" id="unurInput4" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="3"
																			name="unurInput3" id="unurInput3" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="2"
																			name="unurInput2" id="unurInput2" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="1"
																			name="unurInput1" id="unurInput1" readonly>
																	</div>
																</td>
															</tr>
															<tr>
																...
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="8"
																			name="unulInput1" id="unulInput1" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="7"
																			name="unulInput7" id="unulInput7" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="6"
																			name="unulInput6" id="unulInput6" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="5"
																			name="unulInput5" id="unulInput5" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="4"
																			name="unulInput4" id="unulInput4" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="3"
																			name="unulInput3" id="unulInput3" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="2"
																			name="unulInput2" id="unulInput2" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
															...
															<tr>
																...
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="8"
																			name="unllInput8" id="unllInput8" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="7"
																			name="unllInput7" id="unllInput7" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="6"
																			name="unllInput6" id="unllInput6" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="5"
																			name="unllInput5" id="unllInput5" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="4"
																			name="unllInput4" id="unllInput4" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="3"
																			name="unllInput3" id="unllInput3" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="2"
																			name="unllInput2" id="unllInput2" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="1"
																			name="unllInput1" id="unllInput1" readonly>
																	</div>
																</td>
															</tr>
															<tr>
																...
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="8"
																			name="unlrInput8" id="unlrInput8" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="7"
																			name="unlrInput7" id="unlrInput7" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="6"
																			name="unlrInput6" id="unlrInput6" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="5"
																			name="unlrInput5" id="unlrInput5" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="4"
																			name="unlrInput4" id="unlrInput4" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="3"
																			name="unlrInput3" id="unlrInput3" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="2"
																			name="unlrInput2" id="unlrInput2" readonly>
																	</div>
																</td>
																<td>
																	<div class="form-check form-check-inline cusCheck">
																		...
																		<span class="cus-checkbtn"></span> <input
																			class="form-control width50" type="text" value="1"
																			name="unlrInput1" id="unlrInput1" readonly>
																	</div>
																</td>
															</tr>
														</tbody>
									...
									<div class="opdMain_detail_area1">
														...
														<div class="col-md-7">
															<div class="dateHolder">
																<input type="text" name="checkupDate" id="checkupDate"
																	class="noFuture_date2 form-control" placeholder="DD/MM/YYYY" maxlength="10">
															</div>
														</div>
													</div>
												</div>
										...
										<div class="hisDivHide p-10 m-t-10" id="newpost5"
											...
											<div class="col-md-12 m-t-5">
												...
												<div class="form-check form-check-inline cusRadio">
													<input class="form-check-input" type="radio" checked
														value="investigation"
														onChange="return changeRadioForUploa(this.value),openGeneralDocAndInvForDigi('Lab');"
														id="lab_radio" name="btnradio"> <span
														class="cus-radiobtn"></span> <label
														class="form-check-label" for="lab_radio">Laboratory</label>
												</div>
												...
												<div class="form-check form-check-inline cusRadio">
													<input class="form-check-input" type="radio"
														...
														id="imag_radio" name="btnradio"> <span
														class="cus-radiobtn"></span> <label
														class="form-check-label" for="imag_radio">Imaging
														&nbsp &nbsp </label>
												</div>
													...
													<tbody id="dgInvetigationGrid">
														...
														<tr>
															<td>
																<div class="form-check">
																	<input class="form-check-input position-static"
																		...
																		id="checkBoxForUpload"
																		onClick="return getInvestionCheckData(this);">
																</div>
															</td>
															...
															<td>
																...
																<div class="autocomplete forTableResp">
																	...
																	<input type="hidden" name="dgOrderHdId" value=""
																		...
																		id="dgResultDtId" /> <input type="hidden"
																		name="investigationType" value=""
																		id="investigationType" /> <input type="hidden"
																		name="subChargecodeIdForInv" value=""
																		id="subChargecodeIdForInv" /> <input type="hidden"
																		name="mainChargecodeIdValForInv" value=""
																		id="mainChargecodeIdValForInv" />
																	<div id="investigationDivMe"
																		class="autocomplete-itemsNew"></div>
																</div>
															</td>
															...
															<td><textarea class="form-control"
																	name="investigationRemarks" id="investigationRemarks"
																	rows="2" maxlength="500"></textarea></td>
											...
											<div id="fileUploadDynamic">
												<input type="hidden" name="dynamicUploadInvesId"
													id="dynamicUploadInvesId" /> <input type="hidden"
													name="dynamicUploadInvesIdAndfile"
													id="dynamicUploadInvesIdAndfile" /> <input type="hidden"
													name="dynamicFileUploadId" id="dynamicFileUploadId"
													value="investUploadDynamic" /> <input type="hidden"
													name="uploadNewBuutonId" id="uploadNewBuutonId"
													value="uploadNewFile" /> <input type="hidden"
													name="fileNameId" id="fileNameId" value="fileInvUploadDyna" />
												<input type="hidden" name="radioCheckId" id="radioCheckId"
													value="radioFileUpload" /> <input type="hidden"
													name="countFileUploadVal" id="countFileUploadVal" value="1" />
												<input type="hidden" name="checkForRemove"
													id="checkForRemove" value="1" /> <input type="hidden"
													name="mainChargeCodeForFile" id="mainChargeCodeForFile"
													value="" /> <input type="hidden"
													name="mainChargeCodeForFileWithChargeCode"
													id="mainChargeCodeForFileWithChargeCode" value="" />
												<table
													class="table table-hover table-striped table-bordered">
													<thead class="bg-primary">
														<tr>
															...
															<th>File Upload<span class="mandate">(File
																	name should not contain any special characters and
																	should be jpg,pdf,jpeg,gif,png only!)</span></th>
														...
														<tr>
															<td>
																<div class="form-check form-check-inline cusRadio m-l-5">
																	<input class="form-check-input" type="radio"
																		id="radioFileUpload" name="radioFileUpload"
																		onClick="return updateNewIdWhenRadioCheck(this);">
																	<span class="cus-radiobtn"></span>
																</div>
															</td>
															<td><textarea class="form-control"
																	id="investUploadDynamic"></textarea></td>

															<td>
																<div class="fileUploadDiv">
																	<input type="file" name="fileInvUploadDyna"
																		class="inputUpload" id="fileInvUploadDyna" value=""
																		onchange="return getFileUploadData(this);" disabled>
																	<label class="inputUploadlabel">Choose File</label> <span
																		class="inputUploadFileName">No File Chosen</span>
																</div>
															</td>
															<td>
																<button type="button" name="uploadNewFile"
																	id="uploadNewFile" value="uploadNewFile"
																	class="buttonAdd btn btn-primary noMinWidth"
																	button-type="add"
																	onClick="return getNewUploadFile(this);"></button>
															</td>
															...
															<td>
																<button type="button" name="deleteRowForFile" value=""
																	id="deleteRowForFile"
																	class="buttonDel btn btn-danger noMinWidth"
																	button-type="delete" onclick="removeFile(this);"></button>
															</td>
														</tr>
													</tbody>
												</table>
												...
												<div class="col-md-6">
													<div class="form-group row">
														<label class="col-md-4 col-form-label"
															style="padding-left: 10px;"> Other Investigation
														</label>
														<div class="col-md-7">
															<textarea name="otherInvestigation"
																id="otherInvestigation" cols="0" rows="0"
											...
											<div class="row">
														...
														<div class="col-md-7">
															<div class="input-group mb-2 mr-sm-2">
																<input type="text" name="idealWeight" id="idealWeight" 
																	class="form-control" maxlength="10" onblur="checkVaration()"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;">
																<div class="input-group-append">
																	<div class="input-group-text">kg</div>
																</div>
												...
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<div class="input-group mb-2 mr-sm-2">
																<input type="text" name="overWeight" maxlength="100"
																	id="overWeight"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"
																	class="form-control" readonly>
																<div class="input-group-append">
												...
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<div class="input-group mb-2 mr-sm-2">
																<input type="text" name="waist" id="waist" maxlength="100"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"
																	class="form-control">
																<div class="input-group-append">
																	<div class="input-group-text">cm</div>
									...
									<!---------------------- Skin ends here ---------------------->
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<div class="input-group mb-2 mr-sm-2">
																<input type="text" id="pulse" name="pulse"  maxlength="20" 
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"
																	class="form-control">
																<div class="input-group-append">
													...
													<div class="form-group row">
														...
														<div class="col-md-3 offset-md-2">
															...
															<input name="bp" id="bp" type="text"
																...
																placeholder="SBP" value=""  maxlength="3" 
																onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;" />
															<span></span>
															<!-- slash for bp -->
														...
														<div class="col-md-4">
															<div class="input-group mb-2 mr-sm-2">
																<input name="bp1" id="bp1" type="text"
																	...
																	placeholder="DBP" value="" maxlength="3" 
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;" />
																<div class="input-group-append">
													...
													<div class="form-group row">
														...
														<div class="col-md-7">
															<input type="text" id="peripheralPulsations"
																name="peripheralPulsations" class="form-control" maxlength="20" 
																value="NAD">
														</div>
													</div>
												</div>
													...
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Heart
																Size <span style="color: red"><sup></sup></span>
															</label>
														</div>
														<div class="col-md-7">

															<input type="text" id="heartSize" name="heartSize"
																class="form-control" value="NAD" maxlength="10">
														</div>
													</div>
												</div>
										...
										<div class="adviceDivMain" id="button8"
											onclick="showhide(this.id)">
											<div class="titleBg" style="width: 520px; float: left;">
												<span>Gastro Intestinal System</span>
											</div>
											<input class="buttonPlusMinus" tabindex="5" name=""
												id="relatedbutton8" value="-" onclick="showhide(this.id)"
												type="button">
										</div>
										...
										<div class="hisDivHide p-10 m-t-10" id="newpost8">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group row">
														<div class="col-md-3">
															<label for="service" class="col-form-label">Liver
																Palpable <span class="mandate"><sup></sup></span>
															</label>
														</div>
														<div class="col-md-2">
															<select class="form-control"
																onclick="showLiverPalpableValue(this)"
																name="liverPalpable" id="liverPalpable">
																<option value="No">No</option>
																<option value="Yes">Yes</option>
												...
												<div class="col-md-12">
													<div class="form-group row">
														<div class="col-md-3">
															<label for="service" class="col-form-label">Spleen
																Palpable <span class="mandate"><sup></sup></span>
															</label>
														</div>
														<div class="col-md-2">
															<select class="form-control"
																onclick="showLiverPalpableValue1(this)"
																name="spleenPalpable" id="spleenPalpable">
																<option value="No">No</option>
																<option value="Yes">Yes</option>
														...
														<div class="col-md-2" style="display: none;"
															id="spleenPalpableInput">
															<div class="input-group mb-2 mr-sm-2">
																<input type="text" id="spleen" name="spleen"
																	class="form-control" maxlength="10"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;">
																<div class="input-group-append">
																	<div class="input-group-text">cm</div>
										...
										<div class="adviceDivMain" id="button9"
											onclick="showhide(this.id)">
											<div class="titleBg" style="width: 520px; float: left;">
												<span>Central Nervous System</span>
											</div>
											<input class="buttonPlusMinus" tabindex="5" name=""
												id="relatedbutton9" value="-" onclick="showhide(this.id)"
												type="button">
										</div>
										...
										<div class="hisDivHide p-10 m-t-10" id="newpost9">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Higher
																Mental Function <span class="mandate"><sup></sup></span>
															</label>
														</div>
														<div class="col-md-7">
															<input type="text" id="higherMentalFunction"
																name="higherMentalFunction" class="form-control"
																value="NAD"  maxlength="10">
														</div>
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Speech
																<span class="mandate"><sup></sup></span>
															</label>
														</div>
														<div class="col-md-7">
															<input type="text" id="speech" name="speech"
																class="form-control" value="NAD" maxlength="100">
														</div>
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Reflexes
																<span class="mandate"><sup></sup></span>
															</label>
														</div>
														<div class="col-md-7">
															<input type="text" id="reflexes" name="reflexes"
																class="form-control" value="NAD" maxlength="100">
														</div>
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Tremors
																<span class="mandate"><sup></sup></span>
															</label>
														</div>
														<div class="col-md-7">
												...
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Self
																Balancing Test <span class="mandate"><sup></sup></span>
															</label>
														</div>
														<div class="col-md-7">
															<select class="form-control" id="selfBalancingTest"
																name="selfBalancingTest">
													...
													<div class="form-group row">
														...
														<div class="col-md-7">
															<input type="text" id="locomotorSystem"
																name="locomotorSystem" class="form-control" value="NAD" maxLength="100">
														</div>
													</div>
												</div>
										...
										<div class="adviceDivMain" id="button3"
											onclick="showhide(this.id)">
											<div class="titleBg" style="width: 520px; float: left;">
												<span>Vision</span>
											</div>
											<input class="buttonPlusMinus" tabindex="3" name=""
												id="relatedbutton3" value="-" onclick="showhide(this.id)"
												type="button">
										</div>
											...
											<table class="table table-hover table-striped table-bordered">
												...
												<tbody>
													<tr>
														...
														<td><select class="form-control"
															name="distantWithoutGlasses" id="distantWithoutGlasses">
														...
														<td><select class="form-control"
															name="distantWithoutGlassesL" id="distantWithoutGlassesL">
																<option value="6/6">6/6</option>
																<option value="6/9">6/9</option>
																<option value="6/12">6/12</option>
																<option value="6/18">6/18</option>
														...
														<td>Without Glasses</td>
														<td><select class="form-control"
															name="nearWithoutGlasses" id="nearWithoutGlasses">
														...
														<td><select class="form-control"
															name="nearWithoutGlassesL" id="nearWithoutGlassesL">
																<option value="N6">N6</option>
																<option value="N9">N9</option>
																<option value="N12">N12</option>
																<option value="N18">N18</option>
														...
														<td rowspan="2"><select class="form-control"
															name="cpWithoutGlasses" id="cpWithoutGlasses">
													...
													<tr>
														<td>With Glasses</td>
														<td><select class="form-control"
															name="distantWithGlasses" id="distantWithGlasses">
														...
														<td><select class="form-control"
															name="distantWithGlassesL" id="distantWithGlassesL">
																<option value="NA">NA</option>
																<option value="6/6">6/6</option>
																<option value="6/9">6/9</option>
																<option value="6/12">6/12</option>
														...
														<td>With Glasses</td>
														<td><select class="form-control"
															name="nearWithGlasses" id="nearWithGlasses">
																<option value="NA">NA</option>
																<option value="N6">N6</option>
																<option value="N9">N9</option>
																<option value="N12">N12</option>
														...
														<td><select class="form-control"
															name="nearWithGlassesL" id="nearWithGlassesL">
																<option value="NA">NA</option>
																<option value="N6">N6</option>
																<option value="N9">N9</option>
																<option value="N12">N12</option>
										...
										<div class="adviceDivMain" id="button4"
											onclick="showhide(this.id)">
											<div class="titleBg" style="width: 520px; float: left;">
												<span>Hearing</span>
											</div>
											<input class="buttonPlusMinus" tabindex="4" name=""
												id="relatedbutton4" value="-" onclick="showhide(this.id)"
												type="button">
										</div>
										...
										<div class="hisDivHide p-10 m-t-10" id="newpost4">
											...
											<table class="table table-hover table-striped table-bordered">
												...
												<tbody>
													<tr>
														...
														<td>
															<div class="form-row from-inline m-l-0">
																<input type="text" name="fwR" id="fwR"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"
																	class="form-control width100" value="610" maxlength="10"> <input
																	type="text" name="fwr" id="fwr" value="Cms"
																	class="form-control width50" readonly />
															</div>
														</td>
														<td>
															<div class="form-row from-inline m-l-0">
																<input type="text" name="fwL" id="fwL"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"
																	class="form-control width100" value="610" maxlength="10"> <input
																	type="text" name="fwl" id="fwl"
																	class="form-control width50" value="Cms" readonly />
															</div>
														</td>
														<td>
															<div class="form-row from-inline m-l-0">
																<input type="text" name="fwBoth" id="fwBoth"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"
																	class="form-control width100" value="610" maxlength="10"> <input
																	type="text" name="fwboth" id="fwboth"
																	class="form-control width50" value="Cms" readonly />
															</div>
														</td>
													</tr>
														...
														<td>
															<div class="form-row from-inline m-l-0">
																<input type="text" name="cvR" id="cvR"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"
																	class="form-control width100" value="610" maxlength="10"> <input
																	type="text" name="cvr" id="cvr"
																	class="form-control width50" value="Cms" readonly />
															</div>
														</td>
														<td>
															<div class="form-row from-inline m-l-0">
																<input type="text" name="cvL" id="cvL"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"
																	class="form-control width100" value="610" maxlength="10"> <input
																	type="text" name="cvl" id="cvl"
																	class="form-control width50" value="Cms" readonly />
															</div>
														</td>
														<td>
															<div class="form-row from-inline m-l-0">
																<input type="text" name="cvBoth" id="cvBoth"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"
																	class="form-control width100" value="610" maxlength="10"> <input
																	type="text" name="cvboth" id="cvboth"
																	class="form-control width50" value="Cms" readonly />
															</div>
														</td>
													</tr>
													...
													<tr>
														<td class="width330">Tympanic Membrance Intact <span
															class="mandate"><sup></sup></span></td>
														<td><select class="form-control width150" id="tmR"
															name="tmR">
																<option value="Yes">Yes</option>
																<option value="No">No</option>
														...
														<td><select class="form-control width150" id="tmL"
															name="tmL">
																<option value="Yes">Yes</option>
																<option value="No">No</option>
														</select></td>
													...
													<tr>
														<td class="width330">Mobility Valsalva <span
															class="mandate"><sup></sup></span></td>
														<td><select class="form-control width150"
															id="mobilityR" name="mobilityR">
																<option value="+ve">+ve</option>
																<option value="-ve">-ve</option>
														</select></td>

														<td><select class="form-control width150"
															id="mobilityL" name="mobilityL">
																<option value="+ve">+ve</option>
																<option value="-ve">-ve</option>
														</select></td>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label class="col-form-label">Nose, Throat &amp;
																Sinuses <span class="mandate"><sup></sup></span>
															</label>
														</div>
														<div class="col-md-7">
															<input type="text" type="text" id="noseThroatSinuses"
																name="noseThroatSinuses" class="form-control"
																value="NAD" maxLength="100">
														</div>
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label class="col-form-label">Audiometry Record <span
																class="mandate"><sup></sup></span></label>
														</div>
														<div class="col-md-7">
															<select class="form-control" id="audiometryRecord"
																name="audiometryRecord"
																onChange="return displayTextArea(this);">
																<option value="NA">NA</option>
												...
												<div class="col-md-4" style="display: none;"
													id="audiometryRecordForDisplay">
													<div class="form-group row">

														<div class="col-12">
															<textarea class="form-control"
																id="audiometryRecordForOther"
																name="audiometryRecordForOther" maxLength="500"></textarea>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="hisDivHide p-10 m-t-10" id="newpost16">
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group row">
															<div class="col-md-5">
																<label for="service" class="col-form-label">Menstural
																	History <span class="mandate"><sup></sup></span>
																</label>
															</div>
															<div class="col-md-7">
																<input type="text" id="mensturalHistory"
																	name="mensturalHistory" class="form-control" maxlength="30">
															</div>
														</div>
													</div>
															...
															<div class="col-md-5">
																<div class="dateHolder">
																	<input type="text" id="lMP" name="lMP"
																		class="form-control noFuture_date2" placeholder="DD/MM/YYYY" maxlength="10">
																</div>
															</div>
														</div>
													</div>
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<input type="text" id="nosOfPregnancies"
																	name="nosOfPregnancies" class="form-control" maxlength="3"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;" maxlength="3">
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-7">
																<input type="text" id="nosOfAbortions"
																	name="nosOfAbortions" class="form-control" maxlength="3"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;">
															</div>
														</div>
													</div>
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<input type="text" id="nosOfChildren"
																	name="nosOfChildren" class="form-control" maxlength="3"
																	onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;">
															</div>
														</div>
													</div>
												...
												<div class="col-md-12">
													<div class="form-group ">
														<div class="form-check form-check-inline cusCheck">
															<input class="form-check-input" type="checkbox"
																id="fitInChk"
																onclick="return masMedicalCategoryListForMe(this);">
															<span class="cus-checkbtn"></span> <label
																class="col-form-label" for="fitInChk">Fit
																Category</label>
														</div>
													</div>
												</div>
										...
										<div class="row m-t-20">
											<div class="col-12 text-right">
												...
												<input type="button" id="submitMAForma18"
													...
													onClick="return submitMAForm18P('draftMa18');" value="Save" />
		...
		$(document)
				.ready(
						function() {
							...
							$('#armCorpsBranchTrade').val(
									data.data[0].tradeBranch);
							...
							/* if (data.data[0].medicalCategory != ""
									...
									&& data.data[0].medicalCategoryDate != undefined)
							...
							if (data.data[0].medicalCompositeNameValue != null
									&& data.data[0].medicalCompositeNameValue != ""
									&& data.data[0].medicalCompositeNameValue != undefined)
							...
							$('#identificationMarks1').val(
									data.data[0].identificationMarks1);
							$('#identificationMarks2').val(
									data.data[0].identificationMarks2);
							$('#disabilityBeforeJoiningIdValue').val(
									data.data[0].disabilityBeforeJoining);
							setSelectedValue("disabilityBeforeJoining",
									data.data[0].disabilityBeforeJoining);
							...
							$('#maritalStatus')
									.val(data.data[0].marritalStatus);
							$('#permanentAddress').val(data.data[0].address);
							$('#particularsOfPreviousService').val(
									data.data[0].particularsOfPreviousService);

							var selectedValue = "";
							if (data.data[0].disabilityPensionRecieved != null
									&& (data.data[0].disabilityPensionRecieved == 'Y' || data.data[0].disabilityPensionRecieved == 'y')) {
								selectedValue = "Yes";
							} else {
								selectedValue = "No";
							}
							setSelectedValue("disabilityPensionRecieved",
									selectedValue);
							setSelectedValue("claimAnyDisability",
									data.data[0].claimAnyDisability);

							$('#serviceNoForEmployee').val(
									data.data[0].serviceNoEmployee);
							$('#anyOtherInformation').val(
									data.data[0].anyOtherInformation);

							$('#signatureOfWitness').val(
									data.data[0].signatureOfWitness);

							$('#witnessOfEmployee').val(data.data[0].witnessId);

							$('#signatureOfIndividualId').val(
									data.data[0].signatureOfIndividualId);

							$('#signatureOfIndividual').val(
									data.data[0].signatureOfIndividual);
							$('#rankForEmployee').val(
									data.data[0].rankOfEmployee);

							$('#serviceNoOfCertificate').val(
									data.data[0].carefullyExaminedServiceNo);
							$('#rankOfCertificate').val(
									data.data[0].carefullyExaminedRank);
							$('#nameOfCertificate').val(
									data.data[0].carefullyExaminedEmployeeName);
							$('#unitCertificate').val(
									data.data[0].carefullyUnitName);
