...
<div class="content-page">
 ...
 <div class="">
  <div class="container-fluid">
	  ...
	  <div class="internal_Htext">MB Specialist Opinion</div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                <p class="submitMsg">MB Specialist Opinion Saved Successfully</p>    
                                <div id="opd_submit">  
                                     <div class="row">
										<div class="col-md-8"> 
...
<script type="text/javascript" language="javascript">
            function backListReport(flag) {
            				if(flag=="1"){
                          	 window.location.href ="specialistWaitingList";
            				}
            				if(flag=="2"){
