...
<head>
  ...
  <title>Pending For Indent Approval (APM)</title>
	...
	<div class="content-page">
		...
		<div class="">
			...
			<div class="container-fluid">
				<div class="internal_Htext">Pending For Indent Approval (APM)</div>
...
function rowClick(indentId,indentNo,indentdate,toDept,createdBy,approvedBy,status,statusId){	
	 window.location.href = "getIndentDetailsForApproval?indentId="+indentId+"&indentStatus="+statusId;
