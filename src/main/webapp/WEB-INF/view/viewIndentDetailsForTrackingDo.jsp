									...
									<table
										...
										<tbody id="nomenclatureGrid">
												<tr>
													...
													<td><input type="text" name="receivedQty" tabindex="1"
														autocomplete="nope" spellcheck="false" value="" readonly="readonly"
														id="receivedQty" size="5" maxlength="5" class="form-control" onkeypress="return isNumberKey(event)" /></td>
          ...
          var count=dataList.count;
           ...
           record=count;
        	for(item in resultList){
    		 ...
    		 $('#receivedQty'+j).val(resultList[item].receivedQty);
