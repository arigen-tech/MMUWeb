...
var $j = jQuery.noConflict();
        ...
        function generateReport(){
              ...
              var statusVal=$('#statusUserDropDown').val();
              	  
	var url = "${pageContext.request.contextPath}/report/printArrivalRegister?mmu_id="
				+ mmu_id			
				+ "&fromDate="
				+ fromDate
				+ "&toDate="
             ...
             <div class="content-page">
                 ...
                 <div class="">
                     <div class="container-fluid">
                         <div class="internal_Htext">MMU Arrival Report</div>
