...
<head>
  ...
  <title>Pending For Indent Approval (CO)</title>
	...
	<div class="content-page">
		...
		<div class="">
			...
			<div class="container-fluid">
				<div class="internal_Htext">Pending For Indent Approval (CO)</div>
	                                    ...
	                                    <table class="table table-hover table-striped table-bordered">
	                                        <thead class="bg-success" style="color:#fff;">
													<tr>
														...
														<th id="th10">Created By / Approved By</th>
...
{	
	...
	var dataList = jsonData.data;
	 ...
	 for(item in dataList){
	    	  ...
	    	  htmlTable = htmlTable + "<td >" + dataList[item].createdBy +" ("+dataList[item].createdByDsg+")"+ "/ "+dataList[item].approvedBy+" ("+dataList[item].approvedByDsg+")" + "</td>";
	    	  //htmlTable = htmlTable + "<td >Pending</td>";
