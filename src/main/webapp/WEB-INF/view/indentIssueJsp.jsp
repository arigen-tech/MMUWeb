...
%>
		...
		$.ajax({
			...
			success : function(res) {
				...
				for (var i = 0; i < detailList.length; i++) {
					...
					html += '<td><input type="text" class="form-control width60" value="'+detailList[i].previousIssuedQty+'" readonly></td>';
	...
	function addNomenclatureRow(item) {
		...
		var aClone = row.clone().attr("id",'rowId'+x+'');
		...
		aClone.find("td:eq(12)").find("button:eq(0)").removeAttr("style");
...
<script type="text/javascript">
	...
	function goBack() {
		window.location = "indentIssueWaitingJSP";
	}
		...
		$.ajax({
			...
			success : function(res) {
				...
				if(res.data.msg == 'success'){					
					...
					var issueMId = res.data.issueMId;
					//var issueNo = res.data.issueNo;
		...
		<div class="content-page">
			...
			<div class="">
				<div class="container-fluid">
					<div class="internal_Htext">Indent Issue (CO)</div>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
