	...
	<div class="content-page">
		...
		<div class="">
			...
			<div class="container-fluid">
				...
				Pending List For Sanction Order Approval
                                    ...
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead class="bg-success" style="color:#fff;">
												<tr>
													...
													<th id="th7">Sanction Order Created By</th>
												</tr>
											</thead>
...
function GetListOfQuotation(MODE)
{
	...
	var url = "getSanctionListForApproval";
...
{	
	...
	var dataList = jsonData.data;
	 ...
	 for(item in dataList){
	    	  ...
	    	  htmlTable = htmlTable + "<td >" + dataList[item].quotationApprovedBy + "</td>";
...
function rowClick(reqNo,leastCost,storeSoMId){	
	...
	window.location.href = "approveSanctionOrderDetails?storeSoMId="+storeSoMId+"&flag=approve";
