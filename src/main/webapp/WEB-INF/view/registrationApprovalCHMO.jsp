...
function saveCHMOAction(item){
	
	///-----		
	var empRegId = $('#empRegId').val();
	var chmoAction = $('#chmoAction').val();
	var chmoRemarks = $('#chmoRemarks').val();
	...
	var params = {
			"empRegId":empRegId,
			"userId":"<%= userId %>",
			"chmoAction":chmoAction,
			"chmoRemarks":chmoRemarks,				
	}
...
function backToWaitingList(){
	window.location = "getCHMOWaitingList";
}
						...
						<!-- ----Employee Details end--- -->
								...
								<div class="row m-t-20">
									...
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<select class="form-control" id="chmoAction">
									...
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<textarea class="form-control" rows="3" id="chmoRemarks"></textarea>
											</div>
										</div>
									</div>
									</div>
								...
								<div>
									<div class="col-12 text-right m-t-10">
											<button type="button" class="btn btn-primary" onclick="saveCHMOAction(this)">Submit</button>
