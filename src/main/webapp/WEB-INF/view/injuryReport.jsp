...
<div id="wrapper">
	<div class="content-page">
		...
		<div class="container-fluid">
			<div class="internal_Htext">Injury Report</div>
			<form name="frm">			
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">	
							...
							<div class="row">								
								...
								<div class="col-md-3 text-right">
									<!-- <button type="button" class="btn btn-primary" onclick='downloadReport();'>Report</button>	
									 -->
											
									<button id="printReportButton" type="button" class="btn btn-primary noMinWidth"  onclick="makeUrl()">Report</button>
									
									 <a id="newEnt" class="btn btn-primary" role="button" href="${pageContext.request.contextPath}/miAdmin/createInjuryRegister">New Entry</a>
                                    ...
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead class="bg-success" style="color:#fff;">
											<tr>
												...
												<th>Letter No</th>
												<th>Letter Date</th>
												<th>Approving admin authority name</th>
...
function GetListInjuryReport(MODE)
{
...
{	
	...
	var dataList = jsonData.data;
	 ...
	 for(item in dataList){
	    	 ...
	    	 /*  htmlTable = htmlTable + "<td >" + dataList[item].icdNo + "</td>"; */
	    	  htmlTable = htmlTable + "<td >" + dataList[item].letterNo + "</td>";
	    	  htmlTable = htmlTable + "<td >" + dataList[item].letterDate + "</td>";
	    	  htmlTable = htmlTable + "<td >" + dataList[item].authorityletterNo + "</td>";
	    	  htmlTable = htmlTable + "<td >" + dataList[item].approvalDate + "</td>";
	    	  htmlTable = htmlTable + "<td >" + dataList[item].remark + "</td>";
	    	  if(dataList[item].ridcId!=="")
	    	 	 htmlTable = htmlTable + "<td ><a style='text-decoration:underline; color:blue;'  href='#' onclick='downloadFile("+dataList[item].ridcId+")'</a>View Report</td>";
	    	  else
	    		 htmlTable = htmlTable + "<td ></td>";
		    	
	    	  if(dataList[item].ridcLetterId!=="")
	    	  htmlTable = htmlTable + "<td ><a style='text-decoration:underline; color:blue;'  href='#' onclick='downloadFile("+dataList[item].ridcLetterId+")'</a>View Letter</td>";
	    	  else
		    		 htmlTable = htmlTable + "<td ></td>";
...
function downloadReport() {
	...
	document.frm.action="${pageContext.request.contextPath}/report/printInjuryReport";
...
function makeUrl(){
	...
	var url="${pageContext.request.contextPath}/report/printInjuryReport?fromDate="+fromDate+"&toDate="+toDate+"&unitId="+unit+"&empName="+empName+"&serviceNo="+serviceNo;
	openPdfModel(url);
}
</script>
</html>
