...
$j(document).ready(function()
		{
            ...
            if (data.data.empId != null) {
             ...
             if (data.data.auditorDate != null) {
                 document.getElementById('auditorDate').value = data.data.auditorDate;
             } 
             if (data.data.auditorName != null) {
                 document.getElementById('auditorName').value = data.data.auditorName;
             } 
             if (data.data.auditorAction != null) {
                 document.getElementById('auditorAction').value = data.data.auditorAction;
             } 
             if (data.data.auditorRemarks != null) {
                 document.getElementById('auditorRemarks').value = data.data.auditorRemarks;
             } 
             
             if (data.data.chmoDate != null) {
                 document.getElementById('chmoDate').value = data.data.chmoDate;
             } 
             if (data.data.chmoName != null) {
                 document.getElementById('chmoName').value = data.data.chmoName;
             } 
             if (data.data.chmoAction != null) {
                 document.getElementById('chmoAction').value = data.data.chmoAction;
             } 
             if (data.data.chmoRemarks != null) {
                 document.getElementById('chmoRemarks').value = data.data.chmoRemarks;
             } 
...
function saveUPSSAction(item){
	
	///-----		
	var empRegId = $('#empRegId').val();
	var upssAction = $('#upssAction').val();
	var upssRemarks = $('#upssRemarks').val();
	...
	var params = {
			"empRegId":empRegId,
			"userId":"<%= userId %>",
			"upssAction":upssAction,
			"upssRemarks":upssRemarks,				
	}
...
function backToWaitingList(){
	window.location = "getUPSSWaitingList";
}
	...
	<div id="wrapper">
		<div class="content-page">
			...
			<div class="container-fluid">
				...
				<div class="internal_Htext">Registration Approval Page (UPSS)</div>
				...
				<div class="row">
					<div class="col-12">
						...
						<!-- ----Employee Details end--- -->
								...
								<div class="row m-t-20">
									...
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7 ">
												<input type="text" class="form-control" id="apmDate" disabled/>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" id="apmName" disabled/>
											</div>
										</div>
									</div>
									<div class="w-100"></div>
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" id="apmAction" disabled/>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7 ">
												<textarea class="form-control" rows="3" id="apmRemarks" disabled></textarea>
											</div>
										</div>
									</div>
									</div>
								...
								<div class="row m-t-20">
									...
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7 ">
												<input type="text" class="form-control" id="auditorDate" disabled/>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7 ">
												<input type="text" class="form-control" id="auditorName" disabled/>
											</div>
										</div>
									</div>
									<div class="w-100"></div>
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" id="auditorAction" disabled/>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<textarea class="form-control" rows="3" id="auditorRemarks" disabled></textarea>
											</div>
										</div>
									</div>
									</div>
								...
								<div class="row m-t-20">
									<div class="col-12">
										<h6 class="font-weight-bold text-theme text-underline">CHMO's Details</h6>
									</div>
									<div class="col-lg-9 col-sm-12">
										<div class="row">
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" id="chmoDate" disabled/>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" id="chmoName" disabled/>
											</div>
										</div>
									</div>
									<div class="w-100"></div>
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" id="chmoAction" disabled/>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<textarea class="form-control" rows="3" id="chmoRemarks" disabled></textarea>
											</div>
										</div>
									</div>
									</div>
								...
								<div class="row m-t-20">
									<!-- <div class="col-12">
										<h6 class="font-weight-bold text-theme text-underline">UPSS's Details</h6>
									</div> -->
									<div class="col-lg-9 col-sm-12">
										<div class="row">
											<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<select class="form-control" id="upssAction">
										...
										<div class="col-md-6">
											<div class="form-group row">
												...
												<div class="col-md-7 ">
													<textarea class="form-control" rows="3" id="upssRemarks"></textarea>
												</div>
											</div>
										</div>												
								...
								<div>
									<div class="col-12 text-right m-t-10">
											<button type="button" class="btn btn-primary" onclick="saveUPSSAction(this)">Submit</button>
