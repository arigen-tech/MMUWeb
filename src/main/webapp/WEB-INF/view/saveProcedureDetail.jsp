...
<html>
<head>
<title>Save Nursing Care Detail</title>
...
$j(document).ready(function()
	...
	function getSpecificPhysioDetail(){
		...
		for(var i=0;i<table_data.length;i++){
			...
			if(action == 'Y'){
				...
				html2 += '<tr>';
				html2 += '<td><div><input class="form-control" type="text" id="appoint_date" value="'+table_data[i].appointment_date+'" readonly></div></td>';
				...
				if(status != 'Completed')	{
					...
					var app_date = table_data[i].appointment_date
					var date1 = process(app_date);
					var todayDate = new Date().toISOString().slice(0,10);					
					if(date1 <= new Date(todayDate)){
	...
	function saveProcedureDetail(id){
		...
		if(procedure_date == '' || procedure_date == undefined){
			alert("Nursing Care Date must be selected");
			return;
		}
		if(nursing_remarks == '' || nursing_remarks == undefined){
			alert("Nursing Care Remarks must be entered");
			return;
		}
...
<!-- Begin page -->
    ...
    <div>
		...
		<div class="container-fluid m-t-10">			
				...
				<div class="internal_Htext">Nursing Care Details</div>
				<!-- end row -->
							...
							<div class="card-body">
								...
								<div class="row">									
									<div class="col-md-4">
											...
											<label class="col-sm-4 col-form-label">Nursing Care
												Name</label>
											<div class="col-sm-7">
									...
									<div class="col-md-4">
											...
											<div class="col-sm-7">
												...
												<div class="dateHolder ">
													<input type="text"  class="calDate datePickerInput form-control" id="appointment_date" placeholder="DD/MM/YYYY"
