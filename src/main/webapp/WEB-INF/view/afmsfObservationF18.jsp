						...
						<div class="col-12">
							...
							<form:form name="submitMedicalExamByMAForm18" id="submitMedicalExamByMAForm18" method="post" enctype='multipart/form-data'
								...
								<div class="card-body">
									...
									<input type="hidden" name="saveInDraft" id="saveInDraft" value="draftMo18"/>
												...
												<div class="form-group row">
													...
													<div class="col-md-6">
														<div class="dateHolder">
															<input type="text"  name="dateOfReport" id="dateOfReport"class="calDate form-control" placeholder="DD/MM/YYYY" maxlength="10">
														</div>
													</div>
												</div>
											</div>
										...
										<table class="table table-hover table-striped table-bordered">
											...
											<tbody id ="serviceDetailsIdGrid">												
												<tr>
													...
													<td>
														<input type="text"  name="serviceDetailPlace" id="serviceDetailPlace" class="form-control" maxlength="100">
													</td>
													<td>
										...
										<table class="table table-hover table-striped table-bordered">
											...
											<tbody id="diseaseWoundInjuryDetailsGrid">
												...
												<tr>
													...
													<td>
														<div class="dateHolder">
															<input type="text" name="firstStartedDate" id="firstStartedDate" class="input_date  form-control" placeholder="DD/MM/YYYY" maxlength="10">
														</div>
													</td>
													<td>
														<input type="text" name="firstStartedPlace" id="firstStartedPlace" class="form-control" maxlength="100">
													...
													<td>
														<div class="dateHolder">
															<input type="text"  name="approximatePeriodsTreatedFrom" id="approximatePeriodsTreatedFrom" class="input_date  form-control" placeholder="DD/MM/YYYY" maxlength="10">
														</div>
													</td>
													<td>
														<div class="dateHolder">
															<input type="text" name="approximatePeriodsTreatedTo" id="approximatePeriodsTreatedTo" class="input_date  form-control" placeholder="DD/MM/YYYY" maxlength="10">
														</div>
													</td>
													<td>
													...
													<td>
													<button class="btn btn-danger noMinWidth" name="delete" value="" id="deleteDiseaseWoundInjury" button-type="delete"  onclick="removeRowInvestigation(this);"  ></button>
										...
										<div class="row m-t-10">
											...
											<tbody id="diseaseWoundInjuryArmedForces">
												...
												<tr>
													<td class="width150">
														<div class="dateHolder">
															<input type="text" name="armedForcesFrom"  id="armedForcesFrom" class="input_date form-control" placeholder="DD/MM/YYYY" maxlength="10">
													...
													<td class="width150">
														<div class="dateHolder">
															<input type="text" name="armedForcesTo"  id="armedForcesTo" class="input_date form-control" placeholder="DD/MM/YYYY"maxlength="10" >
														</div>
													</td>
													<td>
														<textarea name="armedForcesDetails"  id="armedForcesDetails"  class="form-control" maxlength="100"></textarea>
													</td>
													...
													<td class="width60">
													<button class="btn btn-danger noMinWidth" name="delete" value="" id="deleteArmedForces" button-type="delete"  onclick="removeRowInvestigation(this);"  ></button>
											...
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-3">
														<textarea class="form-control" name="anyOtherInformation" id="anyOtherInformation" rows="3" maxlength="200"></textarea>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row m-b-10">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
														<input type="text" name="dateOfWitness" id="dateOfWitness" maxlength="10"class="calDate form-control" value="" placeholder="DD/MM/YYYY" />
														</div>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
															<input type="text" name="checkupDate" id="checkupDate" class="noFuture_date2 form-control" placeholder="DD/MM/YYYY" maxlength="10">
														</div>
													</div>
												</div>
											</div>
												...
												<tr>
													<td>
														...
														<input type="text" autocomplete="off" value="" id="chargeCodeName"
																			...
																			name="chargeCodeName" onKeyPress="autoCompleteCommonMe(this,1);" onKeyUp="autoCompleteCommonMe(this,1);" size="44"
											...
											<table
													...
													<thead class="bg-primary">
														<tr>
															...
															<th>File Upload <span class="mandate">(File name should not contain any special characters)</span></th>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="weight" id="weight" class="form-control"  maxlength="10" onblur="checkVaration();checkBMI();" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;">
														    <div class="input-group-append">
												...
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="idealWeight" id="idealWeight"  maxlength="10" class="form-control" onblur="checkVaration()" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;">
														    <div class="input-group-append">
														      <div class="input-group-text">kg</div>
														    </div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" type="text" id="noseThroatSinuses" maxLength="100" name="noseThroatSinuses"  class="form-control" value="NAD">
													</div>
												</div>
											</div>
											<div class="w-100"></div>
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost16">
										...
										<div class="row">
											...
											<div class="form-group row">
												<div class="col-md-5">
														<div class="dateHolder">
														<input type="text" id="lMP" name="lMP" class="form-control noFuture_date2" placeholder="DD/MM/YYYY" maxLength="10" >
														</div>
													</div>
											</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" id="nosOfChildren" name="nosOfChildren" class="form-control" maxlength="3" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;">
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
														<input type="text" id="childDateOfLastConfinement" name="childDateOfLastConfinement" class="form-control noFuture_date2" placeholder="DD/MM/YYYY"  maxlength="10">
														</div>
													</div>
												</div>
											</div>
															...
															<div class="col-md-7">
																<select class="form-control" id="actionMe"
																	...
																	<option   value="approveAndClose">Approve
																		and Close</option>
																	<option  
																		value="approveAndForward">Recommended and forward</option>
															...
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<textarea class="form-control" id="referralNote"
																		name="referralNote" rows="2" maxlength="100"></textarea>
																</div>
															</div>
														</div>
													</div>
															...
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<textarea class="form-control" id="chiefComplaint"
																		name="chiefComplaint" rows="2" maxlength="100"></textarea>
																</div>
															</div>
														</div>
																...
																<div class="col-md-4">
																	...
																	class="form-control border-input" placeholder=" " value="" maxlength="500"/> -->
																			<textarea name="GCS" id="gcs" class="form-control"
																				placeholder="GCS" maxlength="200"></textarea>
																		</div>
																	</div>
																</div>
																<div class="col-md-4">
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="CNS" id="cns" type="text" maxlength="25"
																	...
																	<textarea  name="CNS" id="cns" class="form-control"   placeholder="CNS"  maxlength="200">NAD</textarea>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="Chest" id="chest" type="text" maxlength="25"
																	...
																	<textarea  name="Chest"  id="chest" class="form-control"  placeholder="Chest/ Resp"  maxlength="200">AEBE/NVBS</textarea>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="Musculoskeletal" id="musculoskeletal" maxlength="25"
																	...
																	<textarea  name="Musculoskeletal" id="musculoskeletal" class="form-control"  placeholder="Musculoskeletal"  maxlength="200">NAD</textarea>
															</div>
														</div>
													</div>
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="CVS" id="cvs" type="text" maxlength="25"
																	...
																	<textarea name="CVS" id="cvs" class="form-control"  placeholder="CVS"  maxlength="200">S1,S2 normally heard</textarea>
															</div>
														</div>
													</div>
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="Skin" id="skin" type="text" maxlength="25"
																	...
																	<textarea  name="Skin" id="skin" class="form-control"  placeholder="Skin"  maxlength="200">NAD</textarea>
															</div>
														</div>
													</div>
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="GI" id="gi" type="text" maxlength="25"
																	...
																	<textarea name="GI" id="gi" class="form-control"  placeholder="GI"  maxlength="200">P/A-soft,non tender,no palpable</textarea>
															</div>
														</div>
													</div>
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="geneticurinary" id="geneticurinary" maxlength="25"
																	...
																	<textarea name="geneticurinary" id="geneticurinary" class="form-control"  placeholder="Genito Urinary"  maxlength="200">NAD</textarea>
															</div>
														</div>
													</div>
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="Others" id="others1" type="text" maxlength="25"
																	...
																	<textarea  name="sysOthers" id="sysOthers" class="form-control"  placeholder="Others"  maxlength="200"></textarea>
															</div>
														</div>
													</div>
												...
												<div class="row m-t-10 clearfix">
													<div class="col-md-12 text-right">
														...
														<input type="button" id="submitMAForma18"
															...
															onclick="return submitMAForm18('draftMo18');" value="Submit" />
