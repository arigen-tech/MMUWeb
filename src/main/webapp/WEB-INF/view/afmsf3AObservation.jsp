...
<body>
		...
		<div class="content-page noSideMen">
			...
			<div class="">
				<div class="container-fluid">
					<div class="internal_Htext">AFMSF - 3A</div>
					<div class="row">
						<div class="col-12">
							<div class="card">
							<form:form name="submitMedicalExamByMA3A" id="submitMedicalExamByMA3A" method="post" enctype='multipart/form-data'
									action="${pageContext.request.contextPath}/medicalexam/submitMedicalExamByMA3A" autocomplete="never">
									...
									<input type="hidden" name="saveInDraft" id="saveInDraft" value="draftMo3A"/>
									...
									<input type="hidden" name="radioInvAndImaValue"id="radioInvAndImaValue" value="" />
								...
								<div class="card-body">
									...
									<br/>
										...
										<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label for="service" class="col-form-label">Date of Exam</label>
													</div>
													<div class="col-md-7">
														<input type="text" name="dateOfExam" id="dateOfExam" class="form-control" readonly/>
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label for="service" class="col-form-label">Place of Exam</label>
													</div>
													<div class="col-md-7">
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label for="service" class="col-form-label">Type of Commission</label>
													</div>
													<div class="col-md-7">
														<!-- <input type="text" name="typeOfCommission" id="typeOfCommission" class="form-control" readonly/> -->
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label for="service" class="col-form-label">Date of Commission</label>
													</div>
													<div class="col-md-7">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" name="totalService" id="totalService" class="form-control" readonly/>
													</div>
												</div>
											</div>
											...
											<!-- <div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label  class="col-form-label">Past Medical History</label>
													</div>
													<div class="col-md-7">
											...
											<div class="col-md-4">
												<div class="form-group row">
												 ...
												 <div class="form-group row">
													...
													<div class="col-md-7"> 
                                                  <div class="dateHolder">
								                    <input type="text" id="dateAME" 
								                     name="dateAME" class="noFuture_date2 form-control" 
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label  class="col-form-label">Signature of Officer</label>
													</div>
													<div class="col-md-7">
														<input type="text" name="signatureOfOfficer" id="signatureOfOfficer"  class="form-control" readonly />
													</div>
												</div> 
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label  class="col-form-label">Date Of Signature</label>
													</div>
													<!-- <div class="col-md-7">
														<input type="text" name="dateOfPatient" id="dateOfPatient" class="form-control" readonly />
													</div> -->
													<div class="col-md-7"> 
                                                  <div class="dateHolder">
								                    <input type="text" id="dateOfPatient" 
								                     name="dateOfPatient" class="noFuture_date2 form-control" 
								                     placeholder="DD/MM/YYYY" value="" maxlength="10" readonly/>
								                    </div>
                                                        </div> 
												</div> 
											</div>
												    ...
												    <td><input id="medicalCompositeName" id="medicalCompositeName" type="text" class="form-control"></td>
												    			 ...
												    			 <td>
                                                                                       <div class="autocomplete">
                                                                                        <input type="text" name="medicalCompositeName" id="medicalCompositeName" onblur="fillMedicalCategoryData(this.value,this);" onKeyPress="autoCompleteCommonMe(this,6);"  onKeyUp="autoCompleteCommonMe(this,6);" class="form-control">
	                                        ...
	                                        <thead class="bg-success" style="color:#fff;">
												...
												<tbody id="medicalCategory">
                                                       <tr>
                                                            <td>
                                                                <div class="autocomplete">
                                                                <input type="text" class="form-control" name="diagnosisId" id="diagnosisId" onblur="fillDiagnosisCombo(this.value,this);" onKeyPress="autoCompleteCommonMe(this,5);" onKeyUp="autoCompleteCommonMe(this,5);"placeholder="Diagnosis" />
                                                                </div>
                                                             </td>
                                                               <td>
                                                                  <div class="autocomplete">
                                                                   <input type="text" id="medicalCategoryId" onblur="fillMedicalCategoryData(this.value,this);" onKeyPress="autoCompleteCommonMe(this,6);"  onKeyUp="autoCompleteCommonMe(this,6);" class="form-control">
                                                                ...
                                                                <option value="0">Select</option>
                                                                 ...
                                                                 <td>
                                                                   ...
                                                                   <td>
                                                                     <input type="text" name="duration" id="duration" onblur="return generateNextDate(this);" class="form-control">  
                                                                 	</td>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="weight" id="weight" maxlength="3" class="form-control" onblur="checkVaration();checkBMI();" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;">
														    <div class="input-group-append">
												...
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="idealWeight" id="idealWeight" maxlength="3" class="form-control" onblur="checkVaration()" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;">
														    <div class="input-group-append">
														      <div class="input-group-text">kg</div>
														    </div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="overWeight"  maxlength="100" id="overWeight" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"class="form-control" readonly>
														    <div class="input-group-append">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="waist" id="waist"  maxlength="100" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"class="form-control">
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="rangeOfExpansion" id="rangeOfExpansion" value="5" maxlength="100" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"class="form-control">
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost3">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" id="pulse" name="pulse" maxlength="10" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"class="form-control">
														    <div class="input-group-append">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-3 offset-md-2">
															...
															maxlength="3" class="form-control border-input bpSlash" placeholder="SBP"
													...
													<div class="col-md-4">
														<div class="input-group mb-2 mr-sm-2">
															...
															maxlength="3" class="form-control border-input bmiInput" placeholder="DBP"
															value="" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"/>
														    <div class="input-group-append">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" id="peripheralPulsations" name="peripheralPulsations"   class="form-control" value="NAD" maxlength="10">
													</div>
												</div>
											</div>
										...
										<!-- 	<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label class="col-form-label">ECG (R/DMT) No.</label>
													</div>
													<div class="col-md-7">
														<input type="text" name="ecgRDMT" id="ecgRDMT" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
															<input type="text" name="ecgDated" id="ecgDated" class="form-control calDate">
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" name="ecgReport" id="ecgReport"class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label class="col-form-label">ECG (AMT) No.</label>
													</div>
													<div class="col-md-7">
														<input type="text" name="ecgAMT" id="ecgAMT" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
															<input type="text" name="ecgAmtDated" id="ecgAmtDated"  class="form-control calDate">
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" name="ecgAmtReport" id="ecgAmtReport"class="form-control">
													</div>
												</div>
											</div> -->
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost4">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label for="service" class="col-form-label">X-Ray Chest PA Nos</label>
													</div>
													<div class="col-md-7">
														<input type="text" name="xRayChestPANos" id="xRayChestPANos" class="form-control" />
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label for="service" class="col-form-label">Dated</label>
													</div>
													<div class="col-md-7">
														<div class="dateHolder">
															<input type="text"  name="xRayChestPANosDated" id="xRayChestPANosDated"  class="form-control calDate" />
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label for="service" class="col-form-label">Report</label>
													</div>
													<div class="col-md-7">
														<input type="text" name="xRayChestPANosReport" id="xRayChestPANosReport"  class="form-control" value="NAD" />
													</div>
												</div>
											</div>
										</div>
								...
								<div class="adviceDivMain" id="button9" onclick="showhide(this.id)">
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" id="speech" name="speech" class="form-control" value="NAD" maxlength="10">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" id="reflexes" name="reflexes" class="form-control" value="NAD" maxlength="10">
													</div>
												</div>
											</div>
									...
									<!---------------------- Laboratory Investigations Start ---------------------->
									
									<div class="adviceDivMain" id="button7" onclick="showhide(this.id)">
										<div class="titleBg" style="width: 520px; float: left;">
											<span>Investigation</span>
										</div>
										<input class="buttonPlusMinus" tabindex="7" name="" id="relatedbutton7" value="-" onclick="showhide(this.id)" type="button">
									</div>

									<div class="hisDivHide p-10 m-t-10"  id="newpost7" style="display:block;">
															...
															<td>
											  				...
											  				<div class="fileUploadDiv">
												  				<input type="file" name="fileInvUploadDyna" class="inputUpload"
																	id="fileInvUploadDyna" value="" onchange="return getFileUploadData(this);">
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<textarea name="remarksOfLab" id="remarksOfLab" class="form-control" maxlength="500"></textarea>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<div class="dateHolder">
														<input type="text" name="dateOfLab" id="dateOfLab" class="form-control noFuture_date2" placeholder="DD/MM/YYYY" />
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group row">
												<div class="col-md-5">
													<label class="col-form-label">Signature of Medical Specialist</label>
												</div>
												<div class="col-md-7">
													<input type="text"   name="signatureOfMedicalSpecialist" id="signatureOfMedicalSpecialist"  maxlength="200" class="form-control"/>
												</div>
											</div>
										</div>
									</div>
									...
									<!---------------------- Laboratory Investigations ends here ---------------------->
									...
									<div class="adviceDivMain" id="button14" onclick="showhide(this.id)">
										...
										<input class="buttonPlusMinus" tabindex="8" name="" id="relatedbutton14" value="-" onclick="showhide(this.id)" type="button">
									</div>
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost14">
										<div class="row">
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" id="locomotorSystem" name="locomotorSystem" class="form-control" value="NAD" maxlength="100">
													</div>
												</div>
											</div>
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<textarea  name="remarksOfSurgery" id="remarksOfSurgery" class="form-control" maxlength="500"></textarea>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<div class="dateHolder">
														<input type="text" name="dateOfSurgery" id="dateOfSurgery" class="form-control noFuture_date2" placeholder="DD/MM/YYYY" />
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group row">
												<div class="col-md-5">
													<label class="col-form-label">Signature of Surgical Specialist</label>
												</div>
												<div class="col-md-7">
													<input type="text" name="signatureOfSurgicalSpecialist" id="signatureOfSurgicalSpecialist" class="form-control" maxlength="200"/>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost17">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" id="mensturalHistory" name="mensturalHistory" class="form-control" maxlength="500">
													</div>
												</div>
											</div>
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<textarea name="remarksOfGynaecology" id="remarksOfGynaecology"class="form-control"  maxlength ="500"></textarea>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<div class="dateHolder">
														<input type="text" name="dateOfGynaecology" id="dateOfGynaecology" class="form-control noFuture_date2" placeholder="DD/MM/YYYY" />
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group row">
												<div class="col-md-5">
													<label class="col-form-label">Signature of Gynaecologist</label>
												</div>
												<div class="col-md-7">
													<input type="text"  name="signatureOfGynaecologist" id="signatureOfGynaecologist" class="form-control"  maxlength ="200"/>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost10">
										<div class="row">
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<input type="text"  name="totalNoOfTeath" id="totalNoOfTeath"  maxlength="2" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;" class="form-control"/>
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label for="service" class="col-form-label">Total No. of Defective Teeth </label>
													</div>
													<div class="col-md-6">
														<input type="text" name="totalNoOfDefective" id="totalNoOfDefective" onblur="calculateDentalPointAndDefectiveTeeth();" maxlength="2" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"class="form-control" />
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label for="service" class="col-form-label">Total No. of Dental Points </label>
													</div>
													<div class="col-md-6">
														<input type="text" name="totalNoOfDentalPoints" id="totalNoOfDentalPoints"  onblur="calculateDentalPointAndDefectiveTeeth();" maxlength="2" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;" class="form-control" />
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label for="service" class="col-form-label">Missing </label>
													</div>
													<div class="col-md-6">
														<input type="text" name="missing" id="missing"  maxlength="2" class="form-control" readonly/>
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label for="service" class="col-form-label">Unsavable  </label>
													</div>
													<div class="col-md-6">
														<input type="text" name="unSavable" id="unSavable"  maxlength="2" class="form-control" readonly/>
													</div>
												</div>
											</div>
											<div class="col-md-4">
										...
										<h4 class="service_htext">Medical Exam Dental File Uploads</h4>
										<div class="row">
										<div class="col-md-6">
													<div class="form-group row">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label for="service" class="col-form-label">Signature of Dental Officer <span class="mandate"><sup>&#9733;</sup></span></label>
													</div>
													<div class="col-md-7">
														<input type="text" name="dentalOffier" id="dentalOffier"  class="form-control" maxlength="200"/>
													</div>
												</div>
											</div>
											<div class="col-md-4">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<textarea name="remarks" id="remarks" class="form-control"  maxlength="500" rows="2">Dentally fit</textarea>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<textarea name="remarksOfDental" id="remarksOfDental" class="form-control"></textarea>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<div class="dateHolder">
														<input type="text" name="dateOfDental" id="dateOfDental" class="form-control calDate"/>
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group row">
												<div class="col-md-5">
													<label class="col-form-label">Signature of Dental Officer</label>
												</div>
												<div class="col-md-7">
													<input type="text" name="signatureOfDentalOfficer" id="signatureOfDentalOfficer"  class="form-control"/>
												</div>
											</div>
										</div>
									</div> -->
								...
								<div class="adviceDivMain" id="button15" onclick="showhide(this.id)">
										...
										<input class="buttonPlusMinus" tabindex="3" name="" id="relatedbutton15" value="-" onclick="showhide(this.id)" type="button">
									</div>
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost15">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													<div class="col-md-5">
														<label class="col-form-label">Any evidence of Trachoma/ its complication or any other disease</label>
													</div>
													<div class="col-md-2">
														<input type="text" name="evidenceOfTrachoma" id="evidenceOfTrachoma"  class="form-control" maxlength="100"/>
													</div>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group row">
													<div class="col-md-5">
														<label class="col-form-label">Binocular Vision &amp; Grade</label>
													</div>
													<div class="col-md-2">
														<input type="text" name="binocularVisionGrade" id="binocularVisionGrade"  class="form-control"  maxlength="500"/>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
										<div class="col-12">
												<h6 class="text-theme font-weight-bold text-underline">Special Examination When Applicable</h6>
												
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label class="col-form-label">Manifest Hypermetropia, Myopia R &amp; L</label>
													</div>
													<div class="col-md-6">
														<input type="text" id="manifestHypermetropiaMyopia" name="manifestHypermetropiaMyopia" class="form-control" maxlength="100">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label class="col-form-label">Cover Test</label>
													</div>
													<div class="col-md-6">
														<input type="text" id="coverTest" name="coverTest" class="form-control" maxlength="100">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label class="col-form-label">Diaphragm Test (PD Moddox Wing Test)</label>
													</div>
													<div class="col-md-6">
													<input type="text" id="diaphragmTest" name="diaphragmTest" class="form-control" maxlength="100">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label class="col-form-label">Fundi &amp; Media</label>
													</div>
													<div class="col-md-6">
														<input type="text" id="fundiMedia" name="fundiMedia" class="form-control" maxlength="100">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<input type="text" id="fieldSpecial" name="fieldSpecial" class="form-control" maxlength="100">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-6">
														<label class="col-form-label">Night Visual Capacity</label>
													</div>
													<div class="col-md-6">
														<input type="text" id="nightVisualCapacity" name="nightVisualCapacity" class="form-control" maxlength="100">
													</div>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group row">
													<div class="col-md-3">
														<label class="col-form-label">Convergence</label>
													</div>
													<div class="col-md-1">
													...
													<div class="col-md-3">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="convergenceC" id="convergenceC" maxlength="19" class="form-control"  onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
													...
													<div class="col-md-1">
														<label class="col-form-label">SC</label>
													</div>
													<div class="col-md-3">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="convergenceSC" id="convergenceSC" maxlength="19" class="form-control"  onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
											...
											<div class="col-md-6">
												<div class="form-group row">
													<div class="col-md-3">
														<label class="col-form-label">Accomodation</label>
													</div>
													<div class="col-md-1">
													...
													<div class="col-md-3">
														...
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" id="accomodationR" name="accomodationR" class="form-control" maxlength="500">
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
													...
													<div class="col-md-3">
														...
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" id="accomodationL" name="accomodationL" class="form-control" maxlength="500">
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<textarea class="form-control" name="manifestHypermetropiaMyopiaRemarks" id="manifestHypermetropiaMyopiaRemarks" rows="3" maxlength="500"></textarea>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<div class="dateHolder">
															<input type="text" id="manifestHypermetropiaMyopiaDate" name="manifestHypermetropiaMyopiaDate" class="form-control noFuture_date2" placeholder="DD/MM/YYYY" >
														</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label  class="col-form-label">Signature of Eye Specialist</label>
													</div>
													<div class="col-md-7">
														<input type="text"   name="signatureOfEyeSpecialist" id="signatureOfEyeSpecialist"  class="form-control" maxlength="200"/>
													</div>
												</div> 
											</div>
									...
									<!-- <div class="adviceDivMain" id="button19" onclick="showhide(this.id)">
										<div class="titleBg" style="width: 520px; float: left;">
											<span>Special Examination When Applicable</span>
										</div>
										<input class="buttonPlusMinus" tabindex="4" name="" id="relatedbutton19" value="-" onclick="showhide(this.id)" type="button">
									</div>

									<div class="hisDivHide p-10 m-t-10"  id="newpost19">
										
										
									</div> -->
									
									<!---------------------- Special Examination ends here ---------------------->
									...
									<div class="adviceDivMain" id="button16" onclick="showhide(this.id)">
										...
										<input class="buttonPlusMinus" tabindex="4" name="" id="relatedbutton16" value="-" onclick="showhide(this.id)" type="button">
									</div>

									<div class="hisDivHide p-10 m-t-10"  id="newpost16">
										<h6 class="text-theme font-weight-bold text-underline">Ear</h6>	
										<table class="table table-hover table-striped table-bordered">
											<thead class="bg-primary">
												<tr>
													<th></th>
											...
											<tbody>
												<tr>
													...
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="fwR" id="fwR" maxlength="19" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"class="form-control width100" value="610">
															<input type="text" name="fwr" id="fwr"  value="Cms"class="form-control width50" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="fwL" id="fwL" maxlength="19" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;" class="form-control width100" value="610">
															<input type="text" name="fwl" id="fwl" class="form-control width50" value="Cms" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="fwBoth" id="fwBoth" maxlength="19" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"class="form-control width100" value="610">
												...
												<tr>
													...
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="cvR" id="cvR" maxlength="19" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;" class="form-control width100" value="610">
															<input type="text" name="cvr" id="cvr" class="form-control width50" value="Cms" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="cvL" id="cvL" maxlength="19" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;" class="form-control width100" value="610">
															<input type="text" name="cvl" id="cvl" class="form-control width50" value="Cms" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="cvBoth" id="cvBoth" maxlength="19" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;" class="form-control width100" value="610">
												...
												<tr>
													<td class="width330">External Ear (Wax)</td>
													<td>
														<!-- <select class="form-control width150">
															<option>Select</option>
														</select> -->
														<input type="text" name="externalEarR" id="externalEarR" class="form-control " value="No" maxlength="10"/>
													...
													<td>
														<!-- <select class="form-control width150">
															...
															<input type="text" name="externalEarL" id="externalEarL" class="form-control " value="No" maxlength="10"/>
												...
												<tr>
													<td class="width330">Middle Ear (Tympanic Membrane &amp; Eustachian Tube)</td>
													<td>
														<!-- <select class="form-control width150">
															<option>Select</option>
														</select> -->
														
														<input type="text" name="middleEarR" id="middleEarR" class="form-control " value="NAD" maxlength="10"/>
													</td>
													<td>
														<!-- <select class="form-control width150">
															<option>Select</option>
														</select> -->
														<input type="text" name="middleEarL" id="middleEarL" class="form-control " value="NAD" maxlength="10"/>
													</td>
													<td>
												...
												<tr>
													<td class="width330">Inner Ear (Cochlea &amp; Vestibular Apparatus)</td>
													<td>
														<!-- <select class="form-control width150">
															<option>Select</option>
														</select> -->
														<input type="text" name="innerEarR" id="innerEarR" class="form-control " value="NAD" maxlength="10"/>
													</td>
													<td>
														<!-- <select class="form-control width150">
															<option>Select</option>
														</select> -->
														<input type="text" name="innerEarL" id="innerEarL" class="form-control " value="NAD" maxlength="10"/>
													</td>
													<td>
										...
										<div class="row">
											...
											<div class="col-md-4" style="display:none;" id="audiometryRecordForDisplay">
												<div class="form-group row">
													...
													<div class="col-12">
														<textarea class="form-control" id="audiometryRecordForOther" name="audiometryRecordForOther" maxlength="500"></textarea>
													</div>
												</div>
											</div>
											<div class="w-100"></div>
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label class="col-form-label">Nose<span class="mandate"><sup></sup></span></label>
													</div>
													<div class="col-md-7">
														<input type="text" type="text" id="noseSinuses" name="noseSinuses"  class="form-control" value="NAD" maxlength="50">
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label class="col-form-label">Throat<span class="mandate"><sup></sup></span></label>
													</div>
													<div class="col-md-7">
														<input type="text" type="text" id="throatSinuses" name="throatSinuses"  class="form-control" value="NAD" maxlength="100">
													</div>
												</div>
											</div>
											<div class="w-100"></div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<textarea class="form-control" name="noseThroatSinusesRemarks"  id="noseThroatSinusesRemarks" rows="3" maxlength="500"></textarea>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
															<input type="text" name="noseThroatSinusesDate" id="noseThroatSinusesDate" class="form-control noFuture_date2" placeholder="DD/MM/YYYY" />
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label class="col-form-label">Signature of ENT Specialist</label>
													</div>
													<div class="col-md-7">
														<input type="text" name ="signatureOfENTSpecialist" id="signatureOfENTSpecialist" class="form-control" maxlength="200">
													</div>
												</div>
											</div>
										...
										<div class="adviceDivMain" id="button21" onclick="showhide(this.id)">
										<div class="titleBg" style="width: 520px; float: left;">
											<span>Immunization Status</span>
										</div>
										<input class="buttonPlusMinus" tabindex="5" name="" id="relatedbutton21" value="-" onclick="showhide(this.id)" type="button">
									</div>

									<div class="hisDivHide p-10 m-t-10"  id="newpost21">
									...
									<!---------------------- Final Observation Factors ---------------------->
														...
														<!-- <div class="row">
															<div class="col-md-12"><h6 class="text-underline text-theme font-weight-bold">Approving Authority</h6></div>
															<div class="col-md-4">
																	<div class="form-group row">
																		<div class="col-md-6">
																		...
																		<div class="col-md-6">
																			<input type="text" name="approvingName" id="approvingName" class="form-control"/>
																		</div>
																	</div>
																</div>
															<div class="col-md-4">
																	<div class="form-group row">
																		<div class="col-md-6">
																			<label class="col-form-label">Rank &amp; Designation</label>
																		</div>
																		<div class="col-md-6">
																			<input type="text" name="approvingRank" id="approvingRank"   class="form-control"/>
																		</div>
																	</div>
																</div>
																<div class="w-100"></div>
																<div class="col-md-4">
																	<div class="form-group row">
																		...
																		<div class="col-md-6">
																			<input type="text" name="apporvingPlace" id="apporvingPlace" class="form-control"/>
																		</div>
																	</div>
																</div>
																<div class="col-md-4">
														 ...
														 -->
														<!-- <div class="row">
															<div class="col-md-12"><h6 class="text-underline text-theme font-weight-bold">Perusing Authority</h6></div>
															<div class="col-md-4">
																	<div class="form-group row">
																		<div class="col-md-6">
																			<label class="col-form-label">Name</label>
																		...
																		<div class="col-md-6">
																			<input type="text" name="persuingName" id="persuingName"  class="form-control"/>
																		</div>
																	</div>
																</div>
															<div class="col-md-4">
																	<div class="form-group row">
																		...
																		<div class="col-md-6">
																			<input type="text"  name="persuingRank" id="persuingRank" class="form-control"/>
																		</div>
																	</div>
																</div>
																<div class="w-100"></div>
																<div class="col-md-4">
																	<div class="form-group row">
																		...
																		<div class="col-md-6">
																			<input type="text" name="persuingPlace" id="persuingPlace" class="form-control"/>
																		</div>
																	</div>
																</div>
																<div class="col-md-4">
																	<div class="form-group row">
																		...
																		<div class="col-md-6">
																			<div class="dateHolder">
																				<input type="text"  name="persuingDate" id="persuingDate"  class="form-control calDate"/>
																			</div>
 ...
 -->
								...
								<!-- <div class="col-12">
										<h6 class="font-weight-bold">FINAL OBSERVATION & MEDICAL CATEGORY</h6>
								</div> -->
							<div class="opdMain_detail_area" >
 										
 										<!-- <h4  class="service_htext">Final Observation</h4>  -->
 										<br/>
 										<div class="row">
 											<!-- <div class="col-12">
												<div class="form-group row">
													<div class="col-md-5">Final Observation</div>
													<div class="col-12">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
															<input name="memberPlace" id="memberPlace" class=" form-control" type="text" maxlength="50">
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
															<input name="memberDate" id="memberDate" class="form-control noFuture_date2" type="text" placeholder="DD/MM/YYYY" onChange="return checkDateValidate(this);"/>
														</div>
													</div>
												</div>
											</div>
 										...
 										<div class="row m-t-10">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<label for="service" class="col-form-label m-l-5">Rank &amp; Designation</label>
													</div>
												</div>
											</div>
 										...
 										<div class="row">										
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<input type="text"  name="rankDesiMember1" id="rankDesiMember1" class="form-control check" maxlength="50"/>
														</div>
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group row">														
														<div class="col-md-7">
														<input type="text" name="nameMember1" id="nameMember1" class="form-control check"  maxlength="50"/>
														</div>
													</div>
												</div>
											</div>
											<div class="row">										
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<input type="text" name="rankDesiMember2" id="rankDesiMember2"class="form-control check" maxlength="50"/>
														</div>
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group row">														
														<div class="col-md-7">
														<input type="text" name="nameMember2" id="nameMember2"class="form-control check"  maxlength="50"/>
														</div>
													</div>
												</div>
											</div>
											<div class="row">										
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Signature of President</label>
														</div>
														<div class="col-md-7">
															<input type="text" name="rankDesiPresident" id="rankDesiPresident" class="form-control check" maxlength="50"/>
														</div>
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group row">														
														<div class="col-md-7">
														<input type="text" name="namePresident" id="namePresident"class="form-control check" maxlength="50"/>
														</div>
													</div>
												</div>
											</div>
															...
															<tr>
																...
																<td>
																	<div class="autocomplete forTableResp">
																		...
																		<!-- <input name="icddiagnosis" id="icddiagnosis"
								...
								<div class="opdMain_detail_area uneditableEditorView" style="display: none;"
 									  	...
 									  	<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													<label class="col-md-5 col-form-label">Place </label>
													<div class="col-md-7">
															<input name ="placeOfMember" id="placeOfMember" class="form-control" type="text">
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
															<input class="calDate form-control" type="text" name ="dateOfMember" id="dateOfMember"  >
														</div>
													</div>
												</div>
											</div>
 										...
 										<div class="row">										
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<input type="text" name ="rankDesiMember1" id="rankDesiMember1"  class="form-control check" />
														</div>
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group row">														
														<div class="col-md-7">
														<input type="text" name ="nameMember1" id="nameMember1"  class="form-control check" />
														</div>
													</div>
												</div>
											</div>
											<div class="row">										
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<input type="text" name ="rankDesiMember2" id="rankDesiMember2" class="form-control check" />
														</div>
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group row">														
														<div class="col-md-7">
														<input type="text" name ="nameMember2" id="nameMember2" class="form-control check" />
														</div>
													</div>
												</div>
											</div>
											<div class="row">										
												<div class="col-md-4">
													<div class="form-group row">
														...
														<div class="col-md-7">
															<input type="text" name ="rankDesiSigOfPresident" id="rankDesiSigOfPresident"class="form-control check" />
														</div>
													</div>
												</div>
												...
												<div class="col-md-4">
													<div class="form-group row">														
														<div class="col-md-7">
														<input type="text" name ="nameOfPresident" id="nameOfPresident" class="form-control check" />
														</div>
													</div>
												</div>
											</div>
									...
									<!-- <div class="row m-t-20">
										<div class="col-12 text-right">
											...
											<input type="button" id="submitMAFormId3A" class="btn btn-primary" onClick="return submitMAForm3A('draftMa3A');" value="Save"/>
											...
											<c:when test="${approvalFlag =='n'}">
												<div class="row m-t-10">
													<div class="col-md-12 text-right">
														...
														<input type="button" id="sumbitByMo3A"
															class="btn btn-primary"
															onclick="return submitMOForm3A('draftMo3A');" value="Submit" />
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button class="btn btn-primary" id="modal3AFormSubmit" data-dismiss="modal"
							onClick="submitMOFormByModel3A();" aria-hidden="true">
	...
	<div class="modal " id="messageDelete"  role="dialog" >
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<span class="Message_htext"><spring:message code="lblInvestigation" /></span>
  ...
  <div class="modal-dialog modal-xl" role="document">
	...
	function closeSubModal(){
	  ...
	  $(document).ready(function() {
		...
		$('#signatureOfOfficer').val(data.data[0].patientName);
		...
		if(data.data[0].authority!="" && data.data[0].authority!=null && data.data[0].authority!=undefined)
       ...
       if(data.data[0].dateOfPatient!="" && data.data[0].dateOfPatient!=undefined  && data.data[0].dateOfPatient!=""){
  		 $('#dateOfPatient').val(data.data[0].dateOfPatient);
  	 }
  	 else{
     $('#dateOfPatient').val(today);
  	 }
...
var obsistyOverWeight='';
    ...
    function showhide(buttonId)
     {
		 if(buttonId=="button1"){
 	 	 ...
 	 	 }else if(buttonId=="button19"){
			test('related'+buttonId,"newpost19");
 	 	 }
 	 	else if(buttonId=="button21"){
			test('related'+buttonId,"newpost21");
	 	 }
	 }
	...
	function test(buttonId,newpost){
	 ...
	 var investigationForUom = "";
	 				...
	 				function getttttttttttttttttttttttttttt() {
		...
		function checkVaration()  {
		 ...
		 function populateChargeCode(val, count, item) {
	        ...
	        var arryNomenclature= new Array();
	          ...
	          function getMastStoreItemddddddddddddddddddd(){
	      	  var pathname = window.location.pathname;
	      		var accessGroup = "MMUWeb";
