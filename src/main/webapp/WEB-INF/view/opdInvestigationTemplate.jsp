					...
					<td colspan="3" style="background: #fff; border: none;">
						<div>
							<div class="form-check form-check-inline cusRadio m-r-20">
								<input type="radio" onchange="changeRadioTemp(this.value)" checked="checked" name="labradiologyCheck" class="radioCheckCol2 form-check-input" value="" id="lab_radioTemp">
							...
							<div class="form-check form-check-inline cusRadio" style="display: none";>
								<input type="radio" onchange="changeRadioTemp(this.value)" name="labradiologyCheck" class="radioCheckCol2 form-check-input" value="" id="imag_radioTemp">
								<span class="cus-radiobtn"></span> 
...
var i = "";
var invesRadio="";
function changeRadioTemp(radioValue){
	invesRadio=radioValue;
	i++;
...
<script type="text/javascript" language="javascript">
 ...
 $('#addbutton').click(function() {
	...
	arry.push(dataInvestigation)
	 ...
	 if (msg.status == 1)
 	   {
		   alert("Investigation Template Details Inserted successfully"+"S");
		    var pathname = window.location.pathname;
			var accessGroup = "MMUWeb";
