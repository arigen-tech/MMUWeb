...
<div class="content-page">
 ...
 <div class="">
  <div class="container-fluid">
	  ...
	  <div class="internal_Htext">Attendance Offline Data  </div>
...
$j(document).ready(function()
		{
			...
			var captureVendorBillDetailId=localStorage.anmEntryDetailId;
			...
			$('#typeOfVal').val(typeOfVal);
			 ...
			 var valueOfVendor=$('#typeOfVal').val(); 
	            if(valueOfVendor=="anmFirstTime"){
	            	$("#valueSet").append("Attendance offline data saved/ submitted successfully.");
	            }
				...
				if(valueOfVendor=="apmTime"){
              	...
              	$("#valueSet").append("APM Attendance offline data submitted successfully.");
				}
