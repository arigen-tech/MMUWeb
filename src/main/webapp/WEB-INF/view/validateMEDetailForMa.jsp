												...
												<table class="table table-hover table-striped table-bordered">
													...
													<tbody id="dgInvetigationGrid">
														...
														<td>
															...
															<td>
																	<button type="button" name="delete" value="" id="newIdInv"  class="buttonDel btn btn-danger noMinWidth" button-type="delete" onclick="removeRowInvestigation(this);"></button>
																</td>						
														</tr>
												 ...
												 <div class="form-group row" style="display:none;">
                                                                    <label class="col-md-5 col-form-label"> Date of Investigation   </label>
                                                                     <div class="col-md-7">
                                                                         ...
                                                                         <input type="text" class="form-control calDate" name="dateOfInvestigation" id="dateOfInvestigation" placeholder="DD/MM/YYYY" />
                                                                         </div>
                                                                     </div>
                                                          </div>
												</div>
      	     ...
      	     var i=0;
      	      function addNewRowForInvestigation(){
      	     	...
      	     	var	investigationData ='';
					investigationData +='<button type="button" name="delete" value="" id="deleteInves'+i+'"  class="buttonDel btn btn-danger noMinWidth" button-type="delete" onclick="removeRowInvestigation(this);"></button>';
    			                  ...
    			                  var flaga='investigationMe';
    								...
    								$.each(datas, function(i, item) {
										...
										trHTML += ' class="form-control border-input" '+disableFlag+' name="chargeCodeName" autocomplete="off"   onKeyUp="getNomenClatureList(this,\''+func1+'\',\''+url1+'\',\''+url2+'\',\''+flaga+'\');"/>';
    										...
    										trHTML += '<input type="hidden"  name="appointmentId" value=" "  id="appointmentId"/>';
    										...
    										trHTML +=' <input checked=checked class="form-check-input position-static" type="checkbox"  name="checkBoxForValidate" id="checkBoxForValidate'+i+'"><span class="cus-checkbtn"></span>';
    										trHTML +='</div>';
    										trHTML +='</td>';
    						
    										trHTML +='	<td style="display: none"><input type="checkbox"   name="urgent"';
    										trHTML +='	id="uCheck'+i+'" tabindex="1" class="radioAuto" value="1" />';
    										trHTML +='</td>';
    										
    										trHTML +='<td>';
    										trHTML +='	<textarea class="form-control"  name="investigationRemarks" id="investigationRemarks'+i+'" rows="2" maxlength="500"></textarea>';
    										trHTML +=' </td>';
    										...
    										trHTML +='<td>';
    										trHTML +='<button type="button"  name="delete" value="" id="deleteInves'+i+'"  class="buttonDel btn btn-danger noMinWidth" button-type="delete" onclick="removeRowInvestigation(this);"></button>';
    								 	...
    								 	trHTML +='<span class="cus-checkbtn"></span>'; 
    								 	 ...
    								 	 trHTML +='	id="uCheck" tabindex="1" class="radioAuto" value="1" />';
    								 		...
    								 		trHTML +='<td><button name="Button" type="button"  class="buttonAdd btn btn-primary noMinWidth" button-type="add" value=""';  
    								 			...
    								 			trHTML +='tabindex="1" ></button></td>'; 
    								 				trHTML +='<td>';
    								 				trHTML +=' <button type="button" name="delete" value="" id="deleteInves"  class="buttonDel btn btn-danger noMinWidth" button-type="delete" onclick="removeRowInvestigation(this);"></button>';
    								 				trHTML +='</td>';						
    								 				trHTML +='</tr>';
