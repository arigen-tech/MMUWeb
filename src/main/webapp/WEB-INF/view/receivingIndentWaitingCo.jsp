...
$j(document).ready(function(){
 ...
 function getReceivingIndentWaitingList(MODE) {
		...
		var url = "getReceivingIndentWaitingListCo";		
		var bClickable = true;
 ...
 {
	 var storeIssueMIdArr = Id.split('&');
	 window.location="receivingIndentInInventoryCo?id="+storeIssueMIdArr[0]+"&storeIssueMId="+storeIssueMIdArr[1]+"";
 }
 ...
 <div class="">
  <div class="container-fluid">
	  ...
	  <div class="internal_Htext">Indent Receiving (CO)</div>
