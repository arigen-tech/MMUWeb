		...
		<div class="content-page">
			...
			<div class="">
				<div class="container-fluid">
					<div class="internal_Htext">Indent Acknowledgement(CO)</div>
					...
					<div class="row">
									...
									<table class="table table-hover table-striped table-bordered m-t-10">
										...
										<div class="row">
											<div class="col-md-12 text-right">
												<input type="button" class="btn btn-primary" value="Add To Stock" onclick="addToStock()"/>
						...
						<input   type="hidden" class="form-control" id="mmuId" name="cityId" value="<%= cityId %>"/>
	...
	var storeIssueT = jsonResponse.storeInternalIndentTData;
	  for(countT=0; countT<storeIssueT.length;countT++){
		  ...
		  var count = parseInt(countT);
	    	...
	    	htmlTable = htmlTable + "<td style='width: 150px;'><input readonly type='text' class='form-control width80' id='previousReceivedQty"+countT+"' name='previousReceivedQty' value='"+storeIssueT[countT].previousReceivedQty +"'/></td>";
	    }
...
function addToStock(){
	...
	if(value==true){
		document.indentAcknowledgement.action="addToStockIssuedIndentCo";
