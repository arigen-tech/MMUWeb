	...
	<div class="content-page">
		...
		<div class="">
			...
			<div class="container-fluid">
				<div class="internal_Htext">Budgetary Approval List Pending For Quotation (SA)</div>
                                    ...
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead class="bg-success" style="color:#fff;">
												<tr>
													...
													<th id="th2">Approved Date</th>
													<th id="th10">Approx Cost</th>
													
													<th id="th6">LP Type</th>
													<th id="th5">Status</th>
													<th id="th15">Rejected Remarks</th>
	...
	var dataList = jsonData.data;
	 ...
	 for(item in dataList){
	    	 ...
	    	 // htmlTable = htmlTable + "<td >" + dataList[item].reqDate + "</td>";
	    	  ...
	    	  htmlTable = htmlTable + "<td >" + dataList[item].Qstatus + "</td>";
...
function rowClick(budgetaryMId,reqDate,reqNo,approxCost,createdBy,statusId){	
	 window.location.href = "enterQuotationForBudgetary?budgetaryId="+budgetaryMId+"&budgetaryStatus="+statusId;
