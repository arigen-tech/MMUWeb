...
$j(document).ready(function()
		{
			...
			$('#typeOfVal').val(typeOfVal);
			 ...
			 var valueOfVendor=$('#typeOfVal').val(); 
	            if(valueOfVendor=="anmFirstTime"){
	            	$("#valueSet").append("OPD offline data saved/ submitted successfully.");
	            }
				...
				if(valueOfVendor=="apmTime"){
              	...
              	$("#valueSet").append("APM OPD offline data submitted successfully.");
				}
            ...
            function backListReport() {
            	            var valueOfVendor=$('#typeOfVal').val(); 
            	            if(valueOfVendor=="anmFirstTime"){
                             	 window.location.href ="anmEntryApprovalProcess";
               				}
            				if(valueOfVendor=="anmSecondTime"){
