 ...
 {	
 	...
 	for(i=0;i<dataList.length;i++)
 		{	 	
 			...
 			htmlTable = htmlTable +"<td class='width90'><img src='"+dataList[i].fileData+"' class='profileImg'  alt='' width='80%' /></td>";
 			
 			//htmlTable = htmlTable +"<td style='width: 100px; '>'<img src="data:image/png;base64,"+"+dataList[i].fileData+" alt="" />'</td>";
