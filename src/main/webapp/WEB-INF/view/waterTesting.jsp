		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">	
							<form:form name="submitWaterTesting" id="submitWaterTesting" method="post"
										action="${pageContext.request.contextPath}/miAdmin/submitWaterTesting" autocomplete="off">
							...
							<div class="row">								
								...
								<div class="col-md-4">
									<div class="form-group row">
										<div class="col-md-5">
											<label class="col-form-label">Free Chlorine Content<span class="mandate"><sup>&#9733;</sup></span></label>
										</div>
										<div class="col-md-7">
											<div class="input-group mb-2 mr-sm-2">
												<input type="text" class="form-control" name="chlorine" id="chlorine" maxlength="200"/>
    ...
    $j('#testedBy').append(empListValues); */
 	function submitForm() {
		 ...
		 if (location == null || location == "") {
	  	 ...
	  	 if (chlorine == null || chlorine == "") {
         	alert("Please enter free chlorine content");
        	 return false;
    	 }
