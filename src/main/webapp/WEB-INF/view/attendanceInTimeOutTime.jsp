...
function getMMUList(){
	...
	var url = "${pageContext.request.contextPath}/report/attendanceInTimeOutTime?mmu_id="
				+ mmu_id		
			    + "&fromDate="
				+ fromDate
				+ "&toDate="
 ...
 function generateExcelReport(){
  	 ...
  	 if($j("#fromdate").val() == ""){
        ...
        window.location.href  = "${pageContext.request.contextPath}/mis/exportAttendanceInTimeOutTime?mmu_id="
			+ mmu_id		
		    + "&fromDate="
			+ fromDate
			+ "&toDate="
             ...
             <div class="content-page">
                 ...
                 <div class="">
                     <div class="container-fluid">
                         <div class="internal_Htext">Attendance In-time and Out-time Report</div>
