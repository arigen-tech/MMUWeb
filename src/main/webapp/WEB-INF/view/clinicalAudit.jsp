...
<meta http-equiv="X-UA-Compatible" content="IE=edge" />
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/treatmentAudit.js"></script>
...
<div id="wrapper">
	...
	<div class="container-fluid">
		...
		<div class="internal_Htext">Capture Prescription Audit Details</div>
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
...
<!-- ----- Previous visits & Chief	Complaint end here --------- -->	
					...
					<!-- <div style="display:none">	
					 <div class="adviceDivMain" id="button40" onclick="showhide(this.id)">
						<div class="titleBg" style="width: 520px; float: left;">
							<span> MLC Case </span>
					     </div>		
						<input class="buttonPlusMinus" tabindex="1" name="" id="realtedbutton4" value="-" onclick="showhide(this.id)" type="button">
				    	...
				    	<div class="row">
				    		<div class="col-12">
							    <div class="table-responsive">
						      		<table class="table table-bordered" border="0" cellpadding="0" cellspacing="0">
										...
										<tbody id="dgInvetigationGrid">
											<tr>
												<td class="">
													<input type="text" name="" id="" class="form-control width160" disabled>
												</td>
												<td class="">
													<select class="form-control width160">
														<option>Select</option>
					      	...
					      	<div class="row">		
											...
											<div class="col-md-1">
													<div id="viewEcgDocs" >
															<input id="viewEcgDocumentId"  type="button"
						      		...
						      		<table class="table table-bordered" border="0" cellpadding="0" cellspacing="0">
										...
										<tbody id="nomenclatureGrid">
                                                    ...
                                                    <select name="dispensingUnit1" id="dispensingUnit1" class="medium form-control width100" ></select>
														...
														<td><input type="text" name="dosage1" tabindex="1"  onblur="fillValueNomenclature('1')"
...
<input type="hidden" class="input_box" id="actual_fee" style="background: #EFEFEF; border: 1px solid #000; color: #000;" name="actual_fee" size="5" value="" readonly="readonly">
							
								<div class="form-group row ">

									<label class="col-md-4 col-form-label">Exception</label>
	                             <!--  <input type="text" id="auditId" name="auditId" value="">  --> 
									<div class="col-md-7">
								<select class="form-control" id="auditId" class="input_box" onclick="auditData(this.value);">
												</select>
							...
							<div class="col-md-4">
								<div class="form-group row ">
									...
									<div class="col-md-8">
									<input type="radio"  id="finalRemarksObservation" name="finalRemarks" value="A" checked>
				  					...
				  					<label for="newSuggestion" class="redText" >New Suggestion</label>
										<!-- <select id="finalRemarks" name="finalRemarks" class="midium form-control">
											<option value="A">Observation</option>
				    ...
				    <!-- Auditor Feedback End -->
					    ...
					    <div class="row clearfix">		 
							 <div class="col-md-12 text-right m-t-20"> 
								...
								<button type="button" onclick="backToList()" class="btn btn-primary notDisable" >Back</button>	
...
<script type="text/javascript">
            $(document).ready(function() {
               ...
               // console.log("Test "+data.data[0].masAuditsList.length);
               ...
               /*  if (data.data[0].varation != null) {
                ...
                if(data.data[0].masAuditsList.length!=0){
                	var auditDrop ='';
                	
                	//var auditDrop = '<option value="0">Select</option>';
                	for(i=0;i<data.data[0].masAuditsList.length;i++){
                		console.log(data.data[0].masAuditsList[i].auditName);
                		auditDrop += '<option value='+data.data[0].masAuditsList[i].auditId+'>'+data.data[0].masAuditsList[i].auditName+'</option>';
                	}
                	
                	$('#auditId').append(auditDrop);
...
<script>
	...
	function disableAllInput(){
		...
		$('#auditorRemrks').removeAttr('disabled');
		$('#finalRemarksObservation').removeAttr('disabled');
		$('#finalRemarksSuggstion').removeAttr('disabled');
		$('#viewEcgDocumentId').removeAttr('disabled');
		$('#viewEcgDocs').removeAttr('disabled');
		$('#pdfModal button').removeAttr('disabled');
		$('#exampleModal .close').removeAttr('disabled');
   ...
   function auditData(element)
   {  //alert(element);

	   selectElement = document.querySelector('#auditId');
       output = selectElement.value;
       console.log("Select ID::"+output);
       document.getElementById("actual_fee").value = element;
           //element.options[element.selectedIndex].id;
       console.log(document.getElementById("actual_fee").value);
   }
