		...
		<div class="content-page">
			...
			<div class="">
				<div class="container-fluid">
					<div class="internal_Htext">Stock Status Report (CO)</div>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									...
									<div id="divSummary"  class="scrollableDiv"  style="display:none">
									...
									<div id="divDetails"  class="scrollableDiv"  style="display:none">
									<table class="table table-hover table-striped table-bordered m-t-10"  >
										<thead class="bg-primary">
											<tr>
												<th>S.No.</th>
...
function printStockStatusReport(flag){
		 ...
		 var url="${pageContext.request.contextPath}/store/printStockStatusReport?mmuId="+mmuId+"&deptId="+deptId
