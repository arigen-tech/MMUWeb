		...
		<div class="content-page">
			...
			<div class="">
				<div class="container-fluid">
					<div class="internal_Htext">Indent Approval (CO)</div>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
										<form:form name="submitIndentDispencery" id="submitIndentDispencery" method="post"
										action="${pageContext.request.contextPath}/dispencery/approveIndentDispenceryByCO" autocomplete="off">
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group row">
												<div class="col-md-5">
													<label for="service" class="col-form-label">Approved By</label>
												</div>
												<div class="col-md-7">
													<input type="text" class="form-control" id="approvedBy" name="approvedBy" readonly="readonly"/>
												</div>
											</div>
										</div>
									...
									<div class="table-responsive scrollableDiv m-b-10">
									<table
													...
													<input type="submit" class="btn  btn-primary"
														...
														value="Submit" id="saveForm1" tabindex="1" onclick="return submitForm();"/>
														 <a  class="buttonDel  btn btn-primary" role="button"
															href="${pageContext.request.contextPath}/dispencery/getIndentApprovalListForCO">Close</a> 
														<%-- <a  class="buttonDel  btn btn-primary" role="button"
    	 ...
    	 for(item in resultList){
    		 ...
    		 if(item==1){
    			   $j('#indentNo').val(resultList[item].indentNo);
    		  	   ...
    		  	   $j('#approvedBy').val(resultList[item].approvedBy+" ("+resultList[item].approvedByDsg+")");
    		  	   $j('#toDeptName').val(resultList[item].toDeptId);
    		  	 $j('#auditorDate').val(resultList[item].auditorDate);
    		  	 $j('#auditorName').val(resultList[item].auditorName);
    		  	 $j('#auditorAction').val(resultList[item].auditorAction);
    		  	 $j('#auditorRemarks').val(resultList[item].auditorRemarks);
    		 }
    		 ...
    		 if(resultList[item].availableStock == null){
    			 $('#availableStock'+j).val('0');
    		 }else{
...
function submitForm() {
	  ...
	  $("#nomenclatureGrid tr").each(function () {
		 ...
		 var remarks=$(this).find('td:eq(7)').find(':input').val();
		 var itemId=$(this).find('td:eq(8)').find(':input').val(); 
