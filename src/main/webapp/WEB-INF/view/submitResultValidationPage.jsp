...
<script type="text/javascript">
           ...
           {
           	document.submitResultValidatedForm.action="${pageContext.request.contextPath}/report/generateResultValidatedReport?orderHdId="+orderHdId+"";
           	document.submitResultValidatedForm.method="POST";
           	document.submitResultValidatedForm.submit(); 
           	
           }

           function makeUrl(){
        		
       		var url="${pageContext.request.contextPath}/report/generateResultValidatedReport?orderHdId="+orderHdId+"";
       		openPdfModel(url);
       	}
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-12">
							...
							<h5 style="color:green; font-weight: bold;">Result Validated Successfully</h5> 
									<form name="submitResultValidatedForm" id="submitResultValidatedForm" method="">
