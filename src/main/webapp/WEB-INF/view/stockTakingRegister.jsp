...
<title>Stock Taking Register</title>
...
function compareDate(){
 ...
 function printReport(){
	 ...
	 var url="${pageContext.request.contextPath}/report/printStockTakingRegister?mmuId="+mmu_id+"&deptId="
			 +deptId+"&fromDate="+fromDate+"&toDate="+toDate
			 +"&User_id="+User_id
			...
			<div class="content-page">
				...
				<div class="">
					<div class="container-fluid">
						...
						<div class="internal_Htext">Physical Stock Taking/Stock Adjustment Register</div>
