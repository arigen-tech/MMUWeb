...
var serviceNo='';	
 ...
 function getLoginShipAuthentication(){
	 $("#loadingDiv").show();
	 if($("#userId").val()=="")
		{
			alert("Please enter the AD Id");
...
<body class="pb-0 shiplogin-page">
	...
	<div class="container clearfix">
		<div class="headerLeft">
					<img class="headerlogo" src="${pageContext.request.contextPath}/resources/images/logo-icg1.png"
						alt="logo">
						<span class="headertext">
							<!-- <div class="mainText"></div> -->
							<div class="subText">Indian Coast Guard</div>
						</span>
		</div>
		
		<div class="headerRight">
					<img src="${pageContext.request.contextPath}/resources/images/ship-head2.jpg"
						alt="logo">
		</div>
	</div>
	</div>
	
	<div class="container shipLoginBox clearfix ">
	
		<a class="importBtn" href="javascript:getImport()">Import Data To Ship<span class="badge" id="importId"></span></a>
		
		<span class="bnrText">
			Indian Coast Guard <br/>
			<small>Safer Lives... Safer Coasts... Safer Seas</small>
		</span>
		<div class="loginbox">
			...
			<!--  <div class="form-actions text-center">
					 <button class="btn btnLog" id="signIn" type="button" onclick="checkLandingPage();">Log In</button>
				</div> -->
				<div class="form-actions text-center">

					<button class="btn btnLog" id="signIn" type="button"
						onclick="getLoginApiSession();">Log In</button>
				</div>
				<!-- <span class="forget-pas">getLoginShipAuthentication()
	...
	<script>
		$(document).keypress(function(e) {
			var key = e.which;
			if (key == 13) {
				getLoginShipAuthentication();
			}
		});
		
		function checkLandingPage()
		{
			window.location = "${pageContext.request.contextPath}/dashboard/homeShipLanding";	
		}
