...
<body>
					...
					<div class="row">
						<div class="col-12">
							...
							<form:form name="submitMedicalExamByMA3A" id="submitMedicalExamByMA3A" method="post"  enctype='multipart/form-data'
									...
									<input type="hidden" name="saveInDraft" id="saveInDraft" value="draftPRMo3A"/>	
									...
									<!-- 	<div class="col-12  m-b-10">
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<textarea name="remarksOfLab" id="remarksOfLab" class="form-control"></textarea>
												</div>
											</div>
										</div>
										<div class="col-md-4">
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<input type="text"   name="signatureOfMedicalSpecialist" id="signatureOfMedicalSpecialist"  class="form-control"/>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost14">
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<textarea  name="remarksOfSurgery" id="remarksOfSurgery" class="form-control"></textarea>
												</div>
											</div>
										</div>
										<div class="col-md-4">
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<input type="text" name="signatureOfSurgicalSpecialist" id="signatureOfSurgicalSpecialist" class="form-control"/>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost17">
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<textarea name="remarksOfGynaecology" id="remarksOfGynaecology"class="form-control"></textarea>
												</div>
											</div>
										</div>
										<div class="col-md-4">
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<input type="text"  name="signatureOfGynaecologist" id="signatureOfGynaecologist" class="form-control"/>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
															<input type="text" name="checkupDate" id="checkupDate" class="noFuture_date form-control" placeholder="DD/MM/YYYY" >
														</div>
													</div>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-2">
														<input type="text" name="evidenceOfTrachoma" id="evidenceOfTrachoma"  class="form-control"/>
													</div>
												</div>
											</div>
											<div class="col-md-12">
										...
										<div class="col-12">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<input type="text" id="manifestHypermetropiaMyopia" name="manifestHypermetropiaMyopia" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<input type="text" id="coverTest" name="coverTest" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
													<input type="text" id="diaphragmTest" name="diaphragmTest" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<input type="text" id="fundiMedia" name="fundiMedia" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<input type="text" id="fieldSpecial" name="fieldSpecial" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<input type="text" id="nightVisualCapacity" name="nightVisualCapacity" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-md-3">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="convergenceC" id="convergenceC" class="form-control"  onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
													...
													<div class="col-md-3">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="convergenceSC" id="convergenceSC" class="form-control"  onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-md-3">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" id="accomodationR" name="accomodationR" class="form-control">
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
													...
													<div class="col-md-3">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" id="accomodationL" name="accomodationL" class="form-control">
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<textarea class="form-control" name="manifestHypermetropiaMyopiaRemarks" id="manifestHypermetropiaMyopiaRemarks" rows="3"></textarea>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text"   name="signatureOfEyeSpecialist" id="signatureOfEyeSpecialist"  class="form-control"/>
													</div>
												</div> 
											</div>
										...
										<div class="col-md-4">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" type="text" id="noseSinuses" name="noseSinuses"  class="form-control" value="NAD">
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" type="text" id="throatSinuses" name="throatSinuses"  class="form-control" value="NAD">
													</div>
												</div>
											</div>
											<div class="w-100"></div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<textarea class="form-control" name="noseThroatSinusesRemarks"  id="noseThroatSinusesRemarks" rows="3"></textarea>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" name ="signatureOfENTSpecialist" id="signatureOfENTSpecialist" class="form-control">
													</div>
												</div>
											</div>
 ...
 -->
										...
										<div class="opdMain_detail_area" >
											...
											<div class="col-md-8">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<!-- <input type="text" name="finalObservationRmo" id="finalObservationRmo" class="form-control" disabled/> -->
														<!-- <textarea name="finalObservationRmo" id="finalObservationRmo" class="form-control" disabled></textarea> -->
											...
											<!-- <div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" name="remarksRmo" id="remarksRmo" class="form-control" disabled/>
													</div>
												</div>
											</div> -->
										...
										<div class="opdMain_detail_area" >
											...
											<h4 class="service_htext">Final Observation By Perusing Authority</h4>
											...
											<div class="col-md-8">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<!-- <input type="text" name="finalObservationPRmo" id="finalObservationPRmo"  class="form-control" maxlength="500"/> -->
														<!-- <textarea name="finalObservationPRmo" id="finalObservationPRmo"  class="form-control" maxlength="500"></textarea> -->
													 <div id="finalObservationPRmoJ">
														</div>
													 <input type="hidden" name="finalObservationPRmo" id="finalObservationPRmo" value=""/>  
											...
											<!-- <div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" name="remarksPRmo" id="remarksPRmo" class="form-control"/>
													</div>
												</div>
											</div> -->
											...
											<div class="col-md-8">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<input type="text"  name="signedByPRMo" id="signedByPRMo"class="form-control" disabled />
													</div>
												</div>
											</div>
											</div>
												...
												<div class="row m-t-10">
													<div class="col-md-12 text-right">
														...
														<input type="button" id="sumbitByMo3A"
															...
															onclick="return submitMOForm3A('draftPRMo3A');" value="Submit" />
...
<script>
	...
	function test(buttonId,newpost){
	 ...
	 var investigationForUom="";
	 		...
	 		function getttttttttttttttttttttttt() {
		...
		function checkVaration()  {
		 ...
		 function populateChargeCode(val, count, item) {
	        ...
	        var arryNomenclature= new Array();
	          ...
	          function getMastStoreItemddddddddddd(){
	      	  var pathname = window.location.pathname;
	      		var accessGroup = "MMUWeb";
