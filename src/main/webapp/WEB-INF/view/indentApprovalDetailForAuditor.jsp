...
<title>Indent Approval (Doctor)</title>
		...
		<div class="content-page">
			...
			<div class="">
				<div class="container-fluid">
					<div class="internal_Htext">Indent Approval (Doctor)</div>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
										<form:form name="submitIndentDispencery" id="submitIndentDispencery" method="post"
										action="${pageContext.request.contextPath}/dispencery/approveIndentDispenceryByAuditor" autocomplete="off">
									...
									<div class="row">
                                       ...
                                       <input type="hidden" id="doctor" name="doctor" value="doctorValue"/>
										<div class="col-md-4">
											<div class="form-group row">
												<div class="col-md-5">
													...
													<input type="submit" class="btn  btn-primary"
														...
														value="Submit" id="saveForm1" tabindex="1" onclick="return submitForm();"/>
														 <a  class="buttonDel  btn btn-primary" role="button"
															href="${pageContext.request.contextPath}/dispencery/getIndentApprovalListForAuditor">Close</a> 
														<%-- <a  class="buttonDel  btn btn-primary" role="button"
...
function submitForm() {
	  ...
	  localStorage.doctorFlag='doctorValue';
	  var flag=0;
