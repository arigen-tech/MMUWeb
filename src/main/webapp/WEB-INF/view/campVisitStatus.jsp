    ...
    <div id="wrapper">
		<div class="content-page">
			<div class="">
				...
				<div class="internal_Htext">Camp Visit Status</div>
										 ...
										 <div class="col-md-4">
											<div class="form-group row">
												<div class="col-sm-12 text-right">					
												 <button type="button" class="btn btn-primary reception_mi_reports m-t-5"  onclick="generateReport();"> Generate Report</button>
								...
								<!-- 	<div id="tblLabHistoryDetails"
												...
												<table class="table table-striped table-hover  table-bordered  ">
													<thead>
														<tr>
															 <th id="th1">S.No</th> 
															<th id="th2">Auditor Name</th>
															<th id="th3">Total camp visit</th>
...
<script type="text/javascript">
	...
	/* if((mobileNo == undefined || mobileNo == '')){	
		...
		if (MODE == 'ALL') {
			var data = {"pageNo" : nPageNo, "hospitalId":<%=hospitalId %>}

		} else {
			var data = {"mobileNo" : mobileNo, "patientName":patientName, "fromDate":fromDate, "toDate":toDate, "pageNo" : nPageNo, "investigationName":investigationName, "hospitalId":<%=hospitalId %>}
...
var url = "${pageContext.request.contextPath}/report/printCampVisitStatusReport?fromDate="
		+ fromDate
		+ "&toDate="
		+ toDate;
