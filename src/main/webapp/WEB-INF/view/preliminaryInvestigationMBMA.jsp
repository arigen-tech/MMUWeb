                            ...
                            <head>
                             ...
                             <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/medicalBoard.js"></script>
                              <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/autocomplete/commonAutocomplete.js"></script>
                                ...
                                <title>Preliminary Investigation MB(MA)</title>
                                        ...
                                        <div class="content-page">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="container-fluid">
                                                    <div class="internal_Htext">Preliminary Investigation MB(MA)</div>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                      ...
                                                                      <input  name="checkForIVal" id="checkForIVal" type="hidden" value="0" />
											...
											<thead class="bg-success" style="color:#fff;">
												...
												<tbody>
												  <tr>
													...
													<td style="display: none";><input type="hidden"
														value="" tabindex="1" id="compositeCategoryIdVal" size="77"
														name="compositeCategoryIdVal" /></td>	
                                                                      ...
                                                                      <td>
		                                                                <div class="dateHolder">
														                    <input type="text" id="categoryDate" 
														                     ...
														                     placeholder="DD/MM/YYYY" onChange="return generateNextDate(this);" value="" maxlength="10" />
													                    </div>
		                                                              </td>
                                                                       <td>
                                                                        	<div class="dateHolder">
												...
												<div class="col-md-6">
                                                                  ...
                                                                  <!--   <div class="row">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12 m-t-10 clearfix">
                                                                            <div class="btn-right-all">
                                                                            <input type="submit" class="btn btn-primary" value="Save"  id="clicked" tabindex="1" onclick="saveInvestigationDetails(this.value);"/>
                                                                              <!--    <button type="submit" class="btn btn-primary" value="save"  id="clicked" tabindex="1" onclick="saveInvestigationDetails(this.value);">Save</button> -->
                                                                             </div>
                                                                        </div>
                                                                    </div>
                                                                  <div class="col-md-4">
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button class="btn btn-primary" data-dismiss="modal"
							onClick="closeMessageInv();" aria-hidden="true">
           ...
           /////////////////////// Medical Cateogry validation part ////////////////////////////
               ...
               var  idforInvestigation='';
		    	...
		    	var dataJSON={
    	      			...
    	      			'compositeCategoryIdVal':$('#compositeCategoryIdVal').val(),
...
function getMedicalCategoryData() {
	...
	$.ajax({
				...
				$.each(datas, function(i, item) {
						...
						if(icdName==undefined)
						{ 
							$('#compositeCategoryIdVal').val(patientMedicalCategoryId)		
						}
						if(icdName!=""){
...
function getAFMSFInvestigation() {
	...
	var data = {
	 ...
	 var pathname = window.location.pathname;
    var accessGroup = "MMUWeb";
    var url = window.location.protocol + "//" + window.location.host + "/" + accessGroup + "/medicalBoard/getInvestigationAndResult";
	$.ajax({
				type : "POST",
				contentType : "application/json",
				...
				success : function(res) {
					...
					if (data != null && data.length > 0) {
						...
						var resultHdId=0;
							...
							investigationData+='<td><textarea class="form-control" id="investigationRemarks" maxlength="500" value="" placeholder="investigationRemarks">'+data[i].investagationRemarks+'</textarea></td>';
				...
				success : function(response) {
                  ...
                  var disableFlag="";
					$.each(datas, function(i, item) {
							...
							trHTML += '	</td>';
							trHTML+='<td style="display: none";><input type="hidden" value="'+investigationId+ '"  id="investigationIdValue'+ investigationId + '" tabindex="1" id="inestigationIdval" size="77" name="inestigationIdval" /></td>';

							trHTML+='<td><textarea class="form-control" id="investigationRemarks" value="'+item.investagationRemarks+'" placeholder="investigationRemarks"></textarea></td>';
				   ...
				   else
					{
					   ...
					   oldautocomplete(inVal, arryInvestigation);
