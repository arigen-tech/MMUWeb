...
<script type="text/javascript">
	...
	function getMMUList(){
		...
		function generateReport(){
	       ...
	       var url = "${pageContext.request.contextPath}/report/printMedicineIssueRegister?fromDate="
			+ fromDate
			+ "&toDate="
			+ toDate
			+ "&mmu_id="
	...
	<div id="wrapper">
		<div class="content-page">
			...
			<div class="container-fluid">
				...
				<div class="internal_Htext">Medicine Issue Register</div>
								...
								<div class="row">
									...
									<div class="col-lg-4 col-sm-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<div class="dateHolder">
													<input type="text" name="toDate" id="toDate" class="calDate form-control" value="" placeholder="DD/MM/YYYY" onchange="compareToFromDate();">
												</div>
											</div>
										</div>
									</div>						
