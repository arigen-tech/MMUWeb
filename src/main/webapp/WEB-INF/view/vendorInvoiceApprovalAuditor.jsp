...
$(document).ready(function(){
    ...
    $('#back').on('click', function(){
        window.location = 'vendorBillApprovalListAuditor';
    });

    $('#submitBtn').on('click', function(){
        var values = [];
        $('[name="auditorsRemarks"]').each(function(i, $obj){
            if(!$($obj).val()){
                $($obj).focus()
                ...
                var remarks = $($obj).val();
                values.push({'id': id, 'remarks': remarks});
            }
        });
        ...
        var formData = new FormData(document.getElementById("vendorBillAuditorForm"));
        ...
        formData.append('remarksType', 'AUDITOR');
...
function loadBillDetails(){
    ...
    jQuery.ajax({
        ...
        method: "GET",
        crossDomain:true,
        url: 'vendorInvoiceDetailDataAuditor',
        ...
        success: function(result){
            if(result && result.vendorInvoiceDetailData && result.vendorInvoiceDetailData.data && result.vendorInvoiceDetailData.data.length > 0){
                ...
                if(rowData.status && rowData.status != 'P')
	...
	<div id="wrapper">
		<div class="content-page">
			...
			<div class="container-fluid">
				...
				<div class="internal_Htext">Vendor Invoice Approval for Auditor</div>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="row"><div class="col-md-2">
								    <form id="vendorBillAuditorForm">
                                    <input type="file" name="fileName" data-toggle="tooltip" title="No File Selected" class="form-control upload-files" style="padding: 0rem; height: 29px;width: 200px">
								    </form>
								</div></div><br>
