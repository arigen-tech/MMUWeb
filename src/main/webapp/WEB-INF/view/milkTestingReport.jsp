...
<div id="wrapper">
	<div class="content-page">
		...
		<div class="container-fluid">
			<div class="internal_Htext">Milk testing for specific gravity</div>
		<form name="frm">		
			<div class="row">
				<div class="col-12">
					<div class="card">
							...
							<div class="row">								
								...
								<div class="col-md-2 text-right">
									...
									<button id="printReportButton" type="button" class="btn btn-primary noMinWidth"  onclick="makeUrl()">Report</button>
									 ...
									 <a id="newEnt" class="btn btn-primary" role="button" href="${pageContext.request.contextPath}/miAdmin/createMilkTesting">New Entry</a>
...
function GetMilkTestingReport(MODE)
{
	...
	var dataList = jsonData.data;
	 ...
	 for(item in dataList){
			 ...
			 // htmlTable = htmlTable + "<td >" +i+ "</td>";
	    	  ...
	    	  htmlTable = htmlTable + "<td >" + dataList[item].gravity + "</td>";
...
function downloadReport() {
	...
	document.frm.action="${pageContext.request.contextPath}/report/printMilkTestingRegister";
...
function makeUrl(){
	...
	var url="${pageContext.request.contextPath}/report/printMilkTestingRegister?fromDate="+fromDate+"&toDate="+toDate+"&unitId="+unit;
	openPdfModel(url);
