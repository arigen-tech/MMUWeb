						...
						<div class="col-12">
							...
							<form:form name="submitMedicalExamByMo" id="submitMedicalExamByMo" method="post" enctype='multipart/form-data'
								 ...
								 <input type="hidden" name="visitId" id="visitId" value="${visitId}"/>
									...
									<input type="hidden" name="saveInDraft" id="saveInDraft" value="draftRMo"/>		
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost14">
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label for="service" class="col-form-label">Nos of Abortions <span style="color: red"><sup>&#9733;</sup></span></label>
													</div>
													<div class="col-md-7">
											...
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label for="service" class="col-form-label">Nos of Children <span style="color: red"><sup>&#9733;</sup></span></label>
													</div>
													<div class="col-md-7">
 ...
 -->											
								...
								<div class="opdMain_detail_area" >
									...
									<div class="row m-t-10">
											...
											<input type="button" id="submitByMo" class="btn btn-primary" onclick="return submitMOForm('draftRMo');"
															value="Submit"/>
	...
	<%--   var arry = new Array();
	  ...
	  $(document).ready(
       	 ...
       	 var investigationForUom = "";
       	 				...
       	 				function getInveeeeeeMMMMMMMeee() {
	        ...
	        var arryNomenclature= new Array();
	          ...
	          function getMastStoreItemsssss(){
	      	  var pathname = window.location.pathname;
	      		var accessGroup = "MMUWeb";
		...
		if(approvalFlag=='y' || draftRMo == 'draftRMo'){
