...
/* if(approvalFlg=='pe'){
	window.location.href = "${pageContext.request.contextPath}/medicalexam/meInboxProcess?visitId="+visitId+"&age="+age+"&approvalFlag=y";
		...
		if(meTypeCode=="MB15")
		{	
		     window.location.href = ""+url+"mbValidateDetailsForm15ForForwardData?visitId="+visitId+"&age="+age;
		}
		else if(meTypeCode=="MB16")
		{
			window.location.href = ""+url+"mbValidateDetailsForm16ForForward?visitId="+visitId+"&age="+age;	
		}
		else
		{
			window.location.href = "mbValidateDetailsForm15ForForwardData?visitId="+visitId+"&age="+age;
		}
 }
