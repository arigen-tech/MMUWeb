...
<script type="text/javascript">
	...
	function executeClickEvent(captureVendorBillDetailId,data){
        window.location = 'vendorInvoiceApprovalAuditor?detail='+captureVendorBillDetailId;
	}
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="">
                ...
                <div class="internal_Htext">Pending Vendor Bill Approval List for Auditor</div>
