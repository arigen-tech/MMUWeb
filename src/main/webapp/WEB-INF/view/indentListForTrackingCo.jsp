	...
	<div class="content-page">
		...
		<div class="">
			...
			<div class="container-fluid">
				<div class="internal_Htext">Indent Tracking List (CO)</div>
...
function GetListOfIndent(MODE)
{
	...
	var url = "getIndentListForTrackingCo";
...
function rowClick(indentId,indentNo,indentdate,toDept,createdBy,approvedBy,status,statusId){	
	 window.location.href = "getIndentDetailsForTrackingCo?indentId="+indentId+"&indentStatus="+statusId;
