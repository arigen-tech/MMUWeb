...
function searchMEHistoryList(MODE)
{
	...
	var employeeName=$j('#employeeName').val();	
	 if(MODE == 'ALL'){
			var data = {"pageNo":nPageNo, "serviceNo":searchService,  'mestatus':'','examTypeId':examTypeId,'yearOfMeMB':yearOfMeMB,'yearOfMeMBTo':yearOfMeMBTo,'employeeName':employeeName,'hospitalId':'<%=hospitalId%>'};			
		}
	 else if(MODE == 'FILTER'){
	...
	for(i=0;i<dataList.length;i++)
		...
		meTypeCode=dataList[i].meTypeCode;
			...
			if(dataList[i].meApprovalRidcId!=null && dataList[i].meApprovalRidcId!=""){
				htmlTable= htmlTable + "  <button id ='printBtn' type='button'  class='btn btn-primary' onclick='viewDocumentForDigi(\""+dataList[i].meApprovalRidcId+"\");'>View ME signed Doc</button>";
			}
		...
		<div class="content-page">
			<div class="">
				<div class="container-fluid">
					<div class="internal_Htext"><spring:message code="meMbHistory" /></div>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-4">
											...
											<!-- <div class="form-group row">
												<div class="col-md-5">
													<label for="service" class="col-form-label">To </label>
												</div>
												
												<div class="col-md-7">
													<select class="form-control" id="yearOfMeMB"
														name="tearOfMeMB">
														<option value="0">Select</option>
													</select>
													<div class="dateHolder">
									...
									<table
										...
										<thead class="bg-primary">
											<tr>
												...
												<th>Gender</th>
												<th>Medical Exam/Board</th>
												<th>Date Of Exam/Board</th>
												<th>Status</th>
												<th>Action</th>
											</tr>
										</thead>
