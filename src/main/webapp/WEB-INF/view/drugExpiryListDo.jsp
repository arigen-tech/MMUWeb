...
function getMMUList(){
 ...
 function getDrugExpiryList(MODE) { 	
	...
	if (nomenclature === undefined) {
 	 ...
 	 if(MODE == 'ALL')
 		{
 		var data = {"districtId": <%= districtId %>, "departmentId": <%= departmentId %>, "from_date":"","to_date":"", "pvmsNo":"", "nomenclature":"", "pageNo":nPageNo}; 			
 		}
 	else
 		{
 		var data = {"districtId": <%= districtId %>, "departmentId": <%= departmentId %>, "from_date":from_date,"to_date":to_date, "pvmsNo":pvms_no, "nomenclature":nomenclature, "pageNo":nPageNo};
 		} 
