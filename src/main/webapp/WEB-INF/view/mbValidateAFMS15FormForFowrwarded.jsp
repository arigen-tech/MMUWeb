...
%>
                            ...
                            <body>
                                <div id="wrapper">
                                        ...
                                        <div class="content-page">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="container-fluid">
                                                    <div class="internal_Htext">AFMSF-15 (Validate MO)</div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-md-1">
                                                                            <button type="button" id="ehrBtn" onClick="return showEHRRecords();" class="btn btn-primary btn-block">EHR</button>
                                                                        </div>

                                                                        <div class="col-md-3">
                                                                            <button type="button" id="meBtn" onClick="return getCompleteMedicalExamMEOrMB('ALL','SearchStatusForUnitAdmin','me');"  class="btn btn-primary btn-block">PREVIOUS MEDICAL EXAMS</button>
                                                                        </div>

                                                                        <div class="col-md-3">
                                                                            <button type="button" id="mbBtn" onClick="return getCompleteMedicalExamMEOrMB('ALL','SearchStatusForUnitAdmin','mb');" class="btn btn-primary btn-block">PREVIOUS MEDICAL BOARDS</button>
                                                                        </div>

                                                                        <div class="col-md-2">
                                                                            <button type="button" id="immuBtn" onClick="return showImmunizationTemplateMe('aa');" class="btn btn-primary btn-block">IMMUNIZATIONS</button>
                                                                        </div>
                                                                        <div class="col-md-3">
									...
									<input type="hidden" name="visitStatusCheck1" id="visitStatusCheck1" value="" />	
                                                                    ...
                                                                    <div class="row">
																		...
																		<div class="col-md-4">
																			<div class="form-group row">
																				...
																				<div class="col-md-7">
																					<div class="input-group mb-2 mr-sm-2">
																						<input name="weight" id="weight" maxlength="3" onblur="checkVaration()" type="text"
														...
														<div class="form-group row">
															...
															<div class="col-md-3">
																<select class="form-control" id="actionMe"
																	name="actionMe" onChange="return changeActionSelect(this);">
																	<option value="0">Select</option>
									...
									<div class="row m-t-20">
										<div class="col-12 text-right">
											...
											<input type="button" id="verifyCheckBtn" value="Verify Employability Restrictions CheckList" tabindex="1" class="btn btn-primary"
											...
											<!-- <input type="button" id="clicked" class="btn btn-primary"
															value="Submit"/> -->
											<input type="button" onclick="goBack()" class="btn btn-danger" id="closebtn" value="Close"/>								
...
$(document).ready(function() {
    ...
    var visitStatusCheck1=localStorage.visitStatusCheck1;
	 document.getElementById('visitStatusCheck1').value = visitStatusCheck1;
	 if(document.getElementById('visitStatusCheck1').value=='O')
     {
   	  	document.getElementById("actionMe").disabled = true;
	...
	function test(buttonId,newpost){
	 ...
	 $('#clicked').click(function() {
		 ...
		 $('#medicalBoardDocs tr').each(function(ij, el) {
				...
				if(filenameWithExtension!="" && filenameWithExtension!=null && validateFileExtension(filenameWithExtension, "valid_msg", "Only pdf/image/mp4 files are allowed ",
         ...
         if( $('#forwardTo').val()==0 && $('#actionMe').val()!="pending")
         {
        	 alert("Please Select Forward To  before submit form");
        	 return false;
         }
         if( $('#designationForMe').val()==0 && $('#actionMe').val()!="pending")
         {
         ...
         var amsfFormData1 = $('#amsfForm15Data')[0];
    		...
    		var dateCheck1=$('#signDate').val();
      	     var yyyy1 = dateCheck1.split("/")[2];
      	   	formData.append('year',yyyy1);
         ...
         $.ajax({
             ...
             success: function(msg) {
                 ...
                 {
                    var Id= $('#visitId').val()
                    window.location.href ="moValidate15Submit?visitId="+Id+"";
                 } 
					...
					.ajax({
						...
						$.each(datas, function(i, item) {
							...
							{    
								 ...
								 appnedOrigin+='<td><input type="text" value="'+placeOfOrigin+'" tabindex="1" class="form-control" id="placeOfOrigin'+i+'" name="placeOfOrigin" readonly/></td>';
				...
				.ajax({
					...
					$.each(datas, function(i, item) {
			            ...
			            document.getElementById('typeOfCommission').value =typeOfCommission;
			                    ...
			                    var actionMe=item.forwardStatus;
					            if(actionMe!="" && actionMe=="af")
					            {
					             	actionMe='approveAndForward';
					            	document.getElementById('actionMe').value=actionMe;	
					            	$('#forwardStatus').show();
					            }
					            var forwardTo=item.forwardUnitId;
					            if(forwardTo!="" && forwardTo!=null)
					            {
					            	document.getElementById('forwardTo').value=forwardTo;
					            	$("#forwardTo").trigger("onchange");
					            	document.getElementById("forwardTo").disabled = true;
					            			            			            	
					            }
		
				            	var designationForMeVal=item.fowardedDesignationId;
				                if(designationForMeVal!="" && designationForMeVal!=null)
				                {
				                   getMasDesignationMappingByUnitIdByHospitalIdAndDesigMB(forwardTo,designationForMeVal);
				            	//	
				                }
	 ...
	 function changeActionSelect(val){
...
function diasableFormField(){
	 ...
	 $('#ehrBtn').removeAttr('disabled');
	 $('#meBtn').removeAttr('disabled');
	 $('#mbBtn').removeAttr('disabled');
	 $('#immuBtn').removeAttr('disabled');
	 $('#specialistOpinion').removeAttr('disabled');
	 $('#verifyCheckBtn').removeAttr('disabled');
...
function goBack() {
    ...
    var accessGroup = "MMUWeb";
    var url='';
    url = window.location.protocol + "//" + window.location.host + "/" + accessGroup + "/approve/mbApproved";
    window.location=url;
} 	
  </script>
