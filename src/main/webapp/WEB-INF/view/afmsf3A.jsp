					...
					<div class="row">
						<div class="col-12">
							...
							<form:form name="submitMedicalExamByMA3A" id="submitMedicalExamByMA3A" method="post" enctype='multipart/form-data'
									...
									<input type="hidden" name="saveInDraft" id="saveInDraft" value="draftMa3A"/>	
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<!-- <div class="col-md-7">
														<input type="text" name="doeORDoc" id="doeORDoc" class="form-control" readonly/>
													</div> -->
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" name="place" id="place" class="form-control"  maxlength="100"/>
													</div>
												</div>
												 <div class="form-group row">
												  ...
												  <tr>
													...
													<div class="dateHolder">
									                    <input type="text" id="medicalCompositeDate" 
									                     name="medicalCompositeDate" class="noFuture_date5 form-control" 
									                     placeholder="DD/MM/YYYY" value="" maxlength="10" />
											        </div>
												...
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="height" id="height" class="form-control" maxlength="3" onblur="return idealWeight2();checkBMI();" onkeypress="if(isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost7" style="display:block;">
										...
										<div id="fileUploadDynamic">
											...
											<div class="row">
												 <div class="col-md-6">
													<div class="form-group row">
														<label class="col-md-5 col-form-label"> Other Investigation </label>
														<div class="col-md-7">
										...
										<div class="col-md-3">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<input type="text"   name="signatureOfMedicalSpecialist" id="signatureOfMedicalSpecialist"  class="form-control" maxlength="200"/>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost17">
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<div class="dateHolder">
														<input type="text" name="dateOfGynaecology" id="dateOfGynaecology" class="form-control calDate" placeholder="DD/MM/YYYY" />
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<input type="text"  name="signatureOfGynaecologist" id="signatureOfGynaecologist" maxlength="200" class="form-control"/>
												</div>
											</div>
										</div>
									</div>
												...
												<table class="table no-border table-striped">
													...
													<tbody>
														...
														<tr id="ulRow">
															...
															<td>
																<div class="form-check form-check-inline cusCheck cusCheck">
								...
								<div class="adviceDivMain" id="button15" onclick="showhide(this.id)">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-md-3">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="convergenceC" id="convergenceC" class="form-control" maxlength="19" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" >
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
													...
													<div class="col-md-3">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="convergenceSC" id="convergenceSC" class="form-control"  maxlength="19" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" >
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
									...
									<!-- <div class="adviceDivMain" id="button18" onclick="showhide(this.id)">
										...
										<input class="buttonPlusMinus" tabindex="4" name="" id="relatedbutton18" value="-" onclick="showhide(this.id)" type="button">
									</div>
										...
										<table class="table table-hover table-striped table-bordered">
											...
											<tbody>
												<tr>
													...
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="fwR" id="fwR" maxlength="19" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"class="form-control width100" value="610">
															<input type="text" name="fwr" id="fwr"  value="Cms"class="form-control width50" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="fwL" id="fwL" maxlength="19" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" class="form-control width100" value="610">
															<input type="text" name="fwl" id="fwl" class="form-control width50" value="Cms" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="fwBoth" id="fwBoth" maxlength="19" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"class="form-control width100" value="610">
												...
												<tr>
													...
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="cvR" id="cvR" maxlength="19" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" class="form-control width100" value="610">
															<input type="text" name="cvr" id="cvr" class="form-control width50" value="Cms" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="cvL" id="cvL" maxlength="19" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" class="form-control width100" value="610">
															<input type="text" name="cvl" id="cvl" class="form-control width50" value="Cms" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="cvBoth" id="cvBoth" maxlength="19" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" class="form-control width100" value="610">
											...
											<!-- <tbody>
												...
												<tr>
													<td class="width330">Tympanic Membrance Tact <span class="mandate"><sup></sup></span></td>
													<td>
										 ...
										 -->
												...
												<tr>
													...
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="fwR" id="fwR" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"class="form-control width100" value="610">
															<input type="text" name="fwr" id="fwr"  value="Cms"class="form-control width50" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="fwL" id="fwL" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" class="form-control width100" value="610">
															<input type="text" name="fwl" id="fwl" class="form-control width50" value="Cms" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="fwBoth" id="fwBoth" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"class="form-control width100" value="610">
															<input type="text" name="fwboth" id="fwboth" class="form-control width50" value="Cms" readonly/>
														</div>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="cvR" id="cvR" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" class="form-control width100" value="610">
															<input type="text" name="cvr" id="cvr" class="form-control width50" value="Cms" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="cvL" id="cvL" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" class="form-control width100" value="610">
															<input type="text" name="cvl" id="cvl" class="form-control width50" value="Cms" readonly/>
														</div>
													</td>
													<td>
														<div class="form-row from-inline m-l-0">
															<input type="text" name="cvBoth" id="cvBoth" onkeypress="if (isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" class="form-control width100" value="610">
															<input type="text" name="cvboth" id="cvboth" class="form-control width50" value="Cms" readonly/>
														</div>
													</td>
												</tr>
 										...
 										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
															<input class="calDate form-control" type="text">
														</div>
													</div>
												</div>
											</div>
		...
		function checkVaration()  {
		 ...
		 function populateChargeCode(val, count, item) {
	        ...
	        var arryNomenclature= new Array();
	          ...
	          function getMastStoreItem__________(){
	      	  var pathname = window.location.pathname;
	      		var accessGroup = "MMUWeb";
