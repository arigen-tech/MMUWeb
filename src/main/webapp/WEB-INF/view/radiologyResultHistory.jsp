...
$j(document).ready(function() {
	...
	var data = ${data};
	$j('#patient_name1').val(data.resultValidationData[0].patientName);
	$j('#age').val(data.resultValidationData[0].age);
	$j('#gender').val(data.resultValidationData[0].gender);
	$j('#service_no1').val(data.resultValidationData[0].serviceNo);
	$j('#relation').val(data.resultValidationData[0].relation);
	$j('#result').html(data.resultEntry);
	$j('#relation').val(data.resultValidationData[0].relation);
	$j('#investigationName1').val(data.resultValidationData[0].investigationName);
	...
	if(data.resultValidationData[0].status == 'C'){
...
<body>
         ...
         <div class="col-md-4">
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text"  readonly class="form-control-plaintext"    id="patient_name1" name="name" >
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="text"  readonly class="form-control-plaintext"  id="service_no1" name="empService" validate="Service No,string,yes">
                    </div>
                </div>
            </div>
      ...
      <div class="col-md-4">
         ...
         <div class="form-group row">
          ...
          <div class="col-md-7">
           <input type="text"  readonly  class="form-control-plaintext"  id="investigationName1"
            name="investigationName1">
          </div>
         </div>
                              </div>
            </div>
