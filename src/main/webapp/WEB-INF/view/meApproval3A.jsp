					...
					<div class="row">
						<div class="col-12">
							...
							<form:form name="submitMedicalExamByMA3A" id="submitMedicalExamByMA3A" method="post" enctype='multipart/form-data'
									...
									<input type="hidden" name="saveInDraft" id="saveInDraft" value="draftRMo3A"/>	
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost7" style="display:block;">
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<textarea name="remarksOfLab" id="remarksOfLab" maxlength="500" class="form-control"></textarea>
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<div class="dateHolder">
														<input type="text" name="dateOfLab" id="dateOfLab" class="form-control calDate" placeholder="DD/MM/YYYY" />
													</div>
												</div>
											</div>
										</div>
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost14">
										...
										<div class="col-md-4">
											<div class="form-group row">
												...
												<div class="col-md-7">
													<div class="dateHolder">
														<input type="text" name="dateOfSurgery" id="dateOfSurgery" class="form-control calDate" placeholder="DD/MM/YYYY" />
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<textarea name="remarks" id="remarks" class="form-control"  maxlength=200 rows="2" maxlength="500">Dentally fit</textarea>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group row">
													...
													<div class="col-md-2">
														<input type="text" name="binocularVisionGrade" id="binocularVisionGrade"  class="form-control"/>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-12">
											...
											<div class="col-md-6">
												<div class="form-group row">
													...
													<div class="col-md-3">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" id="accomodationR" name="accomodationR"  maxlength="20" class="form-control">
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
													...
													<div class="col-md-3">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" id="accomodationL" name="accomodationL"  maxlength="20" class="form-control">
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-6">
														<div class="dateHolder">
															<input type="text" id="manifestHypermetropiaMyopiaDate" name="manifestHypermetropiaMyopiaDate" class="form-control calDate" placeholder="DD/MM/YYYY" >
														</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
													<input type="text"   name="signatureOfEyeSpecialist" id="signatureOfEyeSpecialist"   maxlength="200" class="form-control"/>
													</div>
												</div> 
											</div>
										...
										<div class="col-md-4">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
															<input type="text" name="noseThroatSinusesDate" id="noseThroatSinusesDate" class="form-control calDate" placeholder="DD/MM/YYYY" />
														</div>
													</div>
												</div>
											</div>
							...
							<div class="opdMain_detail_area" >
																...
																<td>
																	<div class="autocomplete forTableResp">
																		...
																		<!-- <input name="icddiagnosis" id="icddiagnosis"
																			...
																			type="text" class="form-control border-input"
																			placeholder=" " value=""
																			 onKeyUp="getNomenClatureList(this,'fillDiagnosisCombo','opd','getIcdListByName','diagnosisMe');"  />
															...
															<div class="form-group row">
																...
																<div class="col-md-10">
																	<textarea class="form-control" id="finalObservationMo"
																		name="finalObservationMo" rows="2" maxlength="100"></textarea>
																</div>
															</div>
														</div>
													</div>
										...
										<div class="col-md-8">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<!-- <input type="text" name="finalObservationRmo" id="finalObservationRmo" class="form-control" maxlength="500"/> -->
														<!-- <textarea  name="finalObservationRmoJ" id="finalObservationRmoJ" class="form-control" maxlength="500"></textarea> -->
												...
												<div class="row m-t-10">
													<div class="col-md-12 text-right">
														...
														<input type="button" id="sumbitByMo3A"
															...
															onclick="return submitMOForm3A('draftRMo3A');" value="Submit" />
										...
										<div class="col-sm-7">
											<div class="dateHolder dateRightPosition">
												<input class="noFuture_date_ResultDate  form-control" type="text"
													placeholder="" id="investigationResultDateTemp" name="investigationResultDateTemp" value="">
											</div>
										</div>
									</div>
								</div>
...
var obsistyOverWeight='';
	...
	var arryInvestigation = new Array();
	 var investigationForUom = "";
	 				...
	 				function investtttttttttttttttttttttttttttt() {
		...
		function checkVaration()  {
		 ...
		 function populateChargeCode(val, count, item) {
	        ...
	        var arryNomenclature= new Array();
	          ...
	          function getMastStoreItemsssssssssssssssssssss(){
	      	  var pathname = window.location.pathname;
	      		var accessGroup = "MMUWeb";
