...
function getMMUList(){
 ...
 function getDrugExpiryList(MODE) { 	
	...
	if (nomenclature === undefined) {
 	 ...
 	 if(MODE == 'ALL')
 		{
 		var data = {"cityId": <%= cityId %>, "departmentId": <%= departmentId %>, "from_date":"","to_date":"", "pvmsNo":"", "nomenclature":"", "pageNo":nPageNo}; 			
 		}
 	else
 		{
 		var data = {"cityId": <%= cityId %>, "departmentId": <%= departmentId %>, "from_date":from_date,"to_date":to_date, "pvmsNo":pvms_no, "nomenclature":nomenclature, "pageNo":nPageNo};
 		} 
...
/*  function executeClickEvent(Id)
 ...
 function printReport(){
     ...
     var url="${pageContext.request.contextPath}/report/printdrugExpiryReportCO?cityId="+cityId+"&fromDate="+fromDate+"&toDate="+toDate+"&pvmsNo="
