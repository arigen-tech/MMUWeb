                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <p><span class="submitMsg">${msgRecall}</span> </p>   
                                </c:when> 
                                <c:otherwise>
                                	<p><span class="submitMsg">OPD Submitted Successfully</span> </p>
                                </c:otherwise>
                                </c:choose>
                                     ...
                                     <div class="row">
										<div class="col-md-12 text-right"> 
												<button id ='caseSheetReportForOpdSubReport' type='button'  class='btn btn-primary opd_submit_btn'    onclick="printReport('C');">OPD Slip</button> 
												  ...
												  <button id ='prescriptionSlipReport' style="display:none;" type='button'  class='btn btn-primary opd_submit_btn' onclick="printReport('P');">MLC Slip</button> 
