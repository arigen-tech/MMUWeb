...
<div id="wrapper">
	<div class="content-page">
		...
		<div class="container-fluid">
			<div class="internal_Htext">Sanitary Report</div>
			<form name="frm">				
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">	
							...
							<div class="row">								
								...
								<div class="col-md-2 text-right">
									...
									<a id="newEnt" class="btn btn-primary" role="button" href="${pageContext.request.contextPath}/miAdmin/createSanitaryDiary">New Entry</a>
								...
								<div style="float:left">					           
                                    ...
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead class="bg-success" style="color:#fff;">
												...
												<!-- <th>Location</th> -->
												<th>Area</th>
												<th>PMO Observation</th>
												<th>PMO Recommendation</th>
												<th>Action to be Taken by</th>
												<th>Follow Up of Action</th>
												<th>EXO Remarks</th>
												<th>CO's Remarks</th>												
											</tr>
											</thead>
...
function GetListSanitaryReport(MODE)
{
	...
	var dataList = jsonData.data;
	 ...
	 for(item in dataList){
	    	 ...
	    	 /*  htmlTable = htmlTable + "<td >" + dataList[item].location + "</td>"; */
	    	  htmlTable = htmlTable + "<td >" + dataList[item].area + "</td>";
	    	  htmlTable = htmlTable + "<td >" + dataList[item].pmoObservation + "</td>";
	    	  htmlTable = htmlTable + "<td >" + dataList[item].pmoRecommendations + "</td>";
	    	  htmlTable = htmlTable + "<td >" + dataList[item].actionTobeTaken + "</td>";
	    	  htmlTable = htmlTable + "<td >" + dataList[item].followUp + "</td>";
	    	  htmlTable = htmlTable + "<td >" + dataList[item].exoRemark + "</td>";
	    	  htmlTable = htmlTable + "<td >" + dataList[item].coRemark + "</td>";
...
function downloadReport() {
	...
	document.frm.action="${pageContext.request.contextPath}/report/printSanitaryDiaryRegister";
...
function makeUrl(){
	...
	var url="${pageContext.request.contextPath}/report/printSanitaryDiaryRegister?fromDate="+fromDate+"&toDate="+toDate+"&unitId="+unit;
	openPdfModel(url);
