...
<script type="text/javascript">
	...
	function makeTable(jsonData)
	{
		...
		for(i=0;i<dataList.length;i++)
			{
			 ...
			 if(dataList[i].status == 'Y' || dataList[i].status == 'y')
				...
				htmlTable = htmlTable +"<td style='width: 150px;'><button id='viewCapturedInspectionDetails' data-toggle='modal' data-target='#inspectionChecklistDetailModal' type='button' class='btn  btn-primary'>View</button></td>";
        ...
        $('#viewCapturedInspectionDetails').on('click', function(){
            //$('#inspectionChecklistDetailModal').modal();
        });
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="">
                ...
                <div class="internal_Htext">Captured Inspection List</div>
...
<div id="inspectionChecklistDetailModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Captured Inspection Checklist Details</h4>
      </div>
