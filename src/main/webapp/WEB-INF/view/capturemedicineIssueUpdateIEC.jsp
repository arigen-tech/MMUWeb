...
function editRow(itemData,isEditable){
	...
	var newRowContent = '<tr id="'+iteration+'" title="'+itemData.invoiceId+'">'+
		 		 '<td style="display:none;"><select class="form-control" id="medicineSource_'+iteration+'" onChange="getMedicalStore(this.value,'+iteration+');" '+disabled+'>'+
	    		 '<option value="">--SELECT--</option>'+
	    		 
				 '</select></td>'+
				 '<td style="display:none;"><select class="form-control" id="medicineSubSource_'+iteration+'" '+disabled+'>'+
	    		 '<option value="">--SELECT--</option>'+
	    		
				 '</select></td>'+
			 	'<td>'+
			 		'<div class="dateHolder">'+
						'<input type="text" name="invoiceDate" id="invoiceDate_'+iteration+'"	class="calDate form-control" placeholder="DD/MM/YYYY" value="'+itemData.invoiceDate+'" readonly/>'+
					'</div>'+
			 	'</td>'+
 	'<td>'+
	...
	<div id="wrapper">
		<div class="content-page">
			...
			<div class="container-fluid">
				...
				<div class="internal_Htext">View/Update IEC Invoice Details</div>
