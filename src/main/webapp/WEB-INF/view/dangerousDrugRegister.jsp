...
<div id="wrapper">
	<div class="content-page">
		...
		<div class="container-fluid">
			<div class="internal_Htext">DANGEROUS DRUG REGISTER IAFM-1227</div>
			<form name="frm">			
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">	
							...
							<div class="row">								
								...
								<input type="hidden" id="applyFor" name="applyFor" value="D" class="form-control " />
...
function GetDangerousDrugReport(MODE)
{
	var fromDate = $j('#fromDate').val();
	var toDate = $j('#toDate').val();
	var unit = $j('#unitId').val();
	 if(MODE == 'ALL'){
		 var data = {"PN":nPageNo,"fromDate":fromDate,"toDate":toDate,"unit":unit,"flag":"D"};		
		}
	else
		{
		 var data = {"PN":nPageNo,"fromDate":fromDate,"toDate":toDate,"unit":unit,"flag":"D"};
