...
<script type="text/javascript">
	...
	function searchPendingAttendanceList()
	{
		...
		GetAllVendorInvoiceAuth('FILTER');
		//ResetForm();
	} 


	function GetAllVendorInvoiceAuth(MODE){
		...
		var distIdVal=$('#distIdUsers').val();
		 ...
		 if(MODE == 'ALL'){
				var data = {"PN": nPageNo, "invoiceNo": "","fromDate":"","toDate":"","type":"C","authorityId":authorityId,"cityIdVal":cityIdVal};
		 }
		 else if(district != "" || fromDate != ""||toDate != "" || statusSearch != "")
		 {
			 //nPageNo = 1;
		    var data = {"PN":nPageNo,"district":district,"fromDate":fromDate,"toDate":toDate,"statusSearch":statusSearch,"type":"C","authorityId":authorityId,"cityIdVal":cityIdVal};
		 } 
	    else
	    { 
	    	 var data = {"PN":nPageNo,"district":district,"fromDate":fromDate,"toDate":toDate,"statusSearch":statusSearch,"type":"C","authorityId":authorityId,"cityIdVal":cityIdVal};
	...
	function executeClickEvent(captureVendorBillDetailId,data){
		...
		for(i=0;i<dataList.length;i++){
			...
			var id=dataList[i].captureVendorBillDetailId;
			if(lastApprovalMsg.startsWith('Back to TPA') && id==captureVendorBillDetailId){
				window.location = 'rejectedAuditVendorInvoiceDetail?detail='+captureVendorBillDetailId;	
			}else if(id==captureVendorBillDetailId){
				 window.location = 'pendingAuditVendorInvoiceDetail?detail='+captureVendorBillDetailId;
			}
		}
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="">
                ...
                <div class="internal_Htext">Pending Approval List Of Vendor Invoice(Auditor)</div>
