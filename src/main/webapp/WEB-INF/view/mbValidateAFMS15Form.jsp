                    ...
                    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                            ...
                            <head>
                                ...
                                <title>AFMSF-15ValidateMO</title>
                                ...
                                <div id="wrapper">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col-md-1">
                                                                            <button type="button" onClick="return showEHRRecords();" class="btn btn-primary btn-block notDisable">EHR</button>
                                                                        </div>

                                                                        <div class="col-md-3">
                                                                            <button type="button" onClick="return getCompleteMedicalExamMEOrMB('ALL','SearchStatusForUnitAdmin','me');"  class="btn btn-primary btn-block notDisable">PREVIOUS MEDICAL EXAMS</button>
                                                                        </div>

                                                                        <div class="col-md-3">
                                                                            <button type="button" onClick="return getCompleteMedicalExamMEOrMB('ALL','SearchStatusForUnitAdmin','mb');" class="btn btn-primary btn-block notDisable">PREVIOUS MEDICAL BOARDS</button>
                                                                        </div>

                                                                        <div class="col-md-2">
                                                                            <button type="button" onClick="return showImmunizationTemplateMe('aa');" class="btn btn-primary btn-block notDisable">IMMUNIZATIONS</button>
                                                                        </div>
                                                                        <div class="col-md-3">
                                                                            <button type="button" id="specialistOpinion" onclick="getSpecialistOpinionOpen()" abindex="1" class="btn btn-primary notDisable"
									...
									<div class="row m-t-20">
										<div class="col-12 text-right">
											...
											<input type="button" value="Verify Employability Restrictions CheckList" tabindex="1" class="btn btn-primary notDisable"
				...
				.ajax({
					...
					$.each(datas, function(i, item) {
			            ...
			            {	
					            ...
					            setTimeout(function(){ 
					            	var designationForMeValCheck=item.fowardedDesignationId;
					                if(designationForMeValCheck!="" && designationForMeValCheck!=null)
					                {
					                   document.getElementById('designationForMe').value=designationForMeValCheck;	
					                   getMasDesignationMappingByUnitIdByHospitalIdAndDesigMB(forwardTo,designationForMeValCheck);
