...
<form:form name="specialistOpinion" id="specialistOpinion" method="post" enctype='multipart/form-data'
	...
	<div class="content-page">
		...
		<input  name="obsistyCheckAlready" id="obsistyCheckAlready" type="hidden" value="" />
			...
			<div class="container-fluid">
				<div class="internal_Htext">Specialist Doctor for Opinion and Medical Board</div>
					...
					<div class="col-12">
						<div class="card">
									<div class="card-body">
										...
										<div class="row">
											<div class="col-12">
											<h6 class="text-theme text-underline font-weight-bold">Patient
												Details</h6>
											</div>
											<div class="col-md-4">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" class="form-control custom_date"
															name="fromDate" id="name" readonly>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" class="form-control custom_date"
															name="fromDate" id="gender" readonly>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" class="form-control custom_date"
															name="fromDate" id="rank" readonly>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" class="form-control custom_date"
															name="fromDate" id="mb_type" readonly>
													</div>
												</div>
											</div>
										...
										<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
																<input name="height" id="height" maxlength="3"
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
																<input name="Weight" id="weight"
																	onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"
																	type="text" class="form-control border-input"
																     maxlength="5" placeholder="Weight" readonly/>
																<div class="input-group-append">
														      <div class="input-group-text">kg </div>
														    </div>
												...
												<div class="form-group row">
													...
													<div class="form-check form-check-inline cusRadio m-t-5">
															<input type="radio" value="N" class="form-check-input radioCheckCol2"
																name="ObesityCheck" id="obsistyCheck" disabled/>
											...
											<div class="col-md-3">
														...
														<select name="overWeightDivId"  class="form-control p-l-5" id="overWeightSelect"  tabindex="1" disabled>
												...
												<table
													...
													<tbody id="referalGrid">
														<tr style="display:none;">
															...
															<td><input type="text" id="specialityName" value="" class="form-control">
															</td>
															<td>
																<div class="autocomplete">
																	<input type="text" class="form-control"
															...
															<td>
																<div class="fileUploadDiv">
																	<input type="file" name="referalFileUpload" id="referalFileUpload"class="inputUpload" />
		...
		<div class="modal-dialog  modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<button type="button" onClick="closeSubModal();" class="close"
						 aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				...
				<div class="modal-footer">
					<button class="btn btn-primary"
						onClick="saveSpecialistOpinionInText();" aria-hidden="true">
						<spring:message code="btnOK" />
					</button>
...
function saveSpecialistOpinionInText(){
...
$(function() {
	$("#editorOfResult").jqte();
	$("#editorOfResult").attr("readonly", true);
					...
					if(data[i].investigationType!="" && (data[i].investigationType=='s'||data[i].investigationType=='t')){
						...
						var resultHdId=0;
							...
							if(data[i].mainChargeCodeNameForInve=='Radio'){
								...
								investigationData+='<a class="btn-link" href="javascript:void(0)" readonly  data-toggle="modal" data-target="#messageForResult" data-backdrop="static" onclick="openResultModel(this);">View/Enter Result</a>';
								investigationData += '	</td>';
							}
							var rangeForInves="";	
	...
	function masIcdList() {
	 ...
	 function saveSpecialistOpinionDetails() {
        	...
        	$('#referalGrid tr').each(function(i, el) {
        		...
        		if(specialistOpinion=="")
        		{
        			alert("Please enter specialist opinion details under referral section");
        			specialistOpinion.focus();
        			return false;
        		}        		
        		dataReferalHD={
	    	...
	    	var dataJSON={
	    	 ...
	    	 var formData1 = $('#refferalSpecialistOpinion')[0];
	      	 var formData = new FormData(formData1);
	      	 var countFile=1;
	    	formData.append('refferalSpecialistOpinion',JSON.stringify(dataJSON));	
...
<script type="text/javascript">
            $(document).ready(function() {
            	datePick();
            	$(".jqte_editor").attr("readonly", true);
            });
 ...
 var obsistyOverWeight='';
	...
	function getRefferalDetailSpecialist() {
	    var pathname = window.location.pathname;
	    var accessGroup = "MMUWeb";
