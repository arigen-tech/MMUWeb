...
<script type="text/javascript">
			...
			$.ajax({
				...
				success : function(data) {
					...
					if(data.status == true){
						...
						mmuDrop = '<option value="0">--Select</option>';
						$j('#mmuName').append(mmuDrop);
					}  
				},
				error : function(data) {
	...
	function GetAllCapturedInspectionList(MODE){
        var reqStatus = '<%=requestedStatus%>';
         ...
         if(reqStatus == 'V'){
             allStatus = 'V';
             $('#statusBlock').hide();
             $('.internal_Htext').text('List of Validated Inspection Checklist');
         }
		 if(MODE == 'ALL'){
	...
	function executeClickEvent(inspectionDetailId,data){
	    var reqStatus = '<%=requestedStatus%>';
	    if(reqStatus == 'V')
	        window.location = 'auditInspectionChecklist?page=validated&detail='+inspectionDetailId;
        else window.location = 'auditInspectionChecklist?detail='+inspectionDetailId;
    }
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="">
                ...
                <div class="internal_Htext">Audit Pending Inspection Checklist</div>
                    <!-- end row -->
