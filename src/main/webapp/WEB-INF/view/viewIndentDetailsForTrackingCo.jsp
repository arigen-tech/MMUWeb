									...
									<table
										...
										<tbody id="nomenclatureGrid">
												<tr>
													...
													<td><input type="text" name="issuedQty" tabindex="1"
														autocomplete="nope" spellcheck="false" value="" readonly="readonly"
														id="issuedQty1" size="5" maxlength="5" class="form-control" onkeypress="return isNumberKey(event)" /></td>
									...
									<div class="row">
										<div class="col-md-12 text-right">
														...
														<a  class="buttonDel  btn btn-primary " role="button"
															href="${pageContext.request.contextPath}/dispencery/getIndentForTrackingCo">Close</a>
...
function addNomenclatureRow1() {
	 ...
	 i++;
		...
		aClone.find("td:eq(3)").find(":input").prop('id', 'issuedQty'+i+'');
		//issuedQty
