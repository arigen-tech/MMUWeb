				                                        ...
				                                        <tr id="periodicity_tr">                                    
					                                        <td class="ques_width">
					                                          ...
					                                          <td class="ques_drop">		                                           
					                                                <select name="ama"  class="form-control">	
					                                                    <option  id="select"  value="select">Select </option>
					                                                    <option id="mon" value="Month">Month</option>										
																		<option  id="3 Month"  value="Yes">3 Month </option>
																		<option id="mon" value="6 Month">6 Month</option>																										 
																	</select>												 
															</td> 
							             ...
							             <div class="row">											
											<table class="table table-hover table-striped table-bordered">                                       
			                                      ...
			                                      <tbody  id="recommendation_posting">     
				                                        ...
				                                        <tr id="lwt_fmc_tr">                                    
					                                        <td class="ques_width">
					                                             <input  type="text"  id="lwt_fmc_in"  class="col-md-10  form-control-plaintext  col-form-label" value="Can the individual be posted to a billet where he may be utilized for short sea sorties up to 03 days ? [to be filled up for individuals in LMC S3A2 only, intended for transfer to units like LWT, FMC, FMU etc.]">
					                                         </td>
					                                          <td class="ques_drop">		                                           
					                                        ...
					                                        <td class="ques_width">
					                                          ...
					                                          <td class="ques_drop">		                                           
					                                                ...
					                                                <option  id="select"  value="select">Select </option>											
																		<option  id="yes"  value="Yes">Yes </option>
																		<option id="no" value="No">No</option>
																		<option id="restrictions" value="Restrictions">Restrictions</option>																											 
																	</select>													 
															   </td> 												
																<td></td>
																<td></td>										
	...
	$('#addbutton').click(function() {
						...
						$.each(datas, function(i, item) {
							...
							{								
								if(selectCheck=='Y' && system=='S')
								{
									...
									var sFactorDyanmic='';
									sFactorDyanmic+='<tr id="activity"><th class="ques_width"><b class="ques_th_txt">Activity</b></th><th class="ques_drop"><b class="ques_th_txt">Permitted or Not</b></th> th></th><th></th></tr>';  
									sFactorDyanmic+='<tr id="sentry_tr"><td class="ques_width"><input  type="text"  id="sentryin"  class="col-md-10  form-control-plaintext  col-form-label" value="Arm Sentry Duty"></td><td class="ques_drop"><select id="sentry"   class="form-control"><option  id="select"  value="select">Select </option><option  id="yes"  value="Yes">Yes </option><option id="no" value="No">No</option></select></td><td></td><td></td></tr>';
								...
								if(selectCheck=='Y' && system=='H')
								{
									...
									sFactorDyanmic+='<tr id="dive_tr"><td class="ques_width"><input  type="text"  id="dive_in"  class="col-md-10  form-control-plaintext  col-form-label" value="Can dive/swim"></td><td class="ques_drop"><select id="dive"   class="form-control"><option  id="select"  value="select">Select </option><option  id="yes"  value="Yes">Yes </option><option id="no" value="No">No</option><option id="no" value="No">Swim</option></select></td><td><button type="button" name="add"   id="h_factor-add"   onclick="addEmployabilityRestrictionsHFactor()" class="btn btn-primary buttonAdd noMinWidth" value="" button-type="add" tabindex="1" ></button></td><td></tr>';
									$('#h-factor').append(sFactorDyanmic);
								}
								if(selectCheck=='Y' && system=='P')
								{
									$("#p-factor tr").remove();	
									var pFactorDyanmic='';
									pFactorDyanmic+='<tr id="machinery_tr"> <td class="ques_width"><input  type="text"  id="machinery_in"  class="col-md-10  form-control-plaintext  col-form-label" value="Working near moving machinery"></td><td class="ques_drop"><select id="machinery"   class="form-control"><option  id="select"  value="select">Select </option><option  id="yes"  value="Yes">Yes </option><option id="no" value="No">No</option></select></td><td></td><td></td></tr>';  
									pFactorDyanmic+='<tr id="driving_tr"> <td class="ques_width"><input  type="text"  id="driving_in"  class="col-md-10  form-control-plaintext  col-form-label" value="Driving vehicle"></td><td class="ques_drop"><select id="driving"   class="form-control">   <option  id="select"  value="select">Select </option><option  id="yes"  value="Yes">Yes </option><option id="no" value="No">No</option></select></td><td></td><td></td></tr>';
									pFactorDyanmic+='<tr id="working_tr"> <td class="ques_width"><input  type="text"  id="working_in"  class="col-md-10  form-control-plaintext  col-form-label" value="Working near fire"></td><td class="ques_drop"><select id="working"   class="form-control"><option  id="select"  value="select">Select </option><option  id="yes"  value="Yes">Yes </option><option id="no" value="No">No</option></select></td><td></td><td></td></tr>';
									pFactorDyanmic+='<tr id="water_body_tr"> <td class="ques_width"><input  type="text"  id="water_body_in"  class="col-md-10  form-control-plaintext  col-form-label" value="Working near open water body"></td><td class="ques_drop"><select id="water_body"   class="form-control">   <option  id="select"  value="select">Select </option><option  id="yes"  value="Yes">Yes </option><option id="no" value="No">No</option></select></td><td></td><td></td></tr>';
									pFactorDyanmic+='<tr id="spinal_tr"> <td class="ques_width"><input  type="text"  id="spinal_in"  class="col-md-10  form-control-plaintext  col-form-label" value="Duties involving bending forwards (only for post spinal surgery cases)"></td><td class="ques_drop"><select id="spinal"   class="form-control"><option  id="select"  value="select">Select </option><option  id="yes"  value="Yes">Yes </option><option id="no" value="No">No</option></select></td><td></td><td></td></tr>';
									pFactorDyanmic+='<tr id="envirnment_tr"> <td class="ques_width"><input  type="text"  id="envirnment_in"  class="col-md-10  form-control-plaintext  col-form-label" value="Working in envirnment with esposure to dust, smoke"></td><td class="ques_drop"><select id="envirnment"   class="form-control"><option  id="select"  value="select">Select </option><option  id="yes"  value="Yes">Yes </option><option id="no" value="No">No</option></select></td><td></td><td></td></tr>'; 
				                   	pFactorDyanmic+='<tr id="space_tr"> <td class="ques_width"><input  type="text"  id="space_in"  class="col-md-10  form-control-plaintext  col-form-label" value="Working in enclosed space"></td><td class="ques_drop"><select id="space"   class="form-control"><option  id="select"  value="select">Select </option><option  id="yes"  value="Yes">Yes </option><option id="no" value="No">No</option></select></td> <td><button type="button" name="add"    id="physical_factor-add" onclick="addEmployabilityRestrictionsPFactor()"    class="btn btn-primary buttonAdd noMinWidth" value="" button-type="add" tabindex="1" ></button></td><td></td></tr>'; 
									$('#p-factor').append(pFactorDyanmic);
								}
								if(selectCheck=='Y' && system=='E')
								{
									...
									eFactorDyanmic+='<tr id="welding_tr"><td class="ques_width"><input  type="text"  id="welding_in"  class="col-md-10  form-control-plaintext  col-form-label" value="Working in spaces with exposure to welding flash"></td><td class="ques_drop"><select id="welding"   class="form-control"><option  id="select"  value="select">Select </option><option  id="yes"  value="Yes">Yes </option><option id="no" value="No">No</option></select>	</td><td><button type="button" name="add"   id="eye_factor-add"  onclick="addEmployabilityRestrictionsEFactor()"  class="btn btn-primary buttonAdd noMinWidth" value="" button-type="add" tabindex="1" ></button></td><td></td></tr> ';
	 ...
	 function addRequirementPeriodictyGrid()
	 {
		    i++
     		...
     		aClone.find(":input").val("");
     		var	inputType ='';
     		inputType +='<input type="text" name="value" id="newValue" value="" class="form-control" />';
	 ...
	 function addRowRecommendationsPosting(val)
	 {
		    ...
		    var typeZero='';
     		...
     		var	inputType ='';
     		inputType +='<textarea class="form-control" rows="3" name="reasonForVarious" id="reasonForVarious"></textarea>';
    		aClone.find("td:eq(1)").html(inputType);
     	  	var	deleteButton ='';
     	  	deleteButton +='<button type="button" name="delete"  id="recommendations-delete" onclick="deleteRow(this)"  class="buttonDel btn btn-danger noMinWidth" button-type="delete" tabindex="1" ></button>';
     	  	aClone.find("td:eq(3)").html(deleteButton);
...
function getMbAMSF15CheckListforValidate() {
	...
	+ "/medicalBoard/getAmsf15CheckList";
				...
				success : function(response) {
					...
					for (var i = 0; i < datas.length; i++) {
						...
						if (headerID=='RequirementPeriodicty') {
							...
							else if(checklistValue == '6 Month'){
								optionList += '<option value="6 Month" selected>'+checklistValue+'</option><option  id="3Month" value="3 Month">3 Month</option><option  id="month" value="Month">Month</option></option>';
							}
							else if(checklistValue == 'select'){
							optionList += '<option value="select" selected>'+checklistValue+'</option><option  id="yes" value="Yes">Yes</option><option  id="no" value="No">No</option></option>';
						    }
							else
							{
								inputVal +='<input type="text" name="value" id="newValue" value="'+checklistValue+'" class="form-control" />';	
							}	
							...
							{
								RequirementPeriodicty+=	'<td><input type="text" name="value" id="newValue" value="'+checklistValue+'" class="form-control" /></td>';
							}	
						...
						if (headerID=='RecommendationsPosting') {
							...
							RecommendationPosting+='<td class="ques_width"><input  type="text"  id="does_individual_in"  class="col-md-10  form-control-plaintext  col-form-label" value="'+checklistName+'"></td>';
							if(optionList!=null && optionList!="")
							{	
							...
							else
							{
								...
								RecommendationPosting+=	'<td><input type="text" name="value" id="newValue" value="'+checklistValue+'" class="form-control" /></td>';
							}	 
						 ...
						 if (headerID=='EmployabilityRestrictions' && checklistName!='null') {
								...
								else
								{
									...
									employabilityRestrictions+=	'<td><input type="text" name="value" id="newValue" value="'+checklistValue+'" class="form-control" /></td>';
								}	  
						...
						if (headerID=='SFactor') {
							...
							else
							{
								...
								SFactorGetVal+=	'<td><input type="text" name="value" id="newValue" value="'+checklistValue+'" class="form-control" /></td>';
							}	 
						...
						if (headerID=='HFactor') {
							...
							else
							{
								...
								HFactor+=	'<td><input type="text" name="value" id="newValue" value="'+checklistValue+'" class="form-control" /></td>';
							}	 
						...
						if (headerID=='PFactor') {
							...
							else
							{
								...
								PFactor+=	'<td><input type="text" name="value" id="newValue" value="'+checklistValue+'" class="form-control" /></td>';
							}	  
						...
						if (headerID=='EFactor') {
							...
							else
							{
								...
								EFactor+=	'<td><input type="text" name="value" id="newValue" value="'+checklistValue+'" class="form-control" /></td>';
							}	
						...
						if (headerID=='AviationCadre') {
							...
							else
							{
								...
								AviationCadre+=	'<td><input type="text" name="value" id="newValue" value="'+checklistValue+'" class="form-control" /></td>';
							}	 
						...
						if (headerID=='EmployabilitySpecific') {
							...
							{
								optionList +='<option selected>'+checklistValue+'</option><option  id="swim"  value="Swim">Swim </option><option  id="yes"  value="Yes">Yes </option><option  id="no" value="No">No</option>';	
							}
							else if(checklistValue == 'select'){
							optionList += '<option value="selecte" selected>'+checklistValue+'</option><option  id="yes" value="Yes">Yes</option><option  id="no" value="No">No</option></option>';
						    }
							else
							{
								inputVal +='<input type="text" name="value" id="newValue" value="'+checklistValue+'" class="form-control" />';	
							...
							else
							{
								...
								EmployabilitySpecific+=	'<td><input type="text" name="value" id="newValue" value="'+checklistValue+'" class="form-control" /></td>';
							}	  
