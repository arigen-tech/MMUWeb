...
function getCommandList(MODE)
{
	...
	var searchService = $j('#serviceNo').val();
	 ...
	 if(MODE == 'ALL'){
			var data = {"pageNo":nPageNo,"serviceNo":"",'employeeId' : <%=userId%>, 'hospitalId':""+<%=hospitalId%>,'flagForList':'tes'};			
		}
	 else if(searchService!="")
		{
		   nPageNo=1;
		   var data =  {"pageNo":nPageNo, "serviceNo":searchService,"employeeId":<%=userId%>, "hospitalId":""+<%=hospitalId%>,'flagForList':'tes'}; 
		} 
	else
		{
			var data =  {"pageNo":nPageNo, "serviceNo":searchService,"employeeId":<%=userId%>, "hospitalId":""+<%=hospitalId%>,'flagForList':'tes'}; 
 ...
 */	 window.location.href = "mbSpecialistForOpinionDetails?visitId="+visitId+"&age="+age;
	//}
}
		...
		<div class="content-page">
			...
			<div class="">
				...
				<div class="container-fluid">
					<div class="internal_Htext">Transcription Entry Waiting List(Specialist Opinion)</div>
