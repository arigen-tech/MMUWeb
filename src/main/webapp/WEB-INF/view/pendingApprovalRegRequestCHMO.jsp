...
function getSavedEmployeeList(MODE) { 	
    ...
    var cmdId=0;
	 if(MODE == 'ALL'){
		 var data = {"pageNo":nPageNo,"mobileNo":"","empName":"","recordStatus":"saved","calledFor":"chmoApproval","userId":"<%= userId %>"};
		}
	   else if(mobile_no!=""||emp_name!="")
		{
		nPageNo = 1;
		var data = {"pageNo":nPageNo,"mobileNo":mobile_no,"empName":emp_name,"recordStatus":"saved","calledFor":"chmoApproval","userId":"<%= userId %>"};
		} 
	   else
		{
		var data = {"pageNo":nPageNo,"mobileNo":mobile_no,"empName":emp_name,"recordStatus":"saved","calledFor":"chmoApproval","userId":"<%= userId %>"};
 ...
 {
	 //alert(Id)
	 window.location="getEmployeeRecordForCHMO?empRecId="+Id+"";
	...
	<div id="wrapper">
		<div class="content-page">
			...
			<div class="container-fluid">
				...
				<div class="internal_Htext">Pending Approval List of Registration Request (CHMO)</div>
