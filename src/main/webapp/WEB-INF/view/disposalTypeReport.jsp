...
<div id="wrapper">
	<div class="content-page">
		...
		<div class="container-fluid">
			<div class="internal_Htext">Disposal Type Report</div>
...
function GetListDisposalType(MODE)
{
	...
	var url = "getDisposalTypeReportList";
...
{	
	...
	var dataList = jsonData.data;
	 ...
	 for(item in dataList){
	    	  ...
	    	  htmlTable = htmlTable + "<td >" + dataList[item].disposalName + "</td>";
...
function makeUrl(){
	...
	var url="${pageContext.request.contextPath}/report/printDisposalReport?fromDate="+fromDate+"&toDate="+toDate+"&unitId="+unit;
	openPdfModel(url);
}
</script>
</html>
