...
<script type="text/javascript">
	...
	{	
	 ...
	 function createTable(jsonData){
			...
			for (i = 0; i < dataList.length; i++) {
				...
				htmlTable = htmlTable + "<td style='width: 100px;'>"
						+ dataList[i].mmuName + "</td>";
				htmlTable = htmlTable + "<td style='width: 100px;'>"
						+ dataList[i].indentNo + "</td>";
				htmlTable = htmlTable + "<td style='width: 150px;'>"
						+ dataList[i].indentDate + "</td>";
				htmlTable = htmlTable + "<td style='width: 100px;'>"
	 ...
	 function goBack(){
		window.location = "displayItemListCO";
	 }
	...
	<div id="wrapper">
		<div class="content-page">
			...
			<div class="container-fluid">
				...
				<div class="internal_Htext">MMU Wise Indent Detail</div>
