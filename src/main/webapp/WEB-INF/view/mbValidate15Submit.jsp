...
<div class="content-page">
 ...
 <div class="">
  <div class="container-fluid">
	  ...
	  <div class="internal_Htext">AMSF 15 Submitted</div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                <p class="submitMsg">Validated Details Submitted Successfully</p>    
                                <div id="opd_submit">  
                                     <div class="row">
										<div class="col-md-8"> 
...
<script type="text/javascript" language="javascript">
            function backListReport(flag) {
            				if(flag=="1"){
                          	 window.location.href ="validateMoTranscEntry";
            				}
            				if(flag=="2"){
