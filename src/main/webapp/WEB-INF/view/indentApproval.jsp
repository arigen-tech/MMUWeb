		...
		<div class="content-page">
			...
			<div class="">
				<div class="container-fluid">
					<div class="internal_Htext">Indent Approval (APM)</div>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
										<form:form name="submitIndentDispencery" id="submitIndentDispencery" method="post"
										action="${pageContext.request.contextPath}/dispencery/approveIndentDispencery" autocomplete="off">
												...
												<tr>
													...
													<td>
														<div class="autocomplete forTableResp">
															<input type="text" value="" autocomplete="never" readonly="readonly"
													...
													<td style="display: none;"><input type="hidden"
														...
														<td  style="display:none">
															...
															<button type="button" class="btn btn-primary buttonAdd noMinWidth"
																...
																onclick="addNomenclatureRow1();showLastRow();" tabindex="1" disabled></button>
														...
														<td style="display:none">
															...
															<button type="button" class="buttonDel  btn btn-danger noMinWidth m-r-10"
																...
																onclick="removeRowIndent(this);" disabled></button>
													...
													<input type="submit" class="btn  btn-primary"
														...
														value="Submit" id="saveForm1" tabindex="1" onclick="return submitForm();"/>
														 ...
														 <a  class="buttonDel  btn btn-primary" role="button"
															href="${pageContext.request.contextPath}/dispencery/getIndentForApproval">Close</a> 
														<%-- <a  class="buttonDel  btn btn-primary" role="button"
