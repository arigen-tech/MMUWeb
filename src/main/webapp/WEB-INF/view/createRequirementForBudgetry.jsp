		...
		<div class="content-page">
			<div class="">
				<div class="container-fluid">
					<div class="internal_Htext">Create Requirement For Budgetary Approval</div>
							...
							<div class="card">
								<div class="card-body">
									<form:form name="submitBudgetary" id="submitBudgetary" method="post"
										action="${pageContext.request.contextPath}/lpprocess/submitBudgetaryApproval" autocomplete="off">
									<div class="row">
										<div class="col-md-4">
											<div class="form-group row">
												<label class="col-md-4 col-form-label"> Current Date</label>
												<div class="col-md-7">
													...
													<div class="dateHolder">
														<input type="text"
															...
															name="lpDate" id="indentDate" placeholder="DD/MM/YYYY"
...
function addNomenclatureRow1() {
	...
	aClone.find("td:eq(0)").find("div").find("div").prop('id', 'divIdPVMS' + i + '');
	  ...
	  var  lpunitrateData1 ='';
	  lpunitrateData1 +='<input type="text" id="lpunitrate'+i+'"  onkeypress="if(isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" name="lpunitrate"';
	  lpunitrateData1 +='autocomplete="nope" spellcheck="false" value=""';
	  lpunitrateData1 +='class="form-control" onblur="calculateAmount('+i+')"/>';
...
function submitForm() {
	...
	var rows = document.getElementById("nomenclatureGrid").getElementsByTagName("tr").length;
	  ...
	  $("#nomenclatureGrid tr").each(function () {
		 ...
		 var lpunit=$(this).find('td:eq(3)').find(':input').val();
		 var itemId=$(this).find('td:eq(5)').find(':input').val(); 
			 ...
			 if (lpunit == null || lpunit == "") {
		         alert("Please enter last unit rate");
		         flag=1;
		         return false;
		     }
