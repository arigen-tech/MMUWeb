...
<body>
 ...
 <div class="">
  <div class="container-fluid">
	  ...
	  <div class="internal_Htext">Pending approval list of new registration (Auditor)</div>
...
function getSavedEmployeeList(MODE) { 	
    ...
    var cmdId=0;
	 if(MODE == 'ALL'){
		 var data = {"pageNo":nPageNo,"mobileNo":"","empName":"","recordStatus":"saved","calledFor":"audApproval","userId":"<%= userId %>"};
		}
	   else if(mobile_no!=""||emp_name!="")
		{
		nPageNo = 1;
		var data = {"pageNo":nPageNo,"mobileNo":mobile_no,"empName":emp_name,"recordStatus":"saved","calledFor":"audApproval","userId":"<%= userId %>"};
		} 
	   else
		{
		var data = {"pageNo":nPageNo,"mobileNo":mobile_no,"empName":emp_name,"recordStatus":"saved","calledFor":"audApproval","userId":"<%= userId %>"};
 ...
 {	
 	...
 	for(i=0;i<dataList.length;i++)
 		{	 		
 			...
 			if (dataList[i].apmName != null) {
 			htmlTable = htmlTable +"<td style='width: 100px;'>"+dataList[i].apmName+"</td>";
 			}
 			else{
 				htmlTable = htmlTable +"<td style='width: 100px;'></td>";
 			 }
 			if (dataList[i].apmAction != null) {
 				if(dataList[i].apmAction=='A'){
 					apmAction = 'Approved';
 				}else{
 					apmAction = 'Rejected';
 				}
 			htmlTable = htmlTable +"<td style='width: 100px;'>"+apmAction+"</td>";	
 			}
 			else{
 				htmlTable = htmlTable +"<td style='width: 100px;'></td>";
 			 }
 ...
 {
	 //alert(Id)
	 window.location="getEmployeeRecordForAuditor?empRecId="+Id+"";
