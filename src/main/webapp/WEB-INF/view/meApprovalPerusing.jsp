...
<body>
		...
		<div class="content-page noSideMen">
			...
			<div class="">
				<div class="container-fluid">
					<div class="internal_Htext">Medical Exam Final Approval</div>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<form:form name="submitMedicalExamByMo" id="submitMedicalExamByMo" method="post" enctype='multipart/form-data'
									action="${pageContext.request.contextPath}/medicalexam/submitMedicalExamByMA" autocomplete="on">
								...
								<div class="card-body">
								 ...
								 <input type="hidden" name="visitId" id="visitId" value="${visitId}"/>
									...
									<input type="hidden" name="saveInDraft" id="saveInDraft" value="draftPRMo"/>		
									<input type="hidden" name="opdPatientDetailId" id="opdPatientDetailId" value=""/>	
									<input type="hidden" name="referTo" id="referTo" value="E"/>	
									<input type="hidden" name="approvalFlagValue" id="approvalFlagValue" value="${approvalFlag}"/>	
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" name="branchOrTrade" id="branchOrTrade" class="form-control" readonly/>
													</div>
												</div>
											</div>
											<div class="col-md-4">
										 ...
										 <table class="table table-hover table-striped table-bordered">
	                                        <thead class="bg-success" style="color:#fff;">
													<tr>
														...
														<th id="th7" style="width: 80px;">Duration(M)</th>
												...
												<tbody id="medicalCategory">
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                      ...
                                                                                      <input type="text" class="form-control" name="typeOfCategory" name="typeOfCategory" value=""/>
                                                                                    <td>
                                                                                     <select class="form-control width120" name=typeOfCategory id="typeOfCategory">
																							<option value="0">Select</option>
                                                                                   ...
                                                                                   <td>
                                                                                       <div class="dateHolder">
																	                    <input type="text" id="categoryDate" 
																	                     name="categoryDate" class="noFuture_date form-control" 
																	                     placeholder="DD/MM/YYYY" value="" maxlength="10" />
																	                    </div>
                                                                                    </td>
                                                                                    <td>
                                                                                        <input type="text" name="duration" id="duration" onblur="return generateNextDate(this);" class="form-control"> </td>
                                                                                    <td>
                                                                                         <div class="dateHolder">
																	                    <input type="text" id="nextcategoryDate" name="nextcategoryDate" class="input_date form-control" placeholder="DD/MM/YYYY" value="" maxlength="10" />
																	                    </div>
                                                                                       </td>
 ...
 -->									
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" name="missing" id="missing" class="form-control" maxlength="2"  readonly/>
													</div>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" name="unSavable" id="unSavable" class="form-control" maxlength="2" readonly/>
													</div>
												</div>
											</div>
											<div class="col-md-4">
												...
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="height" id="height" class="form-control" maxlength="3" onblur="idealWeight2();checkBMI();" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;">
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost14">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group row">
													<div class="col-md-5">
														<label for="service" class="col-form-label">Menstrual History <span class="mandate"><sup>&#9733;</sup></span></label>
													</div>
													<div class="col-md-7">
									...
									<div class="hisDivHide p-10" style="display:block"  id="newpost12">
											...
											<div class="col-md-4">
														...
														<table class="table table-hover table-striped table-bordered">
															...
															<tbody>
																<tr>
																	...
																	<td>
																		<div class="autocomplete forTableResp">
																		<!-- 	<input autocomplete="off" type="text" name="medicalCompositeName"
													...
													<tbody id="medicalCategory">
                                                       <tr>
                                                            <td>
                                                                <div class="autocomplete forTableResp">
                                                                <!-- <input autocomplete="off" type="text" class="form-control" name="diagnosisId" id="diagnosisId" onblur="fillDiagnosisCombo(this.value,this);" onKeyPress="autoCompleteCommonMe(this,5);" onKeyUp="autoCompleteCommonMe(this,5);"placeholder="Diagnosis" /> -->
                                                               ...
                                                               <td>
                                                                  <div class="autocomplete forTableResp">
                                                                 <!--   <input autocomplete="off" type="text" id="medicalCategoryId" onblur="fillMedicalCategoryData(this.value,this);" onKeyPress="autoCompleteCommonMe(this,6);"  onKeyUp="autoCompleteCommonMe(this,6);" class="form-control"> -->
...
<!-- 											<div class="col-md-4">
														<div class="form-group row">
															<div class="col-md-5">
																<label for="service" class="col-form-label">Fit For</label>
															</div>
															<div class="col-md-7">
																<input type="text"  class="form-control" name="fitInMedicalCategory" id="fitInMedicalCategory" readonly/>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<select class="form-control" id="actionMe" name="actionMe" onblur="return changeAction(this);" onChange="return changeAction(this);" >
															<option value="0">Select</option>
															<option   value="approveAndClose">Approve and Close</option>
															<option  value="approveAndForward">Approved and Forward</option>
										...
										<div class="opdMain_detail_area" style="display:none;" id="referredMe">
											<h4 class="service_htext">Referred</h4>
											
											<table class="table table-hover table-striped table-bordered m-t-10 m-b-10">
												<thead class="bg-primary">
													<tr>
														<th>S.No.</th>
														<th>Hospital Name</th>
												...
												<tbody id="medicalReferal">
													<tr>
														...
														<td>
															<input type="text" class="form-control departmentListClass" id="departmentValue" name="departmentValue" value=""/>
														
														<input type="hidden" id="diagonsisId1" name="diagonsisId" value=""/>
														<input type="hidden"  name="masEmpanalHospitalId" value="" id="masEmpanalHospitalId"/>
														<input type="hidden"  name="masDepatId" value=""id="masDepatId"/>
														<input type="hidden"  name="referalPatientDt" value="" id="referalPatientDt"/>
														<input type="hidden"  name="referalPatientHd" value="" id="referalPatientHd"/>
														...
														<div class="autocomplete">
 												 		 ...
 												 		 <input autocomplete="off" name="icddiagnosis" id="icddiagnosis" type="text"
															class="form-control border-input"
															placeholder=" " value=""  onKeyPress="autoCompleteCommonMe(this,'5');" onKeyUp="autoCompleteCommonMe(this,'5');"
															onblur="fillDiagnosisCombo(this.value,this);" />
 												 		  
 												 		 </div>
														</td>
														<td>
															<input type="text" class="form-control departmentListClass" id="instruction" name="instruction" value=""/>
													</td> 
														 <td>
													...
													<td><button type="Button" name="add" class="buttonAdd btn btn-primary noMinWidth" id="referalMedicalDtIdAdd" button-type="add" value="" tabindex="1" onclick="addRowForReferalPatientMedicalExam();"> </button></td>
													<td><button type="button" name="delete" value="" id="referalDtMedicalIdDel"  class="buttonDel btn btn-danger noMinWidth" button-type="delete" tabindex="1" onclick="removeRowInvestigationReferal(this,'medicalExam','');" ></button></td>
													</tr>
												</tbody>
											</table>
											...
											<div class="row m-t-10">
												<div class="col-md-6">
													<div class="form-group row">
														...
														<div class="col-md-9">
															<textarea class="form-control" id ="chiefComplaint" name="chiefComplaint" rows="2"></textarea>
														</div>
													</div>
												</div>
										      ...
										      <div class="row">
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="Pollar" id="pollar" type="text"
																	...
																	<textarea name="Pollar" id="pollar"  class="form-control"  placeholder="Pallor" maxlength="500"></textarea>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="Ordema" id="ordema" type="text"
																	...
																	<textarea name="Ordema" id="ordema" class="form-control"  placeholder="Edema" maxlength="500"></textarea>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="cyanosis" id="cyanosis" type="text"
																	...
																	<textarea name="cyanosis" id="cyanosis" class="form-control"  placeholder="Cyanosis" maxlength="500"></textarea>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="hairNail" id="hairnail" type="text"
																	...
																	<textarea  name="hairNail"  id="hairnail" class="form-control"  placeholder="Hair/ Nail" maxlength="500"></textarea>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group row">
															<label class="col-md-5 col-form-label">Icterus </label>
															<div class="col-md-7">
																<!-- <input name="Jaundice" id="jaundice" type="text"
																	class="form-control border-input" placeholder=" " value="" maxlength="500"/> -->
																	<textarea name="Icterus" id="icterus" class="form-control"  placeholder="Icterus" maxlength="500"></textarea>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="lymphNode" id="lymphNode" type="text"
																	class="form-control border-input" placeholder=" " value="" maxlength="500"/> -->
																	<textarea name="lymphNode" id="lymphNode" class="form-control"  placeholder="Lymph node" maxlength="500"></textarea>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="Clubbing" id="clubbing" type="text"
																	class="form-control border-input" placeholder=" " value="" maxlength="500"/> -->
																	<textarea name="Clubbing" id="clubbing" class="form-control"  placeholder="Clubbing" maxlength="500"></textarea>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="Thyroid" id="thyroid" type="text"
																	class="form-control border-input" placeholder=" " value="" maxlength="500"/> -->
																	<textarea name="GCS" id="gcs" class="form-control"  placeholder="GCS" maxlength="500"></textarea>
															</div>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="Tremors" id="Tremors" type="text"
																	class="form-control border-input" placeholder=" " value="" maxlength="500"/> -->
																	<textarea name="Tremors" id="tremors" class="form-control"  placeholder="Tremors" maxlength="500"></textarea>
															</div>
														</div>
													</div>
														...
														<div class="form-group row">
															...
															<div class="col-md-7">
																<!-- <input name="Others" id="others" type="text"
																	class="form-control border-input" placeholder=" " value="" maxlength="500"/> -->
																	<textarea name="Others"  id="others" class="form-control"  placeholder="Others" maxlength="500"></textarea>
															</div>
														</div>
													</div>
												...
												<div class="col-md-6">
													<div class="form-group row">
														...
														<div class="col-md-9">
															<textarea class="form-control" id="remarksForReferal" name="remarksForReferal" rows="2"></textarea>
														</div>
													</div>
												</div>
											</div>
										...
										<!-- <div class="opdMain_detail_area" style="display:none;" Id="approvedMedicalExam">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group row">
														...
														<div class="col-md-10">
															<textarea class="form-control" id="remarksForApproval" name="remarksForApproval" rows="2"></textarea>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="opdMain_detail_area" Id="pendingMedicalExam" style="display:none;">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group row">
														<div class="col-md-5">
															<label for="service" class="col-form-label">Next Appointment Date</label>
														</div>
														<div class="col-md-7">
															<div class="dateHolder">
																<input id="nextAppointmentDate" name="nextAppointmentDate" class="form-control calDate" placeholder="DD/MM/YYYY" >
															</div>
														</div>
													</div>
												</div>
									...
									<div class="opdMain_detail_area uneditableEditor" >
										...
										<div class="opdMain_detail_area"  Id="rejectMedicalExam" style="display:none;">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group row">
														<div class="col-md-2">
															<label for="service" class="col-form-label">Reason for Rejection</label>
														</div>
														<div class="col-md-10">
															<textarea class="form-control" id="remarksReject" name="remarksReject" rows="2"></textarea>
														</div>
													</div>
												</div>
											</div>
									...
									<c:when test="${approvalFlag =='n'}">
										<div class="row m-t-10">
											...
											<input type="button" id="submitByMo" class="btn btn-primary" onclick="return submitMOForm('draftPRMo');"
															value="Submit"/>
											<input type="button" id="reset" class="btn btn-danger" onClick="document.location.reload(true);"
															value="Reset"/>					
											</div>
...
var obsistyOverWeight='';
	...
	function test(buttonId,newpost){
	 ...
	 $(document).ready(function() {
		 ...
		 var data = ${
			...
			$('#medicalCompositeDate').val(data.data[0].medicalCategoryDate);
			 ...
			 if(data.data[0].medicalCompositeNameValue!="" && data.data[0].medicalCompositeNameValue!=null && data.data[0].medicalCompositeNameValue!=undefined && data.data[0].fitFlag!='F')
	 ...
	 function idealWeight2() {
		...
		/*  					if(investigationType!="" && investigationType=='m' && ChargeCode!="")
	...
	<script type="text/javascript">
		...
		if(approvalFlag=='y' || draftRMo=='draftPRMo'){
