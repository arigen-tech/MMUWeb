...
<head>
  ...
  <title>Indent Issue Waiting List (DO)</title>
	...
	<div class="content-page">
		...
		<div class="">
			...
			<div class="container-fluid">
				<div class="internal_Htext">Indent Issue Waiting List (DO)</div>
...
<script>
 ...
 function getIndentList(item){
	 ...
	 var url = "indentIssueWaitingListDO";
...
{
	window.location.href = "getIndentIssueDetailJSPForDo?id="+indentCoMId;
}
