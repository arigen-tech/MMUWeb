...
function getSavedEmployeeList(MODE) { 	
    ...
    var cmdId=0;
	 if(MODE == 'ALL'){
		 var data = {"pageNo":nPageNo,"mobileNo":"","empName":"","recordStatus":"saved","calledFor":"tracker","userId":"<%= userId %>"};
		}
	   else if(mobile_no!=""||emp_name!="")
		{
		nPageNo = 1;
		var data = {"pageNo":nPageNo,"mobileNo":mobile_no,"empName":emp_name,"recordStatus":"saved","calledFor":"tracker","userId":"<%= userId %>"};
		} 
	   else
		{
		var data = {"pageNo":nPageNo,"mobileNo":mobile_no,"empName":emp_name,"recordStatus":"saved","calledFor":"tracker","userId":"<%= userId %>"};
 ...
 {
	 //alert(Id)
	 window.location="getSavedEmployeeRecord?empRecId="+Id+"";
