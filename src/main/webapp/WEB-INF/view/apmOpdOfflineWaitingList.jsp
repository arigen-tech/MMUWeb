	...
	function GetAllVendorInvoice(MODE){
		...
		var mmuIds = $j('#mmuIds').val();
		 ...
		 if(MODE == 'ALL'){
				...
				var data = {"PN": nPageNo, "anmApmId": "","fromDate":"","toDate":"","type":"All","creatdBy":"apm"};
		 }
		 else if(cityId != "" || fromDate != ""||toDate != "" || mmuIds != "")
		 {
			 nPageNo = 1;
		    var data = {"PN":nPageNo,"cityId":cityId,"fromDate":fromDate,"toDate":toDate,"mmuId":mmuIds,"type":"All","anmApmId":"","creatdBy":"apm"};
		 } 
	    else
	    { 
	    	 var data = {"PN":nPageNo,"cityId":cityId,"fromDate":fromDate,"toDate":toDate,"mmuId":mmuIds,"type":"All","anmApmId":"","type":"All","creatdBy":"apm"};
		} 
	  ...
	  var dataList=data.data;
		for(i=0;i<dataList.length;i++)
		{
			...
			if(anmApmId==detailsId)
			{
					if(status=="c")
					{	
					 	window.location = 'getApmOpdOfflineDataDetails?anmApmId='+anmApmId;
					}
				    else
					{
						 window.location = 'getApmOpdOfflineDataDetails?anmApmId='+anmApmId;	
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="">
                ...
                <div class="internal_Htext">Pending approval list Of OPD Offline Data </div>
