                ...
                <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                    ...
                    <head>
                        ...
                        <%@include file="..//view/commonJavaScript.jsp" %>
                            <title>UC Document Submit </title>
                     </head>
...
<div class="content-page">
 ...
 <div class="">
  <div class="container-fluid">
	  ...
	  <div class="internal_Htext">UC Document Upload</div>
...
$j(document).ready(function()
		{
			...
			$('#typeOfVal').val(typeOfVal);
			 if(typeOfVal=="S"){
	            	...
	            	document.getElementById('valueSet').innerHTML = 'UC document saved successfully';
				}
	            else
	            {
	            	$("#clicked"). text("Back to List");
	            	document.getElementById('valueSet').innerHTML = 'UC document submitted successfully';
	            }	
