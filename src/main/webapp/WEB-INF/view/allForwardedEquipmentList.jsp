...
<script type="text/javascript">
	...
	function GetAllCapturedEquipmentChecklist(MODE){
		 ...
		 if(MODE == 'ALL'){
				var data = {"PN": nPageNo,'auditStatus': 'F,V'};
		 }else{
			var data = {"PN":nPageNo,'auditStatus': 'F,V'};
			if($('#city').val())
	...
	function makeTable(jsonData)
	{
		...
		for(i=0;i<dataList.length;i++){
            ...
            if(!dataList[i].auditStatus || dataList[i].auditStatus == 'P'){
                ...
                status = 'SAVED';
            }else if(dataList[i].auditStatus == 'F'){
	...
	function executeClickEvent(equipmentChecklistDetailId,data){
        window.location = 'auditEuipmentChecklist?detail='+equipmentChecklistDetailId+'&page=forwarded';
    }
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="">
                ...
                <div class="internal_Htext">Audit Forwarded Equipment Checklist</div>
                    <!-- end row -->
											...
											<div class="col-lg-4 cl-sm-6">
												<div class="form-group row">
													...
													<div class="col-sm-7">
                                                        ...
                                                        <option value="F">Forwarded to Sr. Auditor</option>
