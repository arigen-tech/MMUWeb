						...
						<div class="col-12">
							...
							<form:form name="submitMedicalExamByMAForm18" id="submitMedicalExamByMAForm18" method="post"  enctype='multipart/form-data'
								...
								<div class="card-body">
									...
									<input type="hidden" name="saveInDraft" id="saveInDraft" value="draftPRMo18"/>
												...
												<div class="form-group row">
													...
													<div class="col-md-6">
														<div class="dateHolder">
															<input type="text"  name="dateOfReport" id="dateOfReport"class="calDate form-control" placeholder="DD/MM/YYYY"  value="">
														</div>
													</div>
												</div>
											</div>
										...
										<div class="row m-t-10">
											...
											<tbody id="diseaseWoundInjuryArmedForces">
												...
												<tr>
													...
													<td>
														<textarea name="armedForcesDetails"  id="armedForcesDetails"  class="form-control" maxlength="200"></textarea>
													</td>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="dateHolder">
															<input type="text" name="checkupDate" id="checkupDate" class="noFuture_date form-control" placeholder="DD/MM/YYYY" maxlength="10">
														</div>
													</div>
												</div>
											</div>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="weight" id="weight" maxlength="10"  class="form-control" onblur="checkVaration();checkBMI();" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;">
														    <div class="input-group-append">
											...
											<div class="col-md-8">
												<div class="form-group row">
													...
													<div class="col-md-9">
														...
														<textarea name="signedByMo" id="signedByMo"class="form-control" disabled></textarea>
													</div>
												</div>
											</div>
											</div>
										...
										<div class="opdMain_detail_area uneditableEditorView">
											...
											<div class="col-md-8">
												<div class="form-group row">
													...
													<div class="col-md-9">
														<!-- <input type="text" name="finalObservationPRmo" id="finalObservationPRmo"  class="form-control"/> -->
														<!-- <textarea name="finalObservationPRmo" id="finalObservationPRmo"  class="form-control"></textarea> -->
												...
												<div class="row m-t-10 clearfix">
													<div class="col-md-12 text-right">
														...
														<input type="button" id="submitMAForma18"
															...
															onclick="return submitMAForm18('draftPRMo18');" value="Submit" />
...
function showhide(buttonId)
{
	...
	function test(buttonId,newpost){
	 ...
	 var investigationForUom = "";
	 				...
	 				function getInvvvvvveeeeeeeemmmeee()  {
