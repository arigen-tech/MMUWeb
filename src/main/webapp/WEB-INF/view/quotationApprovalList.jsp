	...
	<div class="content-page">
		...
		<div class="">
			...
			<div class="container-fluid">
				<div class="internal_Htext"> Quotation Approval List  (LPC President)</div>
							...
							<div class="card-body">
                                    ...
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead class="bg-success" style="color:#fff;">
												<tr>
													<th id="th1">SI NO.</th>
													<th id="th2">Requirement Date</th>
													<th id="th3">Requirement No</th>
													<th id="th4">Quotation Entry Date</th>
													
												
													<th id="th10">Quotation Entry By</th>
													
													<th id="th6">L1  Cost</th>
													
												</tr>
											</thead>
											<tbody id="tblListOfQuotation">
											</tbody>
										</table>
									</div>
...
{	
	...
	var dataList = jsonData.data;
	 ...
	 for(item in dataList){
	    	  ...
	    	  htmlTable = htmlTable + "<td >" + dataList[item].quotationDate + "</td>";
	...
	var dataList = jsonData.data;
	 for(item in dataList){
		if(budgetaryMId == dataList[item].budgetaryMId){
			...
			quotationBy =dataList[item].quotationBy;
			quotationDate =dataList[item].quotationDate;
			lpTypeId=dataList[item].lpTypeId;
		}
	}
	rowClick(budgetaryMId,reqDate,reqNo,leastCost,quotationBy,lpTypeId);
}


function rowClick(budgetaryMId,reqDate,reqNo,leastCost,quotationBy,lpTypeId){
	 //window.location.href = "approveQuotation?budgetaryId="+budgetaryMId+"&budgetaryStatus="+statusId;
	window.location.href = "approveQuotation?budgetaryId="+budgetaryMId+"&lpTypeId="+lpTypeId;
