		...
		<div class="content-page">
			...
			<div class="">
				<div class="container-fluid">
					...
					<div class="internal_Htext" style="display:none;" id="afmsf3BSpecialtyId">AFMSF 3B/ Specialty</div>
					
					
					<div class="row">
						<div class="col-12">
							<div class="card">
							<form:form name="submitMedicalExamByMA" id="submitMedicalExamByMA" method="post" enctype='multipart/form-data'
								...
								<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<!-- <input type="text" name="typeOfCommission" id="" class="form-control"  /> -->
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost12" style="display:block;">
									...
									<div class="hisDivHide p-10 m-t-10"  id="newpost13" style="display:block;">
												...
												<tbody id="medicalCategory">
                                                       <tr>
                                                            <td>
                                                                ...
                                                                <input type="text" autocomplete="off" class="form-control" name="diagnosisId" id="diagnosisId" onKeyUp="getNomenClatureList(this,'fillDiagnosisComboMedCatMe','opd','getIcdListByName','diagnosisMe'); generateNextDate(this);"  placeholder="Diagnosis" />
                                                               ...
                                                               <td>
                                                                  <div class="autocomplete forTableResp">
                                                                   ...
                                                                   <input type="text" autocomplete="off" id="medicalCategoryId" onKeyUp="getNomenClatureList(this,'fillMedicalCategoryDataMe','medicalBoard','getMedicalBoardAutocomplete','compositeCategory'); generateNextDate(this);" class="form-control">
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<div class="input-group mb-2 mr-sm-2">
															<input type="text" name="rangeOfExpansion" id="rangeOfExpansion" value="5" onkeypress="if(isNaN(this.value+String.fromCharCode(event.which || event.keyCode))) return false;"class="form-control">
														    <div class="input-group-append">
														      <div class="input-group-text">cm</div>
														    </div>
												...
												<div class="form-group row">
													...
													<div class="col-md-9">
														<div class="form-check form-check-inline cusRadio m-t-5">
															...
															<span class="cus-radiobtn"></span> 
															<label class="form-check-label" for="obsistyCheck">Mark Obesity</label>
														</div>
														<div class="form-check form-check-inline cusRadio m-t-5">
														...
														<div class="form-check form-check-inline cusRadio">
															<input type="radio"   class="form-check-input radioCheckCol2"
																name="ObesityCheck"  value="A" id="noneCheck"
																onchange="overWeightOb(this.value)" />
															<span class="cus-radiobtn"></span> 
									...
									<div class="row m-t-20">
										<div class="col-12 text-right">
											...
											<input type="button" id="submitMAForma" class="btn btn-primary" onClick="return submitMAForm('draftMa');" value="Save"/>
		...
		function checkVaration()  {
		 ...
		 function populateChargeCode(val, count, item) {
	        ...
	        var arryNomenclature= new Array();
	          ...
	          function getMastStoreItemdsfsdfdsff(){
	      	  var pathname = window.location.pathname;
	      		var accessGroup = "MMUWeb";
