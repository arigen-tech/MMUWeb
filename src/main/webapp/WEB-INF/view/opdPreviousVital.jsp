...
function closeWindow()
{
 ...
 {	
 	...
 	for(i=0;i<dataList.length;i++)
 		{	 		
 			if(dataList[i].height!=""||dataList[i].weight!=""||dataList[i].tempature!=""||dataList[i].bp!="" && dataList[i].bp!="/"||dataList[i].bmi!=""||dataList[i].rr!=""||dataList[i].spo2!="")
 			{
 				flag=1;	
