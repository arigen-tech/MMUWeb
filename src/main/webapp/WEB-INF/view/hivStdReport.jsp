...
<div id="wrapper">
	<div class="content-page">
		...
		<div class="container-fluid">
			<div class="internal_Htext">HIV/STD Report</div>
			<form name="frm">			
			<div class="row">
				<div class="col-12">
					<div class="card">
							...
							<div class="row">								
								...
								<div class="col-md-3 text-right">
									<!-- <button type="button" class="btn btn-primary noMinWidth" onclick='downloadReport();'>Report</button>
									 ...
									 <a id="newEnt" class="btn btn-primary" role="button" href="${pageContext.request.contextPath}/miAdmin/createHIvStdRegister">New Entry</a>
...
{	
	...
	var dataList = jsonData.data;
	 ...
	 for(item in dataList){
	    	  ...
	    	  htmlTable = htmlTable + "<td >" + dataList[item].registerDate + "</td>";
	    	  ...
	    	  htmlTable = htmlTable + "<td >" + dataList[item].medCategory + "</td>";
...
function downloadReport() {
	...
	document.frm.action="${pageContext.request.contextPath}/report/hivStdReport";
...
function makeUrl(){
	...
	var url="${pageContext.request.contextPath}/report/hivStdReport?fromDate="+fromDate+"&toDate="+toDate+"&unitId="+unit+"&empName="+empName+"&serviceNo="+serviceNo;
	openPdfModel(url);
}
</script>
</html>
