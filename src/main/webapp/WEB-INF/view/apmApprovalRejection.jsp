...
$j(document).ready(function()
		{
            ...
            console.log(data);
             ...
             if (data.data.auditorAction != null) {
                 ...
                 if(data.data.auditorAction == 'Rejected'){
                	 $(submitBtn).prop('disabled', true);
                	 $(apmAction).prop('disabled', true);
                	 $(apmRemarks).prop('disabled', true);
                 }
             } 
...
function viewUploadedFile(filePath){
	...
	if (mimeType == 'pdf') {
	  ...
	  } else if(mimeType == 'jpg' || mimeType == 'jpeg' || mimeType == 'png' ){
...
function base64ToArrayBuffer(data) {
	...
	function saveAPMApproval(item){
		///-----		
		var empRegId = $('#empRegId').val();
		var apmAction = $('#apmAction').val();
		var apmRemarks = $('#apmRemarks').val();
	...
	function backToWaitingList(){
		window.location = "getAPMWaitingList";
	}	
...
<div id="wrapper">
	...
	<div class="container-fluid">
		...
		<div class="internal_Htext">Registration Approval Page(APM)</div>
					...
					<div class="card-body">
						...
						<div class="col-lg-9 col-sm-12">
									...
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-sm-7">
												...
												<input type="text" id="auditorDate" class="form-control" disabled="disabled" />
								...
								<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input type="text" id="auditorName" class="form-control" disabled="disabled" />
											</div>
										</div> 
									</div>
									...
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<input type="text" id="auditorAction" class="form-control" disabled="disabled" />
											</div>
										</div> 
									</div>
									...
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<textarea class="form-control" rows="3" id="auditorRemarks" disabled="disabled"></textarea>
											</div>
										</div> 
									</div>
								...
								<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<select class="form-control" id="apmAction">
									...
									<div class="col-md-6">
										<div class="form-group row">
											...
											<div class="col-md-7">
												<textarea class="form-control" rows="3" id="apmRemarks" ></textarea>
											</div>
										</div> 
									</div>
								</div>
						...
						<div class="row m-t-20">
							<div class="col-12 text-right">
								<button type="button" class="btn btn-primary" id="submitBtn" onclick="saveAPMApproval(this)">Submit</button>
