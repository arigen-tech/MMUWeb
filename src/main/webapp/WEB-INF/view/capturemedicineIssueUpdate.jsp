...
function editRow(itemData,isEditable){
	...
	'</td>'+
 	...
 	'<input type="text" name="tds_amount" id="tds_amount_'+iteration+'" class="form-control" onChange="calculateAmountMedIEC(this)" placeholder="TDS Amount" onkeypress="return isNumberKey(event)" value="'+itemData.tdsAmount+'" maxlength="10">'+
  	...
  	'<td>'+
 	'<input type="text" name="deduction_amount" id="deduction_amount_'+iteration+'" onChange="calculateAmountMedIEC(this)" value="0" class="form-control" placeholder="Deduction Amount" onkeypress="return isNumberKey(event)" value="'+itemData.deductionAmount+'" maxlength="10">'+
  	'</td>'+
