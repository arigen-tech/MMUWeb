	...
	<div class="content-page">
		...
		<div class="">
			...
			<div class="container-fluid">
				<div class="internal_Htext">BUDGETARY TRACKING LIST</div>
                                    ...
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead class="bg-success" style="color:#fff;">
												<tr>
													...
													<th id="th2">Created On</th>
													<th id="th5">MO Approval By</th>
													<th id="th8">MO Approval On</th>
													<th id="th9">CO Approval By</th>
													<th id="th11">CO Approval On</th>
	...
	var dataList = jsonData.data;
	 for(item in dataList){
	  ...
	  htmlTable = htmlTable + "<td >" + dataList[item].lpType + "</td>";
   	  ...
   	  htmlTable = htmlTable + "<td >" + dataList[item].moApproveBy + "</td>";
   	  htmlTable = htmlTable + "<td >" + dataList[item].moApproveDate + "</td>";
      htmlTable = htmlTable + "<td >" + dataList[item].coApproveBy + "</td>";
 	  htmlTable = htmlTable + "<td >" + dataList[item].coApproveDate + "</td>";
...
function rowClick(budgetaryMId,reqDate,reqNo,approxCost,createdBy,statusId){	
	 window.location.href = "getBudgetaryDetailsForMOTracking?budgetaryId="+budgetaryMId+"&budgetaryStatus=flag";
