...
var $j = jQuery.noConflict();
	...
	var url = "${pageContext.request.contextPath}/report/printAttendanceRegister?mmu_id="
				+ mmu_id			
				+ "&fromDate="
				+ fromDate
				+ "&toDate="
...
function generateExcelReport(){
        ...
        window.location.href  = "${pageContext.request.contextPath}/mis/exportAuditAttendanceRegister?mmu_id="
			+ mmu_id			
			+ "&fromDate="
			+ fromDate
			+ "&toDate="
             ...
             <div class="content-page">
                 ...
                 <div class="">
                     <div class="container-fluid">
                         <div class="internal_Htext">Attendance Register</div>
