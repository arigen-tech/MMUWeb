...
function showAll(){
	...
	$('#toDate').val("");
	 ...
	 $("#vendorName option").filter(function() {
...
function getPendingInvoice(MODE){
	...
	var vendorName=$("#vendorName").val();	
	 ...
	 if(MODE == 'ALL'){
		var data = {"PN":nPageNo, "vendorName":""};			
	 }else{
			var data = {"PN":nPageNo, "vendorName":vendorName,"fromDate":fromDate,"toDate":toDate};
	  } 
...
{	
	...
	for(i=0;i<dataList.length;i++)
		{		
			...
			htmlTable = htmlTable+"<tr id='"+data.medicineInvoiceId+"' >";
			...
			htmlTable = htmlTable +"<td style='width: 150px;'>"+data.sourceOfMedicine+"</td>";
			htmlTable = htmlTable +"<td style='width: 150px;'>"+data.invoiceNum+"</td>";
			htmlTable = htmlTable +"<td style='width: 150px;'>"+invoiceDate+"</td>";
			htmlTable = htmlTable +"<td style='width: 150px;'>"+data.invoiceAmount+"</td>";
...
{
	window.location.href = "updateMedicineIssue?id="+id;
	...
	<div id="wrapper">
		<div class="content-page">
			...
			<div class="container-fluid">
				...
				<div class="internal_Htext">View/Update Medicine Invoice</div>
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-body">
										...
										<table class="table table-hover table-bordered table-striped">
											<thead class="bg-success" style="color: #fff;">
												<tr>
													...
													<th id="th4" class="inner_md_htext">Source of Medicine</th>
													<th id="th5" class="inner_md_htext">Invoice No.</th>
													<th id="th6" class="inner_md_htext">Invoice Date</th>
													<th id="th7" class="inner_md_htext">Invoice Amount</th>
