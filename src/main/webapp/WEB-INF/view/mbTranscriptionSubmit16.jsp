<%@page import="java.util.HashMap"%>
	...
	int i = 1;
                    String mbTypeVal="";
                    mbTypeVal= request.getParameter("mbType");                 
%>
<c:set var="mbTypeValNew" value='<%=mbTypeVal%>'/>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div id="opd_submit">  
                                     <div class="row">
										<div class="col-md-8"> 
												<button class=" btn btn-primary opd_submit_btn" onclick="printReport('C');">AMSF-16</button> 
										...
										<!-- <div class="col-md-2"> 
											...
											<c:choose>
												<c:when test="${mbTypeValNew =='Validated'}">
            ...
            function backListReport(flag) {
            				...
            				if(flag=="2"){
            					...
            					+ window.location.host + "/" + accessGroup;
            					     ...
            					     window.location.href = ""+url+"/approve/mbApproveProcess";
               				}
            }
...
function printReport(flag) {
	...
	//alert("flag : "+flag)
	if(flag=='C')
	document.frm.action="${pageContext.request.contextPath}/report/mbAmsf16Report";
	if(flag=='R')
	document.frm.action="${pageContext.request.contextPath}/report/mbAmsf15ReportCheckList";
	if(flag=='P')
