	...
	<div class="content-page">
		...
		<div class="">
			...
			<div class="container-fluid">
				<div class="internal_Htext">BUDGETARY APPROVAL LIST(MO)</div>
...
function rowClick(budgetaryMId,reqDate,reqNo,approxCost,createdBy,statusId){	
	 window.location.href = "getBudgetaryDetailsForMOApproval?budgetaryId="+budgetaryMId+"&budgetaryStatus="+statusId;
