       ...
       <div div class="paddingTop15"></div>
		...
		<input type="hidden" name="visit_id" id="visit_id" value="">
                 <div class="">
					...
					<div class="center">	<p><b>File Name:</b>
                    <%--    <strong><b> <%= request.getParameter("patientId")%></b> </strong> --%>
            </p></li>
               <%
  //  String arr1 = request.getParameter("propertyNames");
             String arr = request.getParameter("propertyValues");
    String[] a = arr.split(",");
  
    for(int x=0; x<a.length; x++)
        out.println(a[x]+"<br>");%> 
      
     <!--    out.println(<img src="https://best-journal.xyz/wp-content/uploads/2017/02/1-1.jpg" class="profileImg" alt="" width="80%" id="profileImage" /> )
      --> </div>
					 	...
					 	<div class="table-responsive">
							...
							<table class="table table-hover table-bordered">
                                        ...
                                        <c:forEach items="${request.getParameter("propertyValues")}" var="currentItem">
                                        ...
                                        <td></td>
                                         <td>  <%
    String arr1 = request.getParameter("propertyValues");
             // String arr2 = request.getParameter("propertyValues");
    String[] a2 = arr1.split(",");
  
    for(int x=0; x<a2.length; x++)
    	    out.println(a2[x]);%> </td>
                                           <td>  <img src="/MMUWeb/resources/images/photo_icon.png" id="prevPic" alt=""  /></td>
                                                                                      <td>1</td>
                                          </tr>
                                            <tr>
                                        <td>1</td>
 ...
 function searchOpdPreConsultationList()
{
	...
	var nPageNo=1;	
	 ...
	 var url= window.location.protocol + "//" + window.location.host + "/" + accessGroup + "/opd/getPatientHistoryRecord";
 ...
 {	
 	...
 	for(i=0;i<dataList.length;i++)
 		{	 	
 			...
 			htmlTable = htmlTable +"<td style='width: 100px; '>"+PatientId+"</td>";
 			htmlTable = htmlTable +"<td style='width: 100px; '>"+dataList[i].status+"</td>";
 			htmlTable = htmlTable +"<td style='width: 100px;'>"+dataList[i].userName+"</td>";
 			htmlTable = htmlTable +"<td style='width: 100px;'>"+dataList[i].lastchgDate+"</td>";
 		//	htmlTable = htmlTable +"<td>"+dataList[i].lastchgDate+"</td>";
 		//	htmlTable = htmlTable +"<td>"+dataList[i].PatientId+"</td>";
