												...
												<form name="frm">
													...
													<c:if test="${flag=='save'}">
														<a class="btn btn-primary" role="button"
															href="${pageContext.request.contextPath}/dispencery/createIndent">Back</a>
														</c:if>
														<c:if test="${flag=='update'}">
														<a class="btn btn-primary" role="button"
															href="${pageContext.request.contextPath}/dispencery/viewindentListForViewUpdate">Back</a>
														</c:if>
														<c:if test="${docorFlag=='doctorValue'}">
														<a class="btn btn-primary" role="button"
															href="${pageContext.request.contextPath}/dispencery/getIndentApprovalListForAuditor">Back</a> 
														</c:if>
														<c:if test="${flag=='approve'&&docorFlag!='doctorValue'}">
														<a class="btn btn-primary" role="button"
