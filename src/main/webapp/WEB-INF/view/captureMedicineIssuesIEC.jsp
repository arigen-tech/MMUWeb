     ...
     var multipleFields=[];
 	 ...
 	 var everyFieldValidate=true;
	   $('tbody#medicineInvoiceTable tr').each(function(){
		   console.log(this.id);
		   var medicineSource = 0;//$(this).find("select[id*='medicineSource_"+this.id+"']").val();
		   var medicalStore = 0;//$(this).find("select[id*='medicineSubSource_"+this.id+"']").val();
...
function addRow(){
	...
	var newRowContent = '<tr id="'+iteration+'">'+
		 		 '<td style="display:none;"><select class="form-control" id="medicineSource_'+iteration+'" onChange="getMedicalStore(this.value,'+iteration+');">'+
	    		 '<option value="">--SELECT--</option>'+
	    		 sourceOfMedicines+
				 '</select></td>'+
				 '<td style="display:none;"><select class="form-control" id="medicineSubSource_'+iteration+'">'+
	    		 '<option value="">--SELECT--</option>'+
			 	...
			 	'<td>'+
			 		'<div class="dateHolder">'+
						'<input type="text" name="invoiceDate" id="invoiceDate_'+iteration+'"	class="input_date form-control" value=""  placeholder="DD/MM/YYYY" readonly/>'+
					'</div>'+
			 	'</td>'+
 	'<td>'+
	...
	'</td>'+
 	...
 	'<input type="text" name="tds_amount" id="tds_amount_'+iteration+'" class="form-control" onChange="calculateAmountMedIEC(this)" placeholder="TDS Amount" onkeypress="return isNumberKey(event)" maxlength="10">'+
  	...
  	'<td>'+
 	'<input type="text" name="deduction_amount" id="deduction_amount_'+iteration+'" value="0" onChange="calculateAmountMedIEC(this)" class="form-control" placeholder="Deduction Amount" onkeypress="return isNumberKey(event)" maxlength="10">'+
  	'</td>'+
	...
	<div id="wrapper">
		<div class="content-page">
			...
			<div class="container-fluid">
				...
				<div class="internal_Htext">Capture IEC Invoice</div>
										...
										<div class="table-responsive">
											<table id="my-table"
												...
												<thead class="bg-success" style="color: #fff;">
													<tr>
														<th style="display:none;">Source of Medicine</th>
												...
												<tbody class="" id="medicineInvoiceTable">
													<%int inc=1; %>
													<tr id="<%=inc%>">
														<td style="display:none;"><select class="form-control" id="medicineSource_<%=inc%>" onChange="getMedicalStore(this.value,<%=inc%>);">
																<option value="">--SELECT--</option>
														</select></td>
														<td style="display:none;"><select class="form-control"
