...
<title>Nursing Waiting List</title>
...
$j(document).ready(function()
 ...
 function getNursingWaitingList(MODE) {
	...
	if (to_date === undefined) {
 	 ...
 	 if(MODE == 'ALL')
 		{
 			var data = {"hospital_id": <%= hospitalId %>, "from_date":"","to_date":"","pageNo":nPageNo}; 
 		}
 	else
 		{
	...
	<div class="content-page">
		<div class="">
			<div class="container-fluid">
				<div class="internal_Htext">Nursing Care Waiting List</div>
				<!-- end row -->
				<div class="row">
					<div class="col-12">
						<div class="card">
