...
<script type="text/javascript">
	...
	$j(document).ready(function(){
        ...
        /*  $('#userDesignation').val(usertypedesignation);
         ...
         if($('#userDesignation').val()=='Clerk')
         {
         	var approvingAuthorityId=resourceJSON.approvingAuthorityClerkId;
         	var approvingAuthorityOrderNo=resourceJSON.approvingAuthorityClerkOrderNo;
         	var approvingAuthorityName=resourceJSON.approvingAuthorityClerkName;
         	$('#authorityId').val(approvingAuthorityId);
         	$('#authorityOrderNo').val(approvingAuthorityOrderNo);
         	$('#authorityRoleName').val(approvingAuthorityName);
         	GetAllVendorInvoice('ALL');
         }
         else if(userDesignation.startsWith('Sub'))
         {
         	var approvingAuthorityId=resourceJSON.approvingAuthoritySubNodalId;
         	var approvingAuthorityOrderNo=resourceJSON.approvingAuthoritySubNodalOrderNo;
         	var approvingAuthorityName=resourceJSON.approvingAuthoritySubNodalName;
         	$('#authorityId').val(approvingAuthorityId);
         	$('#authorityOrderNo').val(approvingAuthorityOrderNo);
         	$('#authorityRoleName').val(approvingAuthorityName);
         	GetAllVendorInvoice('ALL');
         ...
         else if(userDesignation.startsWith('Nodal'))
         {
         	var approvingAuthorityId=resourceJSON.approvingAuthorityNodalId;
         	var approvingAuthorityOrderNo=resourceJSON.approvingAuthorityNodalOrderNo;
         	var approvingAuthorityName=resourceJSON.approvingAuthorityNodalName;
         	$('#authorityId').val(approvingAuthorityId);
         	$('#authorityOrderNo').val(approvingAuthorityOrderNo);
         	$('#authorityRoleName').val(approvingAuthorityName);
         	GetAllVendorInvoice('ALL');
         ...
         else if(userDesignation.startsWith('Test'))
         {
         	var approvingAuthorityId=resourceJSON.approvingAuthorityTestId;
         	var approvingAuthorityOrderNo=resourceJSON.approvingAuthorityTestOrderNo;
         	var approvingAuthorityName=resourceJSON.approvingAuthorityTestName;
         	$('#authorityId').val(approvingAuthorityId);
         	$('#authorityOrderNo').val(approvingAuthorityOrderNo);
         	$('#authorityRoleName').val(approvingAuthorityName);
         	GetAllVendorInvoice('ALL');
         ...
         else if(userDesignation.startsWith('Commissioner'))
         {
         	var approvingAuthorityId=resourceJSON.approvingAuthorityCommissionerId;
         	var approvingAuthorityOrderNo=resourceJSON.approvingAuthorityCommissionerOrderNo;
         	var approvingAuthorityName=resourceJSON.approvingAuthorityCommissionerName;
         	$('#authorityId').val(approvingAuthorityId);
         	$('#authorityOrderNo').val(approvingAuthorityOrderNo);
         	$('#authorityRoleName').val(approvingAuthorityName);
         	GetAllVendorInvoice('ALL');
         ...
         else if(userDesignation.startsWith('UPSS')||userDesignation.startsWith('Colle'))
         {
         	var approvingAuthorityId=resourceJSON.approvingAuthorityUPSSId;
         	var approvingAuthorityOrderNo=resourceJSON.approvingAuthorityUPSSOrderNo;
         	var approvingAuthorityName=resourceJSON.approvingAuthorityUPSSName;
         	$('#authorityId').val(approvingAuthorityId);
         	$('#authorityOrderNo').val(approvingAuthorityOrderNo);
         	$('#authorityRoleName').val(approvingAuthorityName);
         	GetAllVendorInvoice('ALL');
	...
	function GetAllVendorInvoice(MODE){
		...
		var district = $j('#district').val();
		 ...
		 if(MODE == 'ALL'){
				var data = {"PN": nPageNo, "invoiceNo": "","fromDate":fromDate,"toDate":toDate};
		 }
		 else if(district != "" || fromDate != ""||toDate != "" || statusSearch != ""|| vendorId != "")
		 {
			 //nPageNo=1; 
		    var data = {"PN":nPageNo,"district":district,"fromDate":fromDate,"toDate":toDate,"statusSearch":statusSearch,"vendorId":vendorId};
		 } 
	    else
	    { 
			var data = {"PN":nPageNo};
	...
	function executeClickEvent(captureVendorBillDetailId,data){
        window.location = 'detailVendorBillingReports?detail='+captureVendorBillDetailId;
	}
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="">
                ...
                <div class="internal_Htext">Detailed Billing Report(Vendor Invoice)</div>
