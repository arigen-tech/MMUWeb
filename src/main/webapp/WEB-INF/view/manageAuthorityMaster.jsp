	...
	<div id="wrapper">
		<div class="content-page">
			...
			<div class="container-fluid">
				...
				<div class="internal_Htext">Manage Authority Master</div>
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group row">
											<div class="col-md-5">
												<label class="col-form-label">Authority Name</label>
											</div>
											<div class="col-md-7">
												<input type="text" class="form-control" id="" onchange="" />
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group row">
											<div class="col-md-5">
												<label class="col-form-label">Authority Code</label>
											</div>
											<div class="col-md-7">
												<input type="text" class="form-control" id="" onchange="" />
											</div>
