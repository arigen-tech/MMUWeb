										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group row">
													...
													<div class="col-md-7">
														<input type="text" id="haemorrhoidsss" name="haemorrhoids"  class="form-control" value="NAD">
													</div>
												</div>
											</div>
				...
				.ajax({
					...
					$.each(datas, function(i, item) {
						 ...
						 var totalTeeth=item.totalTeeth;
				            ...
				            if (dentalCheckupDate != null && dentalCheckupDate !="") {
				            ...
				            if (variationinWeight != null && variationinWeight !="") {
				            ...
				            if (withoutGlassesLDistant != null && withoutGlassesLDistant !="") {
				            ...
				            if (withGlassesLNearvision != null && withGlassesLNearvision !="") {
				            ...
				            if (withGlassesRNearvision != null && withGlassesRNearvision !="") {
				            ...
				            if (noseThroatSinuses != null && noseThroatSinuses !="") {
				            ...
				            if (locomoterSystem != null && locomoterSystem !="") {
				            ...
				            if (herniaMusic != null && herniaMusic !="") {
				            ...
				            if (withoutGlassesLNearvision != null && withoutGlassesLNearvision !="") {
