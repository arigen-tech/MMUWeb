	...
	<div class="content-page">
		...
		<div class="">
			...
			<div class="container-fluid">
				<div class="internal_Htext">Budgetary Approval List(CO)</div>
                                    ...
                                    <table class="table table-hover table-striped table-bordered">
                                        <thead class="bg-success" style="color:#fff;">
												<tr>
													...
													<th id="th5">Approved By</th>
													<th id="th7">Approved Date</th>
...
function rowClick(budgetaryMId,reqDate,reqNo,approxCost,createdBy,statusId){	
	 window.location.href = "getBudgetaryDetailsForCOApproval?budgetaryId="+budgetaryMId+"&budgetaryStatus="+statusId;
