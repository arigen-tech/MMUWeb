...
public class ExportExcelMedicineIssueReport extends AbstractXlsxView {
  ...
  protected void buildExcelDocument(Map<String, Object> model, Workbook workbook,
	...
	JSONObject js=(JSONObject) json.get("medicineIssueReport_data");
	String js1=js.get("medicineIssueReport_data").toString();
    ...
    String[] header1= {"Medicine Issue Report Date From : "+fromDate+" To : "+toDate+""};	
    String[] header2= {"S.No.","District Name","MMU Name","Total Appointment","Total Medicine Issued"    		
    		};
    int rowNum = 2;
    
    // Creating sheet with in the workbook
    Sheet sheet = workbook.createSheet("MedicineIssueReport reg");
    /** for header **/
    String fileName = "MedicineIssueReport.xlsx";    
    ...
    try
    {
        ...
        for(int i=0;i<jsonArray.length();i++)
        {
            ...
            if(jsonObject1.optString("total_app") !=null && !jsonObject1.optString("total_app").isEmpty()) {
            	total_app=Integer.parseInt(jsonObject1.optString("total_app").toString());
            }   
                      
            if(jsonObject1.optString("dispensary_flag") !=null && !jsonObject1.optString("dispensary_flag").isEmpty()) {
            	dispensary_flag= Integer.parseInt(jsonObject1.optString("dispensary_flag").toString());
            }  
