...
public class ExportExcelAttendanceInTimeOutTime extends AbstractXlsxView {
	  ...
	  protected void buildExcelDocument(Map<String, Object> model, Workbook workbook,
	    ...
	    String[] header1= {"Attendance In Time and OutTime"};	
	    String[] header2= {"S.No.","MMU Name","Mobile No.","User Name","Designation","Attendance Date","Attendance In Time","Attendance Out Time"    		
	    		};
	    int rowNum = 2;
	    
	    // Creating sheet with in the workbook
	    Sheet sheet = workbook.createSheet("AttendanceInTimeOutTime reg");
	    /** for header **/
	    ...
	    sheet.addMergedRegion(org.apache.poi.ss.util.CellRangeAddress.valueOf("$A$1:$H$1"));
	    ...
	    try
	    {
	        ...
	        for(int i=0;i<jsonArray.length();i++)
	        {
	            ...
	            row3.createCell(2).setCellValue(jsonObject1.optString("mobile_no"));
	            row3.createCell(3).setCellValue(jsonObject1.optString("user_name"));
	            row3.createCell(4).setCellValue(jsonObject1.optString("user_type_name"));
	            row3.createCell(5).setCellValue(jsonObject1.optString("attendance_date"));
	            row3.createCell(6).setCellValue(jsonObject1.optString("intime"));
	            row3.createCell(7).setCellValue(jsonObject1.optString("outtime"));
