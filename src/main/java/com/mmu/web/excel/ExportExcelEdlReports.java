...
public class ExportExcelEdlReports extends AbstractXlsxView {
  ...
  protected void buildExcelDocument(Map<String, Object> model, Workbook workbook,
	...
	JSONObject js=(JSONObject) json.get("edlReport_data");
	String js1=js.get("edlReport_data").toString();
    ...
    String[] header1= {"Stock Status Report(MMU Wise)"};	
    String[] header2= {"S.No.","City","MMU Name","Stock of EDL MMU wise","Summary of EDL not available in MMU's"    		
    		};
    int rowNum = 2;
    ...
    /** for header **/
    String fileName = "EdlReports.xlsx";    
    ...
    try
    {
        ...
        for(int i=0;i<jsonArray.length();i++)
        {
            ...
            if(jsonObject1.optString("a2") !=null && !jsonObject1.optString("a2").isEmpty()) {
            	a2= Integer.parseInt(jsonObject1.optString("a2").toString());
            }  
            ...
            row3.createCell(3).setCellValue(jsonObject1.optString("a1") !=null && !jsonObject1.optString("a1").isEmpty()
            		? Integer.parseInt(jsonObject1.optString("a1")) : 0);
            row3.createCell(4).setCellValue(jsonObject1.optString("a2") !=null && !jsonObject1.optString("a2").isEmpty()
            		? Integer.parseInt(jsonObject1.optString("a2")) : 0);
