...
public class ExportExcelMMSSYInfo2 extends AbstractXlsxView {
  ...
  protected void buildExcelDocument(Map<String, Object> model, Workbook workbook,
	...
	toDate=js.getString("toDate").toString();
	 ...
	 String[] header1= {"District","ULB Name","Progress from - "+fromDate+" and Progress to - "+toDate+"","","","","",""};
    ...
    String fromStringV=fromDate.replace("/", "-");
    Sheet sheet = workbook.createSheet("MMSYinfo reg_"+fromStringV);
    /** for header **/
    String fileName = "MMSSYInfoRegister_DateRange_"+fromStringV+".xlsx";    
    ...
    try
    {
        ...
        row4.createCell(4).setCellValue(Math.round(tot_t_avg_patient/totalNoOfCity));
