...
@WebListener
public class AuditUploadScheduler extends QuartzInitializerListener{
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ...
            JobDetail jobDetail = JobBuilder.newJob(AuditUploadJobExecution.class).build();
            Trigger trigger = TriggerBuilder.newTrigger()
            		.withIdentity("simple1")
            		.withSchedule(
