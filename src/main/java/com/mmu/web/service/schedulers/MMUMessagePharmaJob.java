...
@Component
public class MMUMessagePharmaJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		String OSBURLMedicineRolInfo = HMSUtil.getProperties("urlextension.properties", "sendMedicineRolInfoScheduler");
		String sendMedicineRolInfoScheduler = ipAndPort.trim() + OSBURLMedicineRolInfo.trim();
		...
		try {
			...
			ResponseEntity<String> followMsgDlivered = new RestTemplate().exchange(sendMedicineRolInfoScheduler, HttpMethod.POST, request,
				String.class);
		System.out.println("Pharma MMU Message Status "+followMsgDlivered);
		}catch (Exception e) {
			e.printStackTrace();
		}
    }	
